...
import com.github.terefang.jmelange.ldata.LdataUtil;
        ...
        RowDataWriter
{
    ...
    static List<String> DATANAMES = Collections.unmodifiableList(CommonUtil.toList("ldata", "ldx"));
    static List<String> DATAEXTS = Collections.unmodifiableList(CommonUtil.toList(".ldata", ".ldx"));
    ...
    public void writeRows(List<Map<String, Object>> _data, File _file) {
        LdataUtil.writeTo(CommonUtil.toMap(_ROW_DATA_KEY, _data), _file);
    }

    @Override
    public void writeRows(List<Map<String, Object>> _data, OutputStream _file) {
        LdataUtil.writeTo(CommonUtil.toMap(_ROW_DATA_KEY, _data), new OutputStreamWriter(_file));
    }
