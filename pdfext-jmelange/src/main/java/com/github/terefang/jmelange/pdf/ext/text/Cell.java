...
{
	List<Cell> breakup(PdfFontRegistry _r, double _limit, double _hscale);
	...
	boolean canHypenate(PdfFontRegistry reg, boolean _firstInLine, double _limit, double _hscale, Hyphenator _hy);

	Cell[] hypenate(PdfFontRegistry reg, boolean _firstInLine, double _limit, double _hscale, Hyphenator _hy);
	String getLink();

	double width(PdfFontRegistry _reg, double _hscale, boolean _firstInLine);
}
