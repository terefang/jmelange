...
public class PdfA85Filter extends PdfFilter
{
	public static PdfA85Filter create() { return new PdfA85Filter(); }

	public PdfA85Filter()
	{
		super(PdfName.ASCII85DECODE);
	...
	public byte[] wrap(byte[] content)
	{
		...
		OutputStream _hout = new ASCII85OutputStream(baos);
	 ...
	 *
	 */
	static final class ASCII85OutputStream extends FilterOutputStream {
