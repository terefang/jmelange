...
public class PdfCmykColorSpace extends PdfColorSpace
{
	public PdfCmykColorSpace(PdfDocument doc)
	{
		super(doc);
	}
	
	static PdfCmykColorSpace deviceCmyk = null;
	
	public static synchronized PdfCmykColorSpace getDeviceCmyk(PdfDocument doc)
	{
		if(deviceCmyk==null)
		{
			deviceCmyk = new PdfCmykColorSpace(doc) {
				@Override
			...
			deviceCmyk.add(PdfName.of("DeviceCMYK"));
		}
		return deviceCmyk;
	}
}
