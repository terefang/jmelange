...
public class TestPdf_adf_fonts
{
	public static final String _fontbase = "/data/fredo/_fontz/_free/ADF";

	public static void main(String[] args) throws Exception
	{
		PdfDocument doc = new PdfDocument();

		doc.streamBegin("./out/test-adf-fonts.pdf");
		...
		for(String _fn : scandirs("**/*.ttf,**/*.otf", _fontbase))
		{
