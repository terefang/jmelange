...
public class TestPdf_ttf_cff_fonts
{
	...
	public static void main_enc(String[] args) throws Exception
	{
		...
		FileResourceLoader _rl = FileResourceLoader.of("/nas/_fontz/_free/TeXGyre/TeXGyreHeros-Regular.otf");

		for(String _encode : _encodings)
		{
			PdfFont _xf = _doc.registerTtfFont(_encode, _rl);
		...
		_doc.writeTo("./out/pdf/test-ttf-cff-encoding.pdf");
	}
