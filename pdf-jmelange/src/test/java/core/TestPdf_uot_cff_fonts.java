...
public class TestPdf_uot_cff_fonts
{
	public static final String[] _fontlist = {
			"/mnt/nas/fredos/_fontz/_free/NerdFont/Agave/AgaveNerdFontMono-Regular.ttf",
		//	"/mnt/nas/fredos/_fontz/_free/TeXGyre/TeXGyreHeros-Regular.otf",
		//	"/mnt/nas/fredos/_fontz/_free/Google/NotoSansLinearB/NotoSansLinearB-Regular.ttf"
	};
	...
	public static void main(String[] args) throws Exception
	{
		...
		doc.streamBegin("./out/pdf/test-uot-cff-fonts.pdf");
		...
		for(String _fn : _fontlist)
		{
			...
			try
			{
				...
				for(int _bmp = 0; _bmp<=_cf.maxCoverage(); _bmp++)
				//for(int _bmp = _cf.maxCoverage(); _bmp<=_cf.maxCoverage(); _bmp++)
				{
					if(_cf.hasCoverage(_bmp))
					{
						...
						for(int _cp = 0; _cp<256; _cp++)
						{
							...
							_content.drawString(Character.toString((int) (_cp +(_bmp<<8))), 30+(45 * (_cp % 16)), 800-(30+(45 * (_cp / 16))));
