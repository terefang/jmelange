...
public class FnPerlin extends FastNoiseLite
{
    ...
    // 2d perlin
    public static final double singlePerlin(int interpolation, int seed, double x, double y) {
        int x0 = fastFloor(x);
        int y0 = fastFloor(y);
        int x1 = x0 + 1;
        int y1 = y0 + 1;
    ...
    // 3d perlin
    public static final double singlePerlin(int interpolation, int seed, double x, double y, double z) {
        int x0 = fastFloor(x);
        int y0 = fastFloor(y);
        int z0 = fastFloor(z);
        int x1 = x0 + 1;
    ...
    // 4d perlin
    public static final double singlePerlin(int interpolation, int seed, double x, double y, double z, double w) {
        int x0 = fastFloor(x);
        int y0 = fastFloor(y);
        int z0 = fastFloor(z);
        int w0 = fastFloor(w);
    ...
    // 5d perlin
    public static final double singlePerlin(int interpolation, int seed, double x, double y, double z, double w, double u) {
        int x0 = fastFloor(x);
        int y0 = fastFloor(y);
        int z0 = fastFloor(z);
        int w0 = fastFloor(w);
    ...
    // 6d perlin
    public static final double singlePerlin(int interpolation, int seed, double x, double y, double z, double w, double u, double v) {
        int x0 = fastFloor(x);
        int y0 = fastFloor(y);
        int z0 = fastFloor(z);
        int w0 = fastFloor(w);
