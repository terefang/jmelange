...
public final class OrthoNormalBasis {
	...
	public Vector3 untransform(Vector3 a) {
		double x = Vector3.dot(a, u);
		double y = Vector3.dot(a, v);
		double z = Vector3.dot(a, w);
		return a.set(x, y, z);
	}
	
	public double untransformX(Vector3 a) {
		return Vector3.dot(a, u);
	}
	
	public double untransformY(Vector3 a) {
		return Vector3.dot(a, v);
	}
	
	public double untransformZ(Vector3 a) {
