...
public final class Matrix4 {
	 ...
	 */
	public Matrix4(double[] m, boolean rowMajor) {
		if (rowMajor) {
			m00 = m[0];
			m01 = m[1];
			m02 = m[2];
	...
	public final double[] asRowMajor() {
		return new double[] { m00, m01, m02, m03, m10, m11, m12, m13, m20, m21,
				m22, m23, m30, m31, m32, m33 };
	}
	
	public final double[] asColMajor() {
		return new double[] { m00, m10, m20, m30, m01, m11, m21, m31, m02, m12,
	...
	public final Matrix4 multiply(Matrix4 m) {
		...
		double rm00 = m00 * m.m00 + m01 * m.m10 + m02 * m.m20 + m03 * m.m30;
		double rm01 = m00 * m.m01 + m01 * m.m11 + m02 * m.m21 + m03 * m.m31;
		double rm02 = m00 * m.m02 + m01 * m.m12 + m02 * m.m22 + m03 * m.m32;
		double rm03 = m00 * m.m03 + m01 * m.m13 + m02 * m.m23 + m03 * m.m33;
		
		double rm10 = m10 * m.m00 + m11 * m.m10 + m12 * m.m20 + m13 * m.m30;
		double rm11 = m10 * m.m01 + m11 * m.m11 + m12 * m.m21 + m13 * m.m31;
		double rm12 = m10 * m.m02 + m11 * m.m12 + m12 * m.m22 + m13 * m.m32;
		double rm13 = m10 * m.m03 + m11 * m.m13 + m12 * m.m23 + m13 * m.m33;
		
		double rm20 = m20 * m.m00 + m21 * m.m10 + m22 * m.m20 + m23 * m.m30;
		double rm21 = m20 * m.m01 + m21 * m.m11 + m22 * m.m21 + m23 * m.m31;
		double rm22 = m20 * m.m02 + m21 * m.m12 + m22 * m.m22 + m23 * m.m32;
		double rm23 = m20 * m.m03 + m21 * m.m13 + m22 * m.m23 + m23 * m.m33;
		
		double rm30 = m30 * m.m00 + m31 * m.m10 + m32 * m.m20 + m33 * m.m30;
		double rm31 = m30 * m.m01 + m31 * m.m11 + m32 * m.m21 + m33 * m.m31;
		double rm32 = m30 * m.m02 + m31 * m.m12 + m32 * m.m22 + m33 * m.m32;
		double rm33 = m30 * m.m03 + m31 * m.m13 + m32 * m.m23 + m33 * m.m33;
	 ...
	 */
	public final double transformVX(double x, double y, double z) {
	 ...
	 */
	public final double transformVY(double x, double y, double z) {
	 ...
	 */
	public final double transformVZ(double x, double y, double z) {
	 ...
	 * @return x coordinate transformation result
	 */
	public final double transformTransposeVX(double x, double y, double z) {
	 ...
	 * @return y coordinate transformation result
	 */
	public final double transformTransposeVY(double x, double y, double z) {
	 ...
	 */
	public final double transformTransposeVZ(double x, double y, double z) {
	 ...
	 * @return x coordinate transformation result
	 */
	public final double transformPX(double x, double y, double z) {
	 ...
	 * @return y coordinate transformation result
	 */
	public final double transformPY(double x, double y, double z) {
	 ...
	 * @return z coordinate transformation result
	 */
	public final double transformPZ(double x, double y, double z) {
	 ...
	 */
	public final static Matrix4 translation(double x, double y, double z) {
	 ...
	 */
	public final static Matrix4 rotateX(double theta) {
		Matrix4 m = new Matrix4();
	 ...
	 * @return a new Matrix4 object representing the rotation
	 */
	public final static Matrix4 rotateY(double theta) {
		Matrix4 m = new Matrix4();
		double s = (double) Math.sin(theta);
		double c = (double) Math.cos(theta);
		m.m11 = m.m33 = 1;
	 ...
	 * @return a new Matrix4 object representing the rotation
	 */
	public final static Matrix4 rotateZ(double theta) {
		Matrix4 m = new Matrix4();
		double s = (double) Math.sin(theta);
		double c = (double) Math.cos(theta);
		m.m22 = m.m33 = 1;
	 ...
	 * @return a new Matrix4 object representing the rotation
	 */
	public final static Matrix4 rotate(double x, double y, double z, double theta) {
		Matrix4 m = new Matrix4();
		double invLen = 1 / (double) Math.sqrt(x * x + y * y + z * z);
		x *= invLen;
		y *= invLen;
		z *= invLen;
		double s = (double) Math.sin(theta);
	 ...
	 */
	public final static Matrix4 scale(double s) {
		Matrix4 m = new Matrix4();
		m.m00 = m.m11 = m.m22 = s;
		m.m33 = 1;
		return m;
	 ...
	 */
	public final static Matrix4 scale(double sx, double sy, double sz) {
		Matrix4 m = new Matrix4();
		m.m00 = sx;
		m.m11 = sy;
		m.m22 = sz;
	...
	public final static Matrix4 blend(Matrix4 m0, Matrix4 m1, double t) {
		Matrix4 m = new Matrix4();
