...
public class LongLatProjection implements IProjection<PlanetJProjectionContext>
{
	...
	public void projectCall(PlanetJProjectionContext _context, int _i, int _j, IProjectionCallback<PlanetJProjectionContext> _cb)
	{
		...
		double _lat = (_context.main.PI*((double)_j)/((double)_context.main.Height-1))-_context.main.baseLatitude;
		double _lon = _context.main.PI+(2*_context.main.PI*((double)(_i))/((double)_context.main.Width-1))+_context.main.baseLongitude;
