...
public class JGP_FastValueNoise extends AbstractNoise
{
	int seed = 0;
	@Override
	...
	public double getNoise2d(double x, double y) 
	{
		...
		return JavaGameProgFastNoiseRef.noise(x, y,oct,false,true, seed);
	}
	...
	public double getNoise3d(double x, double y, double z) 
	{
		...
		return JavaGameProgFastNoiseRef.noise(x+z, y+z,oct,false,true, seed);
	}
