...
public class TestLiteNoise
{
    ...
    public static void main(String[] args)
    {
        ...
        //for(final FastNoiseLite.NoiseType _type : Arrays.asList(FastNoiseLite.NoiseType.CELLULAR_MERGE_EUCLIDEAN, FastNoiseLite.NoiseType.CELLULAR_MERGE_MANHATTAN, FastNoiseLite.NoiseType.CELLULAR_MERGE_NATURAL))
        {
                ...
                _EX.execute(() -> {
                    ...
                    for(int _y=0; _y<_SIZE; _y++)
                    {
                        for(int _x=0; _x<_SIZE; _x++)
                        {
                            ...
                            double _h = FastNoiseLite.singleByNoiseAndTransform(_type, 0., 0., 1.0, _transform, _seed, _fx*_FREQ, _fy*_FREQ);
