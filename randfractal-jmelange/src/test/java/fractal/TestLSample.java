...
public class TestLSample extends def.TestUtil
{
                        ...
                        ))
                        {
                            ...
                            //for(final FastNoiseLiteBase.TransformType _transform : FastNoiseLiteBase.TransformType.values())
                            {
                                _EX.execute(() -> {
                                    ...
                                    //savePlot(_nf, "./out/fractal.TestLSample/fchart~" + _name + ".svg", _name);
                                    saveHF(_nf, "./out/fractal.TestLSample/fractal~" + _name + ".png");
                                });
                            }
                        }
                    }
