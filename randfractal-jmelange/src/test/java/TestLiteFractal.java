...
public class TestLiteFractal extends TestUtil
{
    ...
    public static void main(String[] args) {
        ...
        {
            //FastNoiseLite.FractalType _ftype = FastNoiseLite.FractalType.F_0VERSAMPLE;
                            ...
                            _EX.execute(() -> {
                                ...
                                for(int _y=0; _y<_SIZE; _y++)
                                {
                                    for(int _x=0; _x<_SIZE; _x++)
                                    {
                                        ...
                                        float _h = FastNoiseLite.fractalByType(_ftype, _type, FastNoiseLite.BASE_MUTATION, FastNoiseLite.BASE_SHARPNESS, _seed, _fx, _fy, FastNoiseLite.BASE_OFFSET, FastNoiseLite.BASE_H, _oct, _freq, FastNoiseLite.BASE_LACUNARITY, FastNoiseLite.BASE_GAIN, true);
