...
public class FileHandle {
	...
	public File file () {
		if (type == Files.FileType.External) return new File(FilesDelegateSingleton.getInstance().getExternalStoragePath(), file.getPath());
		return file;
	}
	 ...
	 *            mapping fails, or is a {@link Files.FileType#Classpath} file. */
	...
	public ByteBuffer map (MapMode mode) {
		if (type == Files.FileType.Classpath) throw new GdxRuntimeException("Cannot map a classpath file: " + this);
	 ...
	 * @throws GdxRuntimeException if this file handle represents a directory, if it is a {@link Files.FileType#Classpath} or
	 ...
	 * array.
	 * @throws GdxRuntimeException if this file is an {@link Files.FileType#Classpath} file. */
	...
	/** @throws GdxRuntimeException if this file handle is a {@link Files.FileType#Classpath} or {@link Files.FileType#Internal} file. */
	public void mkdirs () {
	 ...
	 * @throws GdxRuntimeException if the destination file handle is a {@link Files.FileType#Classpath} or {@link Files.FileType#Internal}
	 ...
	 * @throws GdxRuntimeException if the source or destination file handle is a {@link Files.FileType#Classpath} or
