...
import com.github.terefang.jmelange.gfx.libgdx.utils.NumberUtils;
...
//        return (byte) (255.99 * (probit((v & 255) * 0x1p-8 + 0x1p-9) * 0.17327209222987916 + 0.5));
    ...
    public static float barronSpline(final float x, final float shape, final float turning) {
        ...
        final int f = com.github.terefang.jmelange.gfx.libgdx.utils.NumberUtils.floatToIntBits(d) >> 31, n = f | 1;
