...
package com.github.terefang.jmelange.gfx.libgdx.utils.compression.lzma;

import java.io.IOException;

import com.github.terefang.jmelange.gfx.libgdx.utils.compression.ICodeProgress;
import com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.BitTreeEncoder;
...
public class Encoder {
	...
	class LiteralEncoder {
		class Encoder2 {
			...
			public void Init () {
				com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(m_Encoders);
			}

			public void Encode (com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder rangeEncoder, byte symbol) throws IOException {
				int context = 1;
				for (int i = 7; i >= 0; i--) {
					int bit = ((symbol >> i) & 1);
			...
			public void EncodeMatched (com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder rangeEncoder, byte matchByte,
			...
			public int GetPrice (boolean matchMode, byte matchByte, byte symbol) {
				...
				if (matchMode) {
					for (; i >= 0; i--) {
						int matchBit = (matchByte >> i) & 1;
						int bit = (symbol >> i) & 1;
						price += com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder
				...
				for (; i >= 0; i--) {
					int bit = (symbol >> i) & 1;
					price += com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice(m_Encoders[context], bit);
					context = (context << 1) | bit;
				}
				return price;
			}
	...
	class LenEncoder {
		...
		public void Init (int numPosStates) {
			com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(_choice);
		...
		public void Encode (com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder rangeEncoder, int symbol, int posState)
			throws IOException {
		...
		public void SetPrices (int posState, int numSymbols, int[] prices, int st) {
			int a0 = com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice0(_choice[0]);
			int a1 = com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice1(_choice[0]);
			int b0 = a1 + com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice0(_choice[1]);
			int b1 = a1 + com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice1(_choice[1]);
			int i = 0;
	...
	com.github.terefang.jmelange.gfx.libgdx.utils.compression.lz.BinTree _matchFinder = null;
	com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder _rangeEncoder = new com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder();
	...
	void Create () {
		if (_matchFinder == null) {
			com.github.terefang.jmelange.gfx.libgdx.utils.compression.lz.BinTree bt = new com.github.terefang.jmelange.gfx.libgdx.utils.compression.lz.BinTree();
			int numHashBytes = 4;
	...
	void Init () {
		...
		com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(_isMatch);
		com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(_isRep0Long);
		com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(_isRep);
		com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(_isRepG0);
		com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(_isRepG1);
		com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(_isRepG2);
		com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.InitBitModels(_posEncoders);
	...
	int GetRepLen1Price (int state, int posState) {
		return com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice0(_isRepG0[state])
			+ com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder
	...
	int GetPureRepPrice (int repIndex, int state, int posState) {
		int price;
		if (repIndex == 0) {
			price = com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice0(_isRepG0[state]);
			price += com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder
				.GetPrice1(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
		} else {
			price = com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice1(_isRepG0[state]);
			if (repIndex == 1)
				price += com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice0(_isRepG1[state]);
			else {
				price += com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice1(_isRepG1[state]);
				price += com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice(_isRepG2[state], repIndex - 2);
			}
		}
		return price;
	}
	...
	int GetOptimum (int position) throws IOException {
		...
		_optimum[1].Price = com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder
		...
		int matchPrice = com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder
			.GetPrice1(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]);
		int repMatchPrice = matchPrice + com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice1(_isRep[_state]);
		...
		int normalMatchPrice = matchPrice + com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice0(_isRep[_state]);
		...
		while (true) {
			...
			matchPrice = curPrice + com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder
				.GetPrice1(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]);
			repMatchPrice = matchPrice + com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice1(_isRep[state]);
			...
			if (!nextIsChar && matchByte != currentByte) {
				...
				if (lenTest2 >= 2) {
					...
					int nextRepMatchPrice = curAnd1Price
						...
						+ com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice1(_isRep[state2]);
					{
			...
			for (int repIndex = 0; repIndex < Base.kNumRepDistances; repIndex++) {
				...
				if (lenTest < numAvailableBytesFull) {
					...
					if (lenTest2 >= 2) {
						...
						int nextMatchPrice = curAndLenCharPrice + com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder
							.GetPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]);
			...
			if (newLen >= startLen) {
				normalMatchPrice = matchPrice + com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.GetPrice0(_isRep[state]);
		...
		for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++) {
			...
			for (posSlot = Base.kEndPosModelIndex; posSlot < _distTableSize; posSlot++)
				_posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1)
					- Base.kNumAlignBits) << com.github.terefang.jmelange.gfx.libgdx.utils.compression.rangecoder.Encoder.kNumBitPriceShiftBits);
