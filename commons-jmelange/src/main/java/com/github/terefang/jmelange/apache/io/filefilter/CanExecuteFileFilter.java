 ...
 * @since 2.7
 */
public class CanExecuteFileFilter extends AbstractFileFilter
        implements Serializable {

    /** Singleton instance of <em>executable</em> filter */
    public static final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter CAN_EXECUTE = new CanExecuteFileFilter();
