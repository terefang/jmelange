 ...
 * {@link FTPFile} instance. Sometimes you will want to parse unusual listing formats, in which case you would create your own
 ...
 * f.connect(server);
 * f.login(user, password);
 * FTPFile[] files = f.listFiles("com.github.terefang.jmelange.apache.net.ftp.parser.EnterpriseUnixFTPFileEntryParser", ".");
 * </pre>
 *
