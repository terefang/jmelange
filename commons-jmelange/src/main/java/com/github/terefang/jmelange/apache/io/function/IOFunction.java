...
import com.github.terefang.jmelange.apache.io.function.Constants;
...
public interface IOFunction<T, R> {
    ...
    static <T> IOFunction<T, T> identity() {
        return com.github.terefang.jmelange.apache.io.function.Constants.IO_FUNCTION_ID;
    }
     ...
     */
    default com.github.terefang.jmelange.apache.io.function.IOConsumer<T> andThen(final Consumer<? super R> after) {
     ...
     * @see #compose(IOFunction)
     */
    default com.github.terefang.jmelange.apache.io.function.IOConsumer<T> andThen(final IOConsumer<? super R> after) {
        Objects.requireNonNull(after, "after");
        return (final T t) -> after.accept(apply(t));
    }
