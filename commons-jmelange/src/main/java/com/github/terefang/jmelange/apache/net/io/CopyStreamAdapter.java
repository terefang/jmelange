...
package com.github.terefang.jmelange.apache.net.io;

import java.util.EventListener;

import com.github.terefang.jmelange.apache.net.util.ListenerList;
 ...
 * facilitate the notification of the progress of a copy operation performed by one of the static copyStream() methods in com.github.terefang.jmelange.apache.io.Util to multiple
...
public class CopyStreamAdapter implements CopyStreamListener {
    ...
    /**
     * This method is not part of the JavaBeans model and is used by the static methods in the com.github.terefang.jmelange.apache.io.Util class for efficiency. It is invoked
