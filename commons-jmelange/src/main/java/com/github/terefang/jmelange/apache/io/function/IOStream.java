...
import com.github.terefang.jmelange.apache.io.function.*;
import com.github.terefang.jmelange.apache.io.function.Erase;
...
public interface IOStream<T> extends IOBaseStream<T, IOStream<T>, Stream<T>>
{
    ...
    default boolean allMatch(final IOPredicate<? super T> predicate) throws IOException {
        return unwrap().allMatch(t -> com.github.terefang.jmelange.apache.io.function.Erase.test(predicate, t));
    }
    ...
    default boolean anyMatch(final IOPredicate<? super T> predicate) throws IOException {
        return unwrap().anyMatch(t -> com.github.terefang.jmelange.apache.io.function.Erase.test(predicate, t));
    }
    ...
    default <R> R collect(final IOSupplier<R> supplier, final IOBiConsumer<R, ? super T> accumulator, final IOBiConsumer<R, R> combiner) throws IOException {
        return unwrap().collect(() -> com.github.terefang.jmelange.apache.io.function.Erase.get(supplier), (t, u) -> com.github.terefang.jmelange.apache.io.function.Erase.accept(accumulator, t, u), (t, u) -> com.github.terefang.jmelange.apache.io.function.Erase.accept(combiner, t, u));
    }
    ...
    default IOStream<T> filter(final IOPredicate<? super T> predicate) throws IOException {
        return adapt(unwrap().filter(t -> com.github.terefang.jmelange.apache.io.function.Erase.test(predicate, t)));
    }
    ...
    default <R> IOStream<R> flatMap(final IOFunction<? super T, ? extends IOStream<? extends R>> mapper) throws IOException {
        return adapt(unwrap().flatMap(t -> com.github.terefang.jmelange.apache.io.function.Erase.apply(mapper, t).unwrap()));
    }
    ...
    default DoubleStream flatMapToDouble(final IOFunction<? super T, ? extends DoubleStream> mapper) throws IOException {
        return unwrap().flatMapToDouble(t -> com.github.terefang.jmelange.apache.io.function.Erase.apply(mapper, t));
    }
    ...
    default IntStream flatMapToInt(final IOFunction<? super T, ? extends IntStream> mapper) throws IOException {
        return unwrap().flatMapToInt(t -> com.github.terefang.jmelange.apache.io.function.Erase.apply(mapper, t));
    }
    ...
    default LongStream flatMapToLong(final IOFunction<? super T, ? extends LongStream> mapper) throws IOException {
        return unwrap().flatMapToLong(t -> com.github.terefang.jmelange.apache.io.function.Erase.apply(mapper, t));
    }
    ...
    default void forEach(final IOConsumer<? super T> action) throws IOException {
        unwrap().forEach(e -> com.github.terefang.jmelange.apache.io.function.Erase.accept(action, e));
    }
    ...
    default void forEachOrdered(final IOConsumer<? super T> action) throws IOException {
        unwrap().forEachOrdered(e -> com.github.terefang.jmelange.apache.io.function.Erase.accept(action, e));
    }
    ...
    default <R> IOStream<R> map(final IOFunction<? super T, ? extends R> mapper) throws IOException {
        return adapt(unwrap().map(t -> com.github.terefang.jmelange.apache.io.function.Erase.apply(mapper, t)));
    }
    ...
    default Optional<T> max(final IOComparator<? super T> comparator) throws IOException {
        return unwrap().max((t, u) -> com.github.terefang.jmelange.apache.io.function.Erase.compare(comparator, t, u));
    }
    ...
    default Optional<T> min(final IOComparator<? super T> comparator) throws IOException {
        return unwrap().min((t, u) -> com.github.terefang.jmelange.apache.io.function.Erase.compare(comparator, t, u));
    }
    ...
    default boolean noneMatch(final IOPredicate<? super T> predicate) throws IOException {
        return unwrap().noneMatch(t -> com.github.terefang.jmelange.apache.io.function.Erase.test(predicate, t));
    }
    ...
    default IOStream<T> peek(final IOConsumer<? super T> action) throws IOException {
        return adapt(unwrap().peek(t -> com.github.terefang.jmelange.apache.io.function.Erase.accept(action, t)));
    }
    ...
    default Optional<T> reduce(final IOBinaryOperator<T> accumulator) throws IOException {
        return unwrap().reduce((t, u) -> com.github.terefang.jmelange.apache.io.function.Erase.apply(accumulator, t, u));
    }
    ...
    default T reduce(final T identity, final IOBinaryOperator<T> accumulator) throws IOException {
        return unwrap().reduce(identity, (t, u) -> com.github.terefang.jmelange.apache.io.function.Erase.apply(accumulator, t, u));
    }
    ...
    default <U> U reduce(final U identity, final IOBiFunction<U, ? super T, U> accumulator, final IOBinaryOperator<U> combiner) throws IOException {
        return unwrap().reduce(identity, (t, u) -> com.github.terefang.jmelange.apache.io.function.Erase.apply(accumulator, t, u), (t, u) -> com.github.terefang.jmelange.apache.io.function.Erase.apply(combiner, t, u));
    }
