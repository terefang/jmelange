...
import com.github.terefang.jmelange.apache.text.similarity.CharSequenceTokenizer;
import com.github.terefang.jmelange.apache.text.similarity.Tokenizer;

/**
 * A simple word {@link com.github.terefang.jmelange.apache.text.similarity.Tokenizer} that utilizes a regex to find words. It applies a regex {@code (\w)+} over the input text to extract words from a given
 * character sequence.
 * <p>
