 ...
 *
 * @see com.github.terefang.jmelange.apache.io.function.IOBiFunction
 * @see BinaryOperator
 * @since 2.12.0
 */
@FunctionalInterface
public interface IOBinaryOperator<T> extends IOBiFunction<T, T, T>
{
     ...
     */
    static <T> IOBinaryOperator<T> maxBy(final com.github.terefang.jmelange.apache.io.function.IOComparator<? super T> comparator) {
