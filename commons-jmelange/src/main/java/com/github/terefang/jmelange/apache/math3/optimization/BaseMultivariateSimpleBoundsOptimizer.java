...
public interface BaseMultivariateSimpleBoundsOptimizer<FUNC extends MultivariateFunction>
     ...
     * @throws com.github.terefang.jmelange.apache.math3.exception.NumberIsTooSmallException if any
     * of the initial values is less than its lower bound.
     * @throws com.github.terefang.jmelange.apache.math3.exception.NumberIsTooLargeException if any
