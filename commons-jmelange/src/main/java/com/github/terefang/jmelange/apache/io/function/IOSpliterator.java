...
import com.github.terefang.jmelange.apache.io.function.IOComparator;
import com.github.terefang.jmelange.apache.io.function.IOConsumer;
import com.github.terefang.jmelange.apache.io.function.IOSpliteratorAdapter;
import com.github.terefang.jmelange.apache.io.function.UncheckedIOSpliterator;
...
public interface IOSpliterator<T> {
     ...
     */
    default void forEachRemaining(final com.github.terefang.jmelange.apache.io.function.IOConsumer<? super T> action) {
    ...
    default com.github.terefang.jmelange.apache.io.function.IOComparator<? super T> getComparator() {
