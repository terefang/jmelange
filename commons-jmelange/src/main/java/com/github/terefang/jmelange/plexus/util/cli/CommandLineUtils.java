...
import com.github.terefang.jmelange.plexus.util.cli.*;
import com.github.terefang.jmelange.plexus.util.cli.Commandline;
import com.github.terefang.jmelange.plexus.util.cli.StreamConsumer;
import com.github.terefang.jmelange.plexus.util.cli.StreamFeeder;
import com.github.terefang.jmelange.plexus.util.cli.StreamPumper;
...
public abstract class CommandLineUtils {
     ...
     * @see #getOutput()
     */
    public static class StringStreamConsumer implements com.github.terefang.jmelange.plexus.util.cli.StreamConsumer
    {
    ...
    public static int executeCommandLine(com.github.terefang.jmelange.plexus.util.cli.Commandline cl, com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemOut, com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemErr)
    ...
    public static int executeCommandLine(
            com.github.terefang.jmelange.plexus.util.cli.Commandline cl, com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemOut, com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemErr, int timeoutInSeconds)
            throws CommandLineException {
        return executeCommandLine(cl, null, systemOut, systemErr, timeoutInSeconds);
    }

    public static int executeCommandLine(
            com.github.terefang.jmelange.plexus.util.cli.Commandline cl, InputStream systemIn, com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemOut, com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemErr)
            throws CommandLineException {
     ...
     */
    public static int executeCommandLine(
            com.github.terefang.jmelange.plexus.util.cli.Commandline cl,
            InputStream systemIn,
            com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemOut,
            com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemErr,
    ...
    public static CommandLineCallable executeCommandLineAsCallable(
            ...
            final com.github.terefang.jmelange.plexus.util.cli.StreamConsumer systemOut,
        ...
        return new CommandLineCallable() {
            ...
            public Integer call() throws CommandLineException {
                com.github.terefang.jmelange.plexus.util.cli.StreamFeeder inputFeeder  = null;
                com.github.terefang.jmelange.plexus.util.cli.StreamPumper outputPumper = null;
                com.github.terefang.jmelange.plexus.util.cli.StreamPumper errorPumper  = null;
                boolean                                   success      = false;
                try {
                    if (systemIn != null) {
                        inputFeeder = new com.github.terefang.jmelange.plexus.util.cli.StreamFeeder(systemIn, p.getOutputStream());
                        inputFeeder.start();
                    }

                    outputPumper = new com.github.terefang.jmelange.plexus.util.cli.StreamPumper(p.getInputStream(), systemOut);
                    outputPumper.start();

                    errorPumper = new com.github.terefang.jmelange.plexus.util.cli.StreamPumper(p.getErrorStream(), systemErr);
                    errorPumper.start();
