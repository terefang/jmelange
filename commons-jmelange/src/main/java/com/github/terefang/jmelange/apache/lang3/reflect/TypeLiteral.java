 ...
 * </p>
 * <p>Additionally {@link TypeLiteral} implements the {@link com.github.terefang.jmelange.apache.lang3.reflect.Typed} interface which
...
public abstract class TypeLiteral<T> implements Typed<T>
{
    ...
    protected TypeLiteral() {
        this.value =
            Validate.notNull(com.github.terefang.jmelange.apache.lang3.reflect.TypeUtils.getTypeArguments(getClass(), TypeLiteral.class).get(T),
                "%s does not assign type parameter %s", getClass(), com.github.terefang.jmelange.apache.lang3.reflect.TypeUtils.toLongString(T));

        this.toString = String.format("%s<%s>", TypeLiteral.class.getSimpleName(), com.github.terefang.jmelange.apache.lang3.reflect.TypeUtils.toString(value));
    }
