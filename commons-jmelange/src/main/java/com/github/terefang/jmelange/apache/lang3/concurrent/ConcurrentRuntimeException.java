 ...
 *
 * <p>
 * This class is an analogue of the {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException} exception class.
 * However, it is a runtime exception and thus does not need explicit catch
 * clauses. Some methods of {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils} throw {@code
...
public class ConcurrentRuntimeException extends RuntimeException {
    ...
    public ConcurrentRuntimeException(final String msg, final Throwable cause) {
        super(msg, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils.checkedException(cause));
    }
