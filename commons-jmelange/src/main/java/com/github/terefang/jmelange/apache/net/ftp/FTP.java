...
import com.github.terefang.jmelange.apache.net.ProtocolCommandSupport;
import com.github.terefang.jmelange.apache.net.SocketClient;
import com.github.terefang.jmelange.apache.net.io.CRLFLineReader;
import com.github.terefang.jmelange.apache.net.util.NetConstants;

/**
 * FTP provides the basic the functionality necessary to implement your own FTP client. It extends com.github.terefang.jmelange.apache.net.SocketClient since extending
 ...
 * to use the FTP class. The {@link FTPClient} class, derived from FTP, implements all the functionality required of an FTP client.
 ...
 * method encountering that reply will throw an {@link FTPConnectionClosedException}. {@code FTPConectionClosedException} is a
...
//    public static final int GZIP_TRANSFER_MODE = 14;
     ...
     * data connection. If you don't need this low level of access, use {@link FTPClient} , which will handle all low level details
     * for you.
     *
