...
package com.github.terefang.jmelange.apache.codec.language.bm;
...
import com.github.terefang.jmelange.apache.codec.language.bm.Lang;
import com.github.terefang.jmelange.apache.codec.language.bm.Languages;
import com.github.terefang.jmelange.apache.codec.language.bm.Languages.LanguageSet;
import com.github.terefang.jmelange.apache.codec.language.bm.NameType;
import com.github.terefang.jmelange.apache.codec.language.bm.Rule;
import com.github.terefang.jmelange.apache.codec.language.bm.Rule.Phoneme;
import com.github.terefang.jmelange.apache.codec.language.bm.RuleType;
...
public class PhoneticEngine {
    ...
    static final class PhonemeBuilder {
         ...
         */
        public void apply(final com.github.terefang.jmelange.apache.codec.language.bm.Rule.PhonemeExpr phonemeExpr, final int maxPhonemes) {
            final Set<Phoneme> newPhonemes = new LinkedHashSet<>(Math.min(phonemes.size() * phonemeExpr.size(), maxPhonemes));
            EXPR: for (final Phoneme left : phonemes) {
    ...
    private static final class RulesApplication {
        ...
        private final Map<String, List<com.github.terefang.jmelange.apache.codec.language.bm.Rule>> finalRules;
        ...
        public RulesApplication(final Map<String, List<com.github.terefang.jmelange.apache.codec.language.bm.Rule>> finalRules, final CharSequence input, final PhonemeBuilder phonemeBuilder, final int i,
        ...
        public RulesApplication invoke() {
            found = false;
            int                                                   patternLength = 1;
            final List<com.github.terefang.jmelange.apache.codec.language.bm.Rule> rules         = finalRules.get(input.subSequence(i, i + patternLength));
            if (rules != null) {
                for (final com.github.terefang.jmelange.apache.codec.language.bm.Rule rule : rules) {
    ...
    private static final Map<com.github.terefang.jmelange.apache.codec.language.bm.NameType, Set<String>> NAME_PREFIXES = new EnumMap<>(com.github.terefang.jmelange.apache.codec.language.bm.NameType.class);

    static {
        NAME_PREFIXES.put(com.github.terefang.jmelange.apache.codec.language.bm.NameType.ASHKENAZI,
                Collections.unmodifiableSet(
                        new HashSet<>(Arrays.asList("bar", "ben", "da", "de", "van", "von"))));
        NAME_PREFIXES.put(com.github.terefang.jmelange.apache.codec.language.bm.NameType.SEPHARDIC,
                Collections.unmodifiableSet(
                        new HashSet<>(Arrays.asList("al", "el", "da", "dal", "de", "del", "dela", "de la",
                                                          "della", "des", "di", "do", "dos", "du", "van", "von"))));
        NAME_PREFIXES.put(com.github.terefang.jmelange.apache.codec.language.bm.NameType.GENERIC,
                Collections.unmodifiableSet(
    ...
    private final com.github.terefang.jmelange.apache.codec.language.bm.Lang lang;

    private final com.github.terefang.jmelange.apache.codec.language.bm.NameType nameType;

    private final com.github.terefang.jmelange.apache.codec.language.bm.RuleType ruleType;
     ...
     */
    public PhoneticEngine(final com.github.terefang.jmelange.apache.codec.language.bm.NameType nameType, final com.github.terefang.jmelange.apache.codec.language.bm.RuleType ruleType, final boolean concatenate) {
     ...
     * @since 1.7
     */
    public PhoneticEngine(final com.github.terefang.jmelange.apache.codec.language.bm.NameType nameType, final com.github.terefang.jmelange.apache.codec.language.bm.RuleType ruleType, final boolean concatenate, final int maxPhonemes) {
        if (ruleType == com.github.terefang.jmelange.apache.codec.language.bm.RuleType.RULES) {
            throw new IllegalArgumentException("ruleType must not be " + com.github.terefang.jmelange.apache.codec.language.bm.RuleType.RULES);
        }
        this.nameType = nameType;
        this.ruleType = ruleType;
        this.concat = concatenate;
        this.lang = com.github.terefang.jmelange.apache.codec.language.bm.Lang.instance(nameType);
        this.maxPhonemes = maxPhonemes;
    }
    ...
    private PhonemeBuilder applyFinalRules(final PhonemeBuilder phonemeBuilder,
            final Map<String, List<com.github.terefang.jmelange.apache.codec.language.bm.Rule>> finalRules) {
        Objects.requireNonNull(finalRules, "finalRules");
    ...
    public String encode(String input, final LanguageSet languageSet) {
        final Map<String, List<com.github.terefang.jmelange.apache.codec.language.bm.Rule>> rules = com.github.terefang.jmelange.apache.codec.language.bm.Rule.getInstanceMap(this.nameType, com.github.terefang.jmelange.apache.codec.language.bm.RuleType.RULES, languageSet);
        // rules common across many (all) languages
        final Map<String, List<com.github.terefang.jmelange.apache.codec.language.bm.Rule>> finalRules1 = com.github.terefang.jmelange.apache.codec.language.bm.Rule.getInstanceMap(this.nameType, this.ruleType, "common");
        // rules that apply to a specific language that may be ambiguous or wrong if applied to other languages
        final Map<String, List<com.github.terefang.jmelange.apache.codec.language.bm.Rule>> finalRules2 = Rule.getInstanceMap(this.nameType, this.ruleType, languageSet);

        // tidy the input
        // lower case is a locale-dependent operation
        input = input.toLowerCase(Locale.ENGLISH).replace('-', ' ').trim();

        if (this.nameType == com.github.terefang.jmelange.apache.codec.language.bm.NameType.GENERIC) {
