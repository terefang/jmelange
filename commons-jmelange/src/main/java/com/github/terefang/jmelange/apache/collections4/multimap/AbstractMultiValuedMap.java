 ...
 */
package com.github.terefang.jmelange.apache.collections4.multimap;
...
import com.github.terefang.jmelange.apache.collections4.CollectionUtils;
import com.github.terefang.jmelange.apache.collections4.IteratorUtils;
import com.github.terefang.jmelange.apache.collections4.MapIterator;
import com.github.terefang.jmelange.apache.collections4.MultiSet;
import com.github.terefang.jmelange.apache.collections4.MultiValuedMap;
import com.github.terefang.jmelange.apache.collections4.Transformer;
import com.github.terefang.jmelange.apache.collections4.iterators.AbstractIteratorDecorator;
...
import com.github.terefang.jmelange.apache.collections4.iterators.LazyIteratorChain;
import com.github.terefang.jmelange.apache.collections4.iterators.TransformIterator;
import com.github.terefang.jmelange.apache.collections4.keyvalue.AbstractMapEntry;
import com.github.terefang.jmelange.apache.collections4.keyvalue.UnmodifiableMapEntry;
import com.github.terefang.jmelange.apache.collections4.multiset.AbstractMultiSet;
import com.github.terefang.jmelange.apache.collections4.multiset.UnmodifiableMultiSet;
...
public abstract class AbstractMultiValuedMap<K, V> implements MultiValuedMap<K, V> {
    ...
    private final class AsMap extends AbstractMap<K, Collection<V>> {
        final class AsMapEntrySet extends AbstractSet<Entry<K, Collection<V>>> {
         ...
         */
        final class AsMapEntrySetIterator extends AbstractIteratorDecorator<Entry<K, Collection<V>>> {

            AsMapEntrySetIterator(final Iterator<Entry<K, Collection<V>>> iterator) {
                super(iterator);
            }
    ...
    private final class KeysMultiSet extends AbstractMultiSet<K> {
        ...
        private final class MapEntryTransformer implements Transformer<Map.Entry<K, Collection<V>>, Entry<K>> {

            @Override
            public Entry<K> transform(final Map.Entry<K, Collection<V>> mapEntry) {
        ...
        @Override
        protected Iterator<Entry<K>> createEntrySetIterator() {
    ...
    protected void doWriteObject(final ObjectOutputStream out) throws IOException {
        ...
        for (final Entry<K, Collection<V>> entry : map.entrySet()) {
