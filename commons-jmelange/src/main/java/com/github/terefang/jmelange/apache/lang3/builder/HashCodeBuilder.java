...
import com.github.terefang.jmelange.apache.lang3.builder.HashCodeExclude;
...
public class HashCodeBuilder implements Builder<Integer>
{
     ...
     * @since 2.3
     */
    private static final ThreadLocal<Set<com.github.terefang.jmelange.apache.lang3.builder.IDKey>> REGISTRY = ThreadLocal.withInitial(HashSet::new);
     ...
     * @since 2.3
     */
    static Set<com.github.terefang.jmelange.apache.lang3.builder.IDKey> getRegistry() {
        return REGISTRY.get();
    }
    ...
    static boolean isRegistered(final Object value) {
        final Set<com.github.terefang.jmelange.apache.lang3.builder.IDKey> registry = getRegistry();
        return registry != null && registry.contains(new com.github.terefang.jmelange.apache.lang3.builder.IDKey(value));
    }
    ...
    private static void register(final Object value) {
        getRegistry().add(new com.github.terefang.jmelange.apache.lang3.builder.IDKey(value));
    }
    ...
    private static void unregister(final Object value) {
        final Set<com.github.terefang.jmelange.apache.lang3.builder.IDKey> registry = getRegistry();
        registry.remove(new com.github.terefang.jmelange.apache.lang3.builder.IDKey(value));
        if (registry.isEmpty()) {
            REGISTRY.remove();
        }
    }
