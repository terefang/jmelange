 ...
 */
package com.github.terefang.jmelange.apache.net.ftp;
...
import com.github.terefang.jmelange.apache.net.ftp.parser.FTPFileEntryParserFactory;
import com.github.terefang.jmelange.apache.net.ftp.parser.MLSxEntryParser;
import com.github.terefang.jmelange.apache.net.ftp.parser.ParserInitializationException;
import com.github.terefang.jmelange.apache.net.io.*;
import com.github.terefang.jmelange.apache.net.MalformedServerReplyException;
import com.github.terefang.jmelange.apache.net.ftp.parser.DefaultFTPFileEntryParserFactory;
import com.github.terefang.jmelange.apache.net.io.CopyStreamListener;
import com.github.terefang.jmelange.apache.net.io.FromNetASCIIInputStream;
import com.github.terefang.jmelange.apache.net.io.SocketOutputStream;
import com.github.terefang.jmelange.apache.net.io.ToNetASCIIOutputStream;
import com.github.terefang.jmelange.apache.net.util.NetConstants;
 ...
 * {@link SocketClient}, you must first connect to the server with {@link SocketClient#connect connect } before
 * doing anything, and finally {@link SocketClient#disconnect() disconnect} after you're completely finished interacting with the server.
 ...
 * FTP reply code causing a success or failure, you must call {@link FTP#getReplyCode getReplyCode } after a success or failure.
 * </p>
 * <p>
 ...
 * {@link FTPReply#SERVICE_NOT_AVAILABLE FTPReply.SERVICE_NOT_AVAILABLE } response to a command. When that occurs, the FTP class
 * method encountering that reply will throw an {@link FTPConnectionClosedException} . {@code FTPConnectionClosedException} is a
 ...
 * before the more general {@code IOException} catch block. When you encounter an {@link FTPConnectionClosedException} , you
 ...
 * may check the last reply code and text with {@link FTP#getReplyCode getReplyCode },
 * {@link FTP#getReplyString getReplyString }, and {@link FTP#getReplyStrings getReplyStrings}. You may
 ...
 * com.github.terefang.jmelange.apache.net.FTPFileEntryParser:
 * </p>
 *
 * <pre>
 * FTPClient f = new FTPClient();
...
public class FTPClient extends FTP implements Configurable {
     ...
     * @since 3.0
     */
    public static final String FTP_SYSTEM_TYPE = "com.github.terefang.jmelange.apache.net.ftp.systemType";
     ...
     * @since 3.1
     */
    public static final String FTP_SYSTEM_TYPE_DEFAULT = "com.github.terefang.jmelange.apache.net.ftp.systemType.default";
     ...
     * @since 3.9.0
     */
    public static final String FTP_IP_ADDRESS_FROM_PASV_RESPONSE = "com.github.terefang.jmelange.apache.net.ftp.ipAddressFromPasvResponse";
     ...
     * <pre>
     * Plan 9=Unix
     * OS410=com.github.terefang.jmelange.apache.net.ftp.parser.OS400FTPEntryParser
     * </pre>
     *
     * @since 3.0
     */
     ...
     * @throws CopyStreamException If an I/O error occurs while actually transferring the file. The CopyStreamException allows you to
     ...
     * @throws ParserInitializationException Thrown if the autodetect mechanism cannot resolve the type of system we are
     *                                                                         connected with.
     ...
     * @throws IOException                                                     If an I/O error occurs while either sending a command to the server or receiving
     *                                                                         a reply from the server.
     * @throws ParserInitializationException Thrown if the parserKey parameter cannot be resolved by the selected parser
     ...
     *                                                                         com.github.terefang.jmelange.apache.net.ftp.FTPFileEntryParser nor a string containing one of the
