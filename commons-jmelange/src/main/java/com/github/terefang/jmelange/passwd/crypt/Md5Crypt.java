...
public class Md5Crypt {
    ...
    public static String apr1Crypt(final byte[] keyBytes) {
        return apr1Crypt(keyBytes, APR1_PREFIX + B64T.getRandomSalt(8));
    }
    ...
    public static String apr1Crypt(final byte[] keyBytes, final Random random) {
        return apr1Crypt(keyBytes, APR1_PREFIX + B64T.getRandomSalt(8, random));
    }
    ...
    public static String md5Crypt(final byte[] keyBytes) {
        return md5Crypt(keyBytes, MD5_PREFIX + B64T.getRandomSalt(8));
    }
    ...
    public static String md5Crypt(final byte[] keyBytes, final Random random) {
        return md5Crypt(keyBytes, MD5_PREFIX + B64T.getRandomSalt(8, random));
    }
    ...
    public static String md5Crypt(final byte[] keyBytes, final String salt, final String prefix, final Random random) {
        ...
        final MessageDigest ctx = HashUtil.getMd5Digest();
         ...
         */
        MessageDigest ctx1 = HashUtil.getMd5Digest();
        ...
        B64T.b64from24bit(finalb[0], finalb[6], finalb[12], 4, passwd);
        B64T.b64from24bit(finalb[1], finalb[7], finalb[13], 4, passwd);
        B64T.b64from24bit(finalb[2], finalb[8], finalb[14], 4, passwd);
        B64T.b64from24bit(finalb[3], finalb[9], finalb[15], 4, passwd);
        B64T.b64from24bit(finalb[4], finalb[10], finalb[5], 4, passwd);
        B64T.b64from24bit((byte) 0, (byte) 0, finalb[11], 2, passwd);
