 ...
 * specific errors. You would only want to do this if you were building your own TFTP client or server on top of the {@link TFTP}
 * class if you wanted more functionality than the {@link TFTPClient#receiveFile receiveFile()} and
 * {@link TFTPClient#sendFile sendFile()} methods provide.
 *
 *
 * @see TFTPPacket
 * @see TFTP
