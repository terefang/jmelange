...
import com.github.terefang.jmelange.apache.lang3.Functions;
import com.github.terefang.jmelange.apache.lang3.Functions.FailableConsumer;
import com.github.terefang.jmelange.apache.lang3.Functions.FailableFunction;
import com.github.terefang.jmelange.apache.lang3.Functions.FailablePredicate;
 ...
 *
 * @see Stream
 * @see com.github.terefang.jmelange.apache.lang3.Functions
 * @since 3.10
 * @deprecated Use {@link com.github.terefang.jmelange.apache.lang3.stream.Streams}.
 */
@Deprecated
public class Streams {
     ...
     * @deprecated Use {@link com.github.terefang.jmelange.apache.lang3.stream.Streams.ArrayCollector}.
     */
    @Deprecated
     ...
     * @deprecated Use {@link com.github.terefang.jmelange.apache.lang3.stream.Streams.FailableStream}.
     */
    @Deprecated
    public static class FailableStream<O> {
        ...
        public boolean allMatch(final FailablePredicate<O, ?> predicate) {
            assertNotTerminated();
            return stream().allMatch(com.github.terefang.jmelange.apache.lang3.Functions.asPredicate(predicate));
        }
        ...
        public boolean anyMatch(final FailablePredicate<O, ?> predicate) {
            assertNotTerminated();
            return stream().anyMatch(com.github.terefang.jmelange.apache.lang3.Functions.asPredicate(predicate));
        }
        ...
        public FailableStream<O> filter(final FailablePredicate<O, ?> predicate) {
            assertNotTerminated();
            stream = stream.filter(com.github.terefang.jmelange.apache.lang3.Functions.asPredicate(predicate));
            return this;
        }
        ...
        public void forEach(final FailableConsumer<O, ?> action) {
            makeTerminated();
            stream().forEach(com.github.terefang.jmelange.apache.lang3.Functions.asConsumer(action));
        }
