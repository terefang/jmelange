...
public class DeferredFileOutputStream extends ThresholdingOutputStream
{
     ...
     */
    private com.github.terefang.jmelange.apache.io.output.ByteArrayOutputStream memoryOutputStream;
    ...
    private DeferredFileOutputStream(final int threshold, final File outputFile, final String prefix, final String suffix, final File directory,
        ...
        this.memoryOutputStream = new com.github.terefang.jmelange.apache.io.output.ByteArrayOutputStream(checkBufferSize(initialBufferSize));
