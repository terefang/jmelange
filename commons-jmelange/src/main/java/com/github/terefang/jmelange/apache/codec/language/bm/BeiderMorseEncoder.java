...
import com.github.terefang.jmelange.apache.codec.EncoderException;
import com.github.terefang.jmelange.apache.codec.StringEncoder;
import com.github.terefang.jmelange.apache.codec.language.bm.NameType;
import com.github.terefang.jmelange.apache.codec.language.bm.PhoneticEngine;
 ...
 * and may not be thread-safe. If you require a guaranteed thread-safe encoding then use {@link com.github.terefang.jmelange.apache.codec.language.bm.PhoneticEngine}
 * directly.
 * </p>
...
public class BeiderMorseEncoder implements StringEncoder {
    ...
    // a cached object
    private com.github.terefang.jmelange.apache.codec.language.bm.PhoneticEngine engine = new com.github.terefang.jmelange.apache.codec.language.bm.PhoneticEngine(com.github.terefang.jmelange.apache.codec.language.bm.NameType.GENERIC, com.github.terefang.jmelange.apache.codec.language.bm.RuleType.APPROX, true);
     ...
     */
    public com.github.terefang.jmelange.apache.codec.language.bm.NameType getNameType() {
     ...
     */
    public com.github.terefang.jmelange.apache.codec.language.bm.RuleType getRuleType() {
    ...
    public void setConcat(final boolean concat) {
        this.engine = new com.github.terefang.jmelange.apache.codec.language.bm.PhoneticEngine(this.engine.getNameType(),
    ...
    /**
     * Sets the type of name. Use {@link com.github.terefang.jmelange.apache.codec.language.bm.NameType#GENERIC} unless you specifically want phonetic encodings
    ...
    public void setNameType(final NameType nameType) {
        this.engine = new com.github.terefang.jmelange.apache.codec.language.bm.PhoneticEngine(nameType,
                                         this.engine.getRuleType(),
                                         this.engine.isConcat(),
                                         this.engine.getMaxPhonemes());
    }
     ...
     *
     * @param ruleType
     *            {@link com.github.terefang.jmelange.apache.codec.language.bm.RuleType#APPROX} or {@link com.github.terefang.jmelange.apache.codec.language.bm.RuleType#EXACT} for approximate or exact phonetic matches
     */
