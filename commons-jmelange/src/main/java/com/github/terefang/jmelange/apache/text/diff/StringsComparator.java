 ...
 */
package com.github.terefang.jmelange.apache.text.diff;

import com.github.terefang.jmelange.apache.text.diff.CommandVisitor;
import com.github.terefang.jmelange.apache.text.diff.DeleteCommand;
import com.github.terefang.jmelange.apache.text.diff.EditCommand;
import com.github.terefang.jmelange.apache.text.diff.EditScript;
import com.github.terefang.jmelange.apache.text.diff.InsertCommand;
import com.github.terefang.jmelange.apache.text.diff.KeepCommand;
 ...
 * the shortest possible {@link com.github.terefang.jmelange.apache.text.diff.EditScript edit script} containing all the
 * {@link com.github.terefang.jmelange.apache.text.diff.EditCommand commands} needed to transform the first sequence into
 * the second one.
 *
 * <p>
 ...
 * </p>
 *
 * @see com.github.terefang.jmelange.apache.text.diff.EditScript
 * @see EditCommand
 * @see CommandVisitor
 * @since 1.0
 */
public class StringsComparator {
    ...
    private void buildScript(final int start1, final int end1, final int start2, final int end2,
            final com.github.terefang.jmelange.apache.text.diff.EditScript<Character> script) {
        ...
        if (middle == null
            ...
            while (i < end1 || j < end2) {
                if (i < end1 && j < end2 && left.charAt(i) == right.charAt(j)) {
                    script.append(new com.github.terefang.jmelange.apache.text.diff.KeepCommand<>(left.charAt(i)));
                    ++i;
                    ++j;
                } else if (end1 - start1 > end2 - start2) {
                    script.append(new com.github.terefang.jmelange.apache.text.diff.DeleteCommand<>(left.charAt(i)));
                    ++i;
                } else {
                    script.append(new com.github.terefang.jmelange.apache.text.diff.InsertCommand<>(right.charAt(j)));
                    ++j;
                }
            }
    ...
    /**
     * Gets the {@link com.github.terefang.jmelange.apache.text.diff.EditScript} object.
     * <p>
     ...
     *         sequences
     */
    public com.github.terefang.jmelange.apache.text.diff.EditScript<Character> getScript() {
        final com.github.terefang.jmelange.apache.text.diff.EditScript<Character> script = new EditScript<>();
