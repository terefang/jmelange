...
import com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException;
...
/**
 * A specialized {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} implementation that can deal with
 * multiple background initialization tasks.
 *
 * <p>
 * This class has a similar purpose as {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer}. However,
 * it is not limited to a single background initialization task. Rather it
 * manages an arbitrary number of {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} objects,
 ...
 * with the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} objects it is responsible for; so the
 ...
 * is complete.</li>
 * <li>Create specialized {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} objects for the
 * initialization tasks to be performed and add them to the {@code
 * MultiBackgroundInitializer} using the
 * {@link #addInitializer(String, com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer)} method.</li>
 ...
 * starts all {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} objects added to the instance.
 ...
 * starts all registered {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} objects and waits for
...
public class MultiBackgroundInitializer
        extends
        com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<MultiBackgroundInitializer.MultiBackgroundInitializerResults>
{
     ...
     * {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} objects managed by the owning instance. It
     * is also possible to retrieve status information about single
     * {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer}s, i.e. whether they completed normally or
     * caused an exception.
     */
    public static class MultiBackgroundInitializerResults {
        /** A map with the child initializers. */
        private final Map<String, com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<?>> initializers;

        /** A map with the result objects. */
        private final Map<String, Object> resultObjects;

        /** A map with the exceptions. */
        private final Map<String, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException> exceptions;

        /**
         * Creates a new instance of {@link MultiBackgroundInitializerResults}
         * and initializes it with maps for the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer}
         * objects, their result objects and the exceptions thrown by them.
         *
         * @param inits the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} objects
         * @param results the result objects
         * @param excepts the exceptions
         */
        private MultiBackgroundInitializerResults(
                final Map<String, com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<?>> inits,
                final Map<String, Object> results,
                final Map<String, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException> excepts) {
            initializers = inits;
         ...
         */
        private com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<?> checkName(final String name) {
            final com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<?> init = initializers.get(name);
            if (init == null) {
        ...
        /**
         * Returns the {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException} object that was thrown by the
         * {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} with the given name. If this
         * initializer did not throw an exception, the return value is
         * <b>null</b>. If the name cannot be resolved, an exception is thrown.
         *
         * @param name the name of the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer}
         * @return the exception thrown by this initializer
         * @throws NoSuchElementException if the name cannot be resolved
         */
        public com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException getException(final String name) {
            checkName(name);
            return exceptions.get(name);
        }

        /**
         * Returns the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} with the given name. If the
         * name cannot be resolved, an exception is thrown.
         *
         * @param name the name of the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer}
         * @return the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} with this name
         * @throws NoSuchElementException if the name cannot be resolved
         */
        public com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<?> getInitializer(final String name) {
         ...
         * {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} caused an exception, <b>null</b> is
        ...
        /**
         * Returns a set with the names of all {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer}
        ...
        /**
         * Returns a flag whether the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} with the
    ...
    /** A map with the child initializers. */
    private final Map<String, com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<?>> childInitializers = new HashMap<>();
    ...
    /**
     * Adds a new {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} to this object. When this
     ...
     * @param backgroundInitializer the {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} to add (must not be
     * <b>null</b>)
     * @throws NullPointerException if either {@code name} or {@code backgroundInitializer}
     *         is {@code null}
     * @throws IllegalStateException if {@code start()} has already been called
     */
    public void addInitializer(final String name, final com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<?> backgroundInitializer) {
     ...
     *
     * @throws com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException throws an ConcurrentException that will have all other exceptions as suppressed exceptions. ConcurrentException thrown by children will be unwrapped.
     * @since 3.14.0
     */
    @Override
    public void close() throws com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException
    {
        com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException exception = null;

        for (final com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer<?> child : childInitializers.values()) {
            try {
                child.close();
            } catch (final Exception e) {
                if (exception == null) {
                    exception = new com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException();
                }

                if (e instanceof com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException) {
    ...
    protected int getTaskCount() {
        return 1 + childInitializers.values().stream().mapToInt(com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer::getTaskCount).sum();
    }
    ...
    protected MultiBackgroundInitializerResults initialize() throws Exception {
        ...
        final Map<String, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException> excepts = new HashMap<>();
        inits.forEach((k, v) -> {
            try {
                results.put(k, v.get());
