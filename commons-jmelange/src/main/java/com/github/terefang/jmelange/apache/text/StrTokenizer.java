...
import com.github.terefang.jmelange.apache.text.StringTokenizer;
...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    static {
        ...
        CSV_TOKENIZER_PROTOTYPE.setDelimiterMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.commaMatcher());
        CSV_TOKENIZER_PROTOTYPE.setQuoteMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.doubleQuoteMatcher());
        CSV_TOKENIZER_PROTOTYPE.setIgnoredMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.noneMatcher());
        CSV_TOKENIZER_PROTOTYPE.setTrimmerMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.trimMatcher());
        CSV_TOKENIZER_PROTOTYPE.setEmptyTokenAsNull(false);
        CSV_TOKENIZER_PROTOTYPE.setIgnoreEmptyTokens(false);

        TSV_TOKENIZER_PROTOTYPE = new StrTokenizer();
        TSV_TOKENIZER_PROTOTYPE.setDelimiterMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.tabMatcher());
        TSV_TOKENIZER_PROTOTYPE.setQuoteMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.doubleQuoteMatcher());
        TSV_TOKENIZER_PROTOTYPE.setIgnoredMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.noneMatcher());
        TSV_TOKENIZER_PROTOTYPE.setTrimmerMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.trimMatcher());
    ...
    private com.github.terefang.jmelange.apache.text.StrMatcher delimMatcher = com.github.terefang.jmelange.apache.text.StrMatcher.splitMatcher();

    /** The quote matcher. */
    private com.github.terefang.jmelange.apache.text.StrMatcher quoteMatcher = com.github.terefang.jmelange.apache.text.StrMatcher.noneMatcher();

    /** The ignored matcher. */
    private com.github.terefang.jmelange.apache.text.StrMatcher ignoredMatcher = com.github.terefang.jmelange.apache.text.StrMatcher.noneMatcher();

    /** The trimmer matcher. */
    private com.github.terefang.jmelange.apache.text.StrMatcher trimmerMatcher = com.github.terefang.jmelange.apache.text.StrMatcher.noneMatcher();
     ...
     */
    public StrTokenizer(final char[] input, final com.github.terefang.jmelange.apache.text.StrMatcher delim) {
        this(input);
     ...
     * @param quote  the field quoted string character
     */
    public StrTokenizer(final char[] input, final com.github.terefang.jmelange.apache.text.StrMatcher delim, final com.github.terefang.jmelange.apache.text.StrMatcher quote) {
        this(input, delim);
     ...
     * @param delim  the field delimiter matcher
     */
    public StrTokenizer(final String input, final com.github.terefang.jmelange.apache.text.StrMatcher delim) {
        this(input);
        setDelimiterMatcher(delim);
    }
     ...
     */
    public StrTokenizer(final String input, final com.github.terefang.jmelange.apache.text.StrMatcher delim, final com.github.terefang.jmelange.apache.text.StrMatcher quote) {
        this(input, delim);
        setQuoteMatcher(quote);
    }
     ...
     */
    public com.github.terefang.jmelange.apache.text.StrMatcher getDelimiterMatcher() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.StrMatcher getIgnoredMatcher() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.StrMatcher getQuoteMatcher() {
        return quoteMatcher;
    }
     ...
     */
    public com.github.terefang.jmelange.apache.text.StrMatcher getTrimmerMatcher() {
    ...
    private int readNextToken(final char[] srcChars,
                              int start,
                              final int len,
                              final com.github.terefang.jmelange.apache.text.StrBuilder workArea,
     ...
     */
    private int readWithQuotes(final char[] srcChars, final int start, final int len, final com.github.terefang.jmelange.apache.text.StrBuilder workArea,
    ...
    public StrTokenizer setDelimiterChar(final char delim) {
        return setDelimiterMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.charMatcher(delim));
    }
     ...
     * @return this, to enable chaining
     */
    public StrTokenizer setDelimiterMatcher(final com.github.terefang.jmelange.apache.text.StrMatcher delim) {
        if (delim == null) {
            this.delimMatcher = com.github.terefang.jmelange.apache.text.StrMatcher.noneMatcher();
        } else {
    ...
    public StrTokenizer setDelimiterString(final String delim) {
        return setDelimiterMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.stringMatcher(delim));
    }
    ...
    public StrTokenizer setIgnoredChar(final char ignored) {
        return setIgnoredMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.charMatcher(ignored));
    }
     ...
     * @return this, to enable chaining
     */
    public StrTokenizer setIgnoredMatcher(final com.github.terefang.jmelange.apache.text.StrMatcher ignored) {
        if (ignored != null) {
    ...
    public StrTokenizer setQuoteChar(final char quote) {
        return setQuoteMatcher(com.github.terefang.jmelange.apache.text.StrMatcher.charMatcher(quote));
    }
     ...
     * @return this, to enable chaining
     */
    public StrTokenizer setQuoteMatcher(final com.github.terefang.jmelange.apache.text.StrMatcher quote) {
        if (quote != null) {
    ...
    protected List<String> tokenize(final char[] srcChars, final int offset, final int count) {
        ...
        final com.github.terefang.jmelange.apache.text.StrBuilder buf       = new StrBuilder();
