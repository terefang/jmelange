...
import com.github.terefang.jmelange.apache.net.discard.DiscardTCPClient;
 ...
 * {@link SocketClient#connect connect } and call {@link DiscardTCPClient#getOutputStream getOutputStream() } to retrieve the echo output
 ...
 * {@link SocketClient#disconnect disconnect } to clean up properly.
 *
 * @see EchoUDPClient
...
public final class EchoTCPClient extends DiscardTCPClient {
     ...
     * Rather, you should call {@link SocketClient#disconnect disconnect } to clean up properly.
     *
