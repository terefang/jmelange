 ...
 * socket with {@link DatagramSocketClient#open open } and call {@link #getTime getTime } to retrieve the daytime string, then call
 * {@link DatagramSocketClient#close close } to close the connection properly. Unlike
 * {@link DaytimeTCPClient}, successive calls to {@link #getTime getTime } are permitted without re-establishing a connection.
