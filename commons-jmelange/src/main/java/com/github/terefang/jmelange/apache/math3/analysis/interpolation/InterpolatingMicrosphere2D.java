...
public class InterpolatingMicrosphere2D extends InterpolatingMicrosphere {
     ...
     * if {@code size <= 0}.
     * @throws com.github.terefang.jmelange.apache.math3.exception.NotPositiveException if
     * {@code darkThreshold < 0}.
     * @throws com.github.terefang.jmelange.apache.math3.exception.OutOfRangeException if
