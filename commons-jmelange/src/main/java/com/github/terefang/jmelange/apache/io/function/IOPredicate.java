...
public interface IOPredicate<T> {
    ...
    static <T> IOPredicate<T> alwaysFalse() {
        return (IOPredicate<T>) com.github.terefang.jmelange.apache.io.function.Constants.IO_PREDICATE_FALSE;
    }
    ...
    static <T> IOPredicate<T> alwaysTrue() {
        return (IOPredicate<T>) com.github.terefang.jmelange.apache.io.function.Constants.IO_PREDICATE_TRUE;
    }
