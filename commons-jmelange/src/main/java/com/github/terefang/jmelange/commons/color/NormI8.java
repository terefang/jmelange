...
public class NormI8 {
    ...
    // public static int pack(float phi, float rho)
    ...
    public static float[] unpack(int norm) {
        return new float[] {
                ((byte) ((norm >> X_COMPONENT_OFFSET) & 0xFF)) * NORM,
                ((byte) ((norm >> Y_COMPONENT_OFFSET) & 0xFF)) * NORM,
                ((byte) ((norm >> Z_COMPONENT_OFFSET) & 0xFF)) * NORM
        };
    }
