...
package com.github.terefang.jmelange.apache.net.pop3;
...
import com.github.terefang.jmelange.apache.net.io.DotTerminatedMessageReader;
...
public class POP3Client extends POP3 {
     ...
     * the client is in the {@link POP3#TRANSACTION_STATE TRANSACTION_STATE}.
     *
    ...
    /**
     * List an individual message. A list attempt can only succeed if the client is in the {@link POP3#TRANSACTION_STATE
    ...
    /**
     * List all messages. A list attempt can only succeed if the client is in the {@link POP3#TRANSACTION_STATE TRANSACTION_STATE} .
     ...
     * {@link POP3#TRANSACTION_STATE TRANSACTION_STATE} . Returns a POP3MessageInfo instance containing the number of the listed
     ...
     * {@link POP3#TRANSACTION_STATE TRANSACTION_STATE} . Returns an array of POP3MessageInfo instances, each containing the number
    ...
    /**
     * Login to the POP3 server with the given user and password. You must first connect to the server with {@link SocketClient#connect
     * connect} before attempting to log in. A login attempt is only valid if the client is in the {@link POP3#AUTHORIZATION_STATE
     * AUTHORIZATION_STATE }. After logging in, the client enters the {@link POP3#TRANSACTION_STATE TRANSACTION_STATE}.
     *
     ...
     * the information. Therefore, after connecting to the server, you must call {@link POP3#getReplyString getReplyString} and
     * parse out the timestamp information yourself.
     * <p>
     * You must first connect to the server with {@link SocketClient#connect connect} before attempting to log in. A login attempt is
     * only valid if the client is in the {@link POP3#AUTHORIZATION_STATE AUTHORIZATION_STATE }. After logging in, the client enters
     * the {@link POP3#TRANSACTION_STATE TRANSACTION_STATE }. After connecting, you must parse out the server specific information
    ...
    /**
     * Logout of the POP3 server. To fully disconnect from the server you must call {@link POP3#disconnect disconnect}. A logout
     * attempt is valid in any state. If the client is in the {@link POP3#TRANSACTION_STATE TRANSACTION_STATE } , it enters the
     * {@link POP3#UPDATE_STATE UPDATE_STATE } on a successful logout.
     *
     ...
     * inactivity. A noop attempt will only succeed if the client is in the {@link POP3#TRANSACTION_STATE TRANSACTION_STATE } .
     *
     ...
     * in the {@link POP3#TRANSACTION_STATE TRANSACTION_STATE } .
     *
    ...
    /**
     * Gets the mailbox status. A status attempt can only succeed if the client is in the {@link POP3#TRANSACTION_STATE
