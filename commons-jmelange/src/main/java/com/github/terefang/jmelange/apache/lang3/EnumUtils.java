...
public class EnumUtils {
    ...
    public static <E extends Enum<E>> long[] generateBitVectors(final Class<E> enumClass, final E... values) {
        ...
        com.github.terefang.jmelange.apache.lang3.ArrayUtils.reverse(result);
        return result;
    }
    ...
    public static <E extends Enum<E>> EnumSet<E> processBitVectors(final Class<E> enumClass, final long... values) {
        ...
        final long[] lvalues = com.github.terefang.jmelange.apache.lang3.ArrayUtils.clone(Objects.requireNonNull(values, "values"));
