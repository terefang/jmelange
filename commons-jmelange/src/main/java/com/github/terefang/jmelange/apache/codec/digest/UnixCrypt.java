...
public class UnixCrypt {
    ...
    private static final String CRYPT_SALT_REGEX = "^[" + com.github.terefang.jmelange.apache.codec.digest.B64.B64T_STRING + "]{2,}$";
     ...
     *            generated for you using {@link com.github.terefang.jmelange.apache.codec.digest.B64#getRandomSalt(int)}.
     * @return a 13 character string starting with the salt string
    ...
    public static String crypt(final byte[] original, String salt) {
        if (salt == null) {
            salt = com.github.terefang.jmelange.apache.codec.digest.B64.getRandomSalt(2);
