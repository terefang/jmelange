...
package com.github.terefang.jmelange.fonts.sfnt.sfntly.table.core;

import com.github.terefang.jmelange.fonts.sfnt.sfntly.data.ReadableFontData;
import com.github.terefang.jmelange.fonts.sfnt.sfntly.data.SfObjects;
...
import com.github.terefang.jmelange.fonts.sfnt.sfntly.table.SubTableContainerTable;
...
public final class NameTable extends SubTableContainerTable
  ...
  private static class NameEntryId implements Comparable<NameEntryId> {
    ...
    /**
     * @see UnicodeLanguageId
     * @see MacintoshLanguageId
     * @see WindowsLanguageId
     */
