 ...
 * {@link com.github.terefang.jmelange.apache.math3.ode.sampling.StepHandler StepHandler} instance using the
 * {@link com.github.terefang.jmelange.apache.math3.ode.FirstOrderIntegrator#addStepHandler addStepHandler}
 ...
 * com.github.terefang.jmelange.apache.math3.ode.sampling.StepHandler StepHandler} interface can be called
 ...
 * com.github.terefang.jmelange.apache.math3.ode.sampling.StepInterpolator StepInterpolator} object.
 * If regular output is desired (for example in order to write an ephemeris file), then
 * the simpler {@link com.github.terefang.jmelange.apache.math3.ode.sampling.FixedStepHandler FixedStepHandler}
 * interface can be used. Objects implementing this interface should be wrapped within a
 * {@link com.github.terefang.jmelange.apache.math3.ode.sampling.StepNormalizer StepNormalizer} instance
 * in order to be registered to the integrator.
 * </p>
 *
 *
 */
package com.github.terefang.jmelange.apache.math3.ode.sampling;
