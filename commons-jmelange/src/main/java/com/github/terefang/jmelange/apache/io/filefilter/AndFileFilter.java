...
import com.github.terefang.jmelange.apache.io.filefilter.AbstractFileFilter;
import com.github.terefang.jmelange.apache.io.filefilter.ConditionalFileFilter;
 ...
 *
 * @since 1.0
 * @see FileFilterUtils#and(com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter...)
 */
public class AndFileFilter extends AbstractFileFilter
    ...
    private final List<com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter> fileFilters;
     ...
     */
    private AndFileFilter(final ArrayList<com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter> initialList) {
     ...
     * @since 2.9.0
     */
    public AndFileFilter(final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter... fileFilters) {
     ...
     */
    public AndFileFilter(final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter filter1, final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter filter2) {
        this(2);
     ...
     * @since 1.1
     */
    public AndFileFilter(final List<com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter> fileFilters) {
     ...
     */
    @Override
    public void addFileFilter(final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter fileFilter) {
     ...
     * @since 2.9.0
     */
    public void addFileFilter(final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter... fileFilters) {
     ...
     */
    @Override
    public List<com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter> getFileFilters() {
     ...
     */
    @Override
    public boolean removeFileFilter(final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter ioFileFilter) {
