...
package com.github.terefang.jmelange.apache.text.matcher;

import com.github.terefang.jmelange.apache.lang3.ArrayUtils;
import com.github.terefang.jmelange.apache.lang3.StringUtils;
import com.github.terefang.jmelange.apache.text.matcher.AbstractStringMatcher;
import com.github.terefang.jmelange.apache.text.matcher.StringMatcher;
...
public final class StringMatcherFactory {
     ...
     * @since 1.9
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher andMatcher(final com.github.terefang.jmelange.apache.text.matcher.StringMatcher... stringMatchers) {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher charMatcher(final char ch) {
     ...
     * @return a new matcher for the given char[]
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher charSetMatcher(final char... chars) {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher charSetMatcher(final String chars) {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher commaMatcher() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher doubleQuoteMatcher() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher noneMatcher() {
        return NONE_MATCHER;
    }
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher quoteMatcher() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher singleQuoteMatcher() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher spaceMatcher() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher splitMatcher() {
     ...
     * @since 1.9
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher stringMatcher(final char... chars) {
     ...
     * @return a new Matcher for the given String
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher stringMatcher(final String str) {
     ...
     */
    public com.github.terefang.jmelange.apache.text.matcher.StringMatcher tabMatcher() {
        return TAB_MATCHER;
    }
