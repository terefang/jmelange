...
import com.github.terefang.jmelange.apache.io.output.ClosedWriter;
import com.github.terefang.jmelange.apache.io.output.ProxyWriter;
...
public class CloseShieldWriter extends ProxyWriter
{
    ...
    /**
     * Replaces the underlying writer with a {@link com.github.terefang.jmelange.apache.io.output.ClosedWriter} sentinel. The
