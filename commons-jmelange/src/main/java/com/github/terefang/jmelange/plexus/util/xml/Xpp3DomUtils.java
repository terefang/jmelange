...
import com.github.terefang.jmelange.plexus.util.xml.SerializerXMLWriter;
import com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom;
import com.github.terefang.jmelange.plexus.util.xml.Xpp3DomWriter;
import com.github.terefang.jmelange.plexus.util.xml.pull.XmlSerializer;
...
public class Xpp3DomUtils {
    ...
    public void writeToSerializer(String namespace, XmlSerializer serializer, com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom dom) throws IOException {
     ...
     * </ol>
     */
    private static void mergeIntoXpp3Dom(com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom dominant, com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom recessive, Boolean childMergeOverride) {
        ...
        if (mergeSelf) {
            ...
            com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom[] children = recessive.getChildren();
            for (com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom recessiveChild : children) {
                String idValue = recessiveChild.getAttribute(ID_COMBINATION_MODE_ATTRIBUTE);

                com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom childDom = null;
                if (isNotEmpty(idValue)) {
                    for (com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom dominantChild : dominant.getChildren()) {
                ...
                if (mergeChildren && childDom != null) {
                    ...
                    dominant.addChild(new com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom(recessiveChild));
                }
            }
        }
    }
     ...
     * @return merged DOM
     */
    public static com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom mergeXpp3Dom(com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom dominant, com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom recessive, Boolean childMergeOverride) {
        if (dominant != null) {
     ...
     * @return merged DOM
     */
    public static com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom mergeXpp3Dom(com.github.terefang.jmelange.plexus.util.xml.Xpp3Dom dominant, Xpp3Dom recessive) {
        if (dominant != null) {
     ...
     * @deprecated Use com.github.terefang.jmelange.plexus.util.StringUtils#isNotEmpty(String) instead
     */
    @Deprecated
     ...
     * @deprecated Use com.github.terefang.jmelange.plexus.util.StringUtils#isEmpty(String) instead
     */
    @Deprecated
