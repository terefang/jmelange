...
import com.github.terefang.jmelange.apache.text.lookup.AbstractPathFencedLookup;
...
final class PropertiesStringLookup extends AbstractPathFencedLookup
{
    ...
    static String toPropertyKey(final String file, final String key) {
        return com.github.terefang.jmelange.apache.text.lookup.AbstractStringLookup.toLookupKey(file, SEPARATOR, key);
    }
