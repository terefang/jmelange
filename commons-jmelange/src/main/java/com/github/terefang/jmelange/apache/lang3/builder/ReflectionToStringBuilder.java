...
import com.github.terefang.jmelange.apache.lang3.ArraySorter;
import com.github.terefang.jmelange.apache.lang3.ArrayUtils;
import com.github.terefang.jmelange.apache.lang3.ClassUtils;
import com.github.terefang.jmelange.apache.lang3.builder.RecursiveToStringStyle;
import com.github.terefang.jmelange.apache.lang3.builder.ToStringBuilder;
import com.github.terefang.jmelange.apache.lang3.builder.ToStringExclude;
import com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle;
import com.github.terefang.jmelange.apache.lang3.builder.ToStringSummary;
 ...
 * </pre>
 * <p>
 * Alternatively the {@link com.github.terefang.jmelange.apache.lang3.builder.ToStringExclude} annotation can be used to exclude fields from being incorporated in the
 * result.
 * </p>
 * <p>
 * It is also possible to use the {@link com.github.terefang.jmelange.apache.lang3.builder.ToStringSummary} annotation to output the summary information instead of the
 * detailed information of a field.
 * </p>
 * <p>
 * The exact format of the {@code toString} is determined by the {@link com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle} passed into the constructor.
 * </p>
 *
 * <p>
 * <b>Note:</b> the default {@link com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle} will only do a "shallow" formatting, i.e. composed objects are not
...
public class ReflectionToStringBuilder extends ToStringBuilder
{
    ...
    /**
     * Builds a {@code toString} value using the default {@link com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle} through reflection.
     *
     * <p>
     ...
     *
     * @see com.github.terefang.jmelange.apache.lang3.builder.ToStringExclude
     * @see com.github.terefang.jmelange.apache.lang3.builder.ToStringSummary
     */
     ...
     *
     * <p>
     * If the style is {@code null}, the default {@link com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle} is used.
     * </p>
     *
     * @param object
     *            the Object to be output
     ...
     * @return the String result
     * @throws IllegalArgumentException
     *             if the Object or {@link com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle} is {@code null}
     *
     * @see com.github.terefang.jmelange.apache.lang3.builder.ToStringExclude
     * @see com.github.terefang.jmelange.apache.lang3.builder.ToStringSummary
     */
    public static String toString(final Object object, final com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle style) {
     ...
     * @see com.github.terefang.jmelange.apache.lang3.builder.ToStringSummary
     */
    public static String toString(final Object object, final com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle style, final boolean outputTransients) {
     ...
     * @since 2.1
     */
    public static String toString(final Object object, final com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle style, final boolean outputTransients, final boolean outputStatics) {
    ...
    public static <T> String toString(
            final T object, final com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle style, final boolean outputTransients,
     ...
     *            the style of the {@code toString} to create, may be {@code null}
     */
    public ReflectionToStringBuilder(final Object object, final com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle style) {
        super(object, style);
    }
     ...
     */
    public ReflectionToStringBuilder(final Object object, final com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle style, final StringBuffer buffer) {
    ...
    public <T> ReflectionToStringBuilder(
            final T object, final com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle style, final StringBuffer buffer,
