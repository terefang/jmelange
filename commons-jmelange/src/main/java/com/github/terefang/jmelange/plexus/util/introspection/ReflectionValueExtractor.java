package com.github.terefang.jmelange.plexus.util.introspection;
...
import com.github.terefang.jmelange.plexus.util.introspection.ClassMap;
...
public class ReflectionValueExtractor {
     ...
     */
    private static final Map<Class<?>, WeakReference<com.github.terefang.jmelange.plexus.util.introspection.ClassMap>> classMaps =
            new WeakHashMap<Class<?>, WeakReference<com.github.terefang.jmelange.plexus.util.introspection.ClassMap>>();
    ...
    private static Object getMappedValue(
        ...
        if (value instanceof Map) {
            ...
            com.github.terefang.jmelange.plexus.util.introspection.ClassMap classMap    = getClassMap(value.getClass());
    ...
    private static com.github.terefang.jmelange.plexus.util.introspection.ClassMap getClassMap(Class<?> clazz) {

        WeakReference<com.github.terefang.jmelange.plexus.util.introspection.ClassMap> softRef = classMaps.get(clazz);

        com.github.terefang.jmelange.plexus.util.introspection.ClassMap classMap;

        if (softRef == null || (classMap = softRef.get()) == null) {
            classMap = new com.github.terefang.jmelange.plexus.util.introspection.ClassMap(clazz);
