...
import com.github.terefang.jmelange.apache.lang3.time.DateUtils;
...
public class DurationFormatUtils {
    ...
    public static String formatDuration(final long durationMillis, final String format, final boolean padWithZeros) {
        ...
        if (Token.containsTokenWithValue(tokens, d)) {
            days = milliseconds / com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_DAY;
            milliseconds -= days * com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_DAY;
        }
        if (Token.containsTokenWithValue(tokens, H)) {
            hours = milliseconds / com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_HOUR;
            milliseconds -= hours * com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_HOUR;
        }
        if (Token.containsTokenWithValue(tokens, m)) {
            minutes = milliseconds / com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_MINUTE;
            milliseconds -= minutes * com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_MINUTE;
        }
        if (Token.containsTokenWithValue(tokens, s)) {
            seconds = milliseconds / com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_SECOND;
            milliseconds -= seconds * com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_SECOND;
        }
    ...
    public static String formatPeriod(final long startMillis, final long endMillis, final String format, final boolean padWithZeros,
        ...
        while (milliseconds < 0) {
            milliseconds += com.github.terefang.jmelange.apache.lang3.time.DateUtils.MILLIS_PER_SECOND;
            seconds -= 1;
        }
        while (seconds < 0) {
