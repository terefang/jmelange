 ...
 */
package com.github.terefang.jmelange.apache.io.input.buffer;
...
import com.github.terefang.jmelange.apache.io.input.buffer.CircularByteBuffer;

/**
 * Implements a buffered input stream, which is internally based on a {@link com.github.terefang.jmelange.apache.io.input.buffer.CircularByteBuffer}. Unlike the
...
public class CircularBufferInputStream extends FilterInputStream {
    ...
    /** Internal buffer. */
    protected final com.github.terefang.jmelange.apache.io.input.buffer.CircularByteBuffer buffer;
     ...
     *
     * @param inputStream The input stream, which is being buffered.
     * @param bufferSize The size of the {@link com.github.terefang.jmelange.apache.io.input.buffer.CircularByteBuffer}, which is used internally.
     */
