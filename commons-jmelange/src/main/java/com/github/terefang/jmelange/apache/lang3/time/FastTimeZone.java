...
import com.github.terefang.jmelange.apache.lang3.time.GmtTimeZone;
...
public class FastTimeZone {
    ...
    private static final TimeZone GREENWICH = new com.github.terefang.jmelange.apache.lang3.time.GmtTimeZone(false, 0, 0);
    ...
    public static TimeZone getGmtTimeZone(final String pattern) {
        ...
        if (m.matches()) {
            ...
            return new com.github.terefang.jmelange.apache.lang3.time.GmtTimeZone(parseSign(m.group(1)), hours, minutes);
        }
        return null;
    }
