 ...
 * with {@link DatagramSocketClient#open open } and call {@link #getTime getTime } or {@link #getTime getDate } to retrieve the time.
 * Then call {@link DatagramSocketClient#close close } to close the connection properly. Unlike
 * {@link TimeTCPClient}, successive calls to {@link #getTime getTime } or {@link #getDate getDate } are permitted without
