...
import com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults;
 ...
 * @since 1.0
 */
public class LevenshteinDetailedDistance implements EditDistance<com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults>
{
     ...
     */
    private static <E> com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults findDetailedResults(final SimilarityInput<E> left,
        ...
        return new com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults(addCount + delCount + subCount, addCount, delCount, subCount);
    }
     ...
     */
    private static <E> com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults limitedCompare(SimilarityInput<E> left, SimilarityInput<E> right, final int threshold) { //NOPMD
        ...
        if (n == 0) {
            return m <= threshold ? new com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults(m, m, 0, 0) : new com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults(-1, 0, 0, 0);
        }
        if (m == 0) {
            return n <= threshold ? new com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults(n, 0, n, 0) : new com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults(-1, 0, 0, 0);
        }
        ...
        for (int j = 1; j <= m; j++) {
            ...
            if (min > max) {
                return new com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults(-1, 0, 0, 0);
            }
     ...
     */
    private static <E> com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults unlimitedCompare(SimilarityInput<E> left, SimilarityInput<E> right) {
        if (left == null || right == null) {
            throw new IllegalArgumentException("CharSequences must not be null");
        }
        ...
        if (n == 0) {
            return new com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults(m, m, 0, 0);
        }
        if (m == 0) {
            return new com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults(n, 0, n, 0);
        }
        boolean swapped = false;
        if (n > m) {
     ...
     */
    @Override
    public com.github.terefang.jmelange.apache.text.similarity.LevenshteinResults apply(final CharSequence left, final CharSequence right) {
