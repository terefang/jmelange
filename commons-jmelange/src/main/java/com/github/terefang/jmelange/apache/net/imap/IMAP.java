...
import com.github.terefang.jmelange.apache.net.PrintCommandListener;
...
public class IMAP extends SocketClient {
     ...
     * {@link PrintCommandListener PrintCommandListener} instances will be invoked with the partial response and a status of
