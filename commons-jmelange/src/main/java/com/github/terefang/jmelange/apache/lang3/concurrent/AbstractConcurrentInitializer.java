...
/**
 * Abstracts and defines operations for {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer} implementations.
 *
...
public abstract class AbstractConcurrentInitializer<T, E extends Exception> implements ConcurrentInitializer<T>
{
     ...
     *
     * @throws com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException Thrown by the closer.
     * @since 3.14.0
     */
