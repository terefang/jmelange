...
import com.github.terefang.jmelange.plexus.util.xml.XMLWriter;
...
public class XmlWriterUtil {
     ...
     */
    public static void writeLineBreak(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer) {
     ...
     */
    public static void writeLineBreak(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, int repeat) {
     ...
     * @see #writeLineBreak(com.github.terefang.jmelange.plexus.util.xml.XMLWriter, int, int, int)
     */
    public static void writeLineBreak(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, int repeat, int indent) {
     ...
     */
    public static void writeLineBreak(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, int repeat, int indent, int indentSize) {
     ...
     * @see #writeCommentLineBreak(com.github.terefang.jmelange.plexus.util.xml.XMLWriter, int)
     */
    public static void writeCommentLineBreak(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer) {
     ...
     */
    public static void writeCommentLineBreak(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, int columnSize) {
        if (columnSize < 10) {
     ...
     * @see #DEFAULT_INDENTATION_SIZE
     * @see #writeComment(com.github.terefang.jmelange.plexus.util.xml.XMLWriter, String, int, int)
     */
    public static void writeComment(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, String comment) {
     ...
     * @see #writeComment(com.github.terefang.jmelange.plexus.util.xml.XMLWriter, String, int, int)
     */
    public static void writeComment(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, String comment, int indent) {
     ...
     * @param indentSize positive number
     * @see #DEFAULT_COLUMN_LINE
     * @see #writeComment(com.github.terefang.jmelange.plexus.util.xml.XMLWriter, String, int, int, int)
     */
    public static void writeComment(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, String comment, int indent, int indentSize) {
     ...
     * @param columnSize positive number
     */
    public static void writeComment(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, String comment, int indent, int indentSize, int columnSize) {
        if (comment == null) {
            comment = "null";
        }
     ...
     * @param comment the comment
     * @see #DEFAULT_INDENTATION_SIZE
     * @see #writeCommentText(com.github.terefang.jmelange.plexus.util.xml.XMLWriter, String, int, int)
     */
    public static void writeCommentText(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, String comment) {
     ...
     * @see #writeCommentText(com.github.terefang.jmelange.plexus.util.xml.XMLWriter, String, int, int)
     */
    public static void writeCommentText(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, String comment, int indent) {
     ...
     * @param indentSize positive number
     * @see #DEFAULT_COLUMN_LINE
     * @see #writeCommentText(com.github.terefang.jmelange.plexus.util.xml.XMLWriter, String, int, int, int)
     */
    public static void writeCommentText(com.github.terefang.jmelange.plexus.util.xml.XMLWriter writer, String comment, int indent, int indentSize) {
