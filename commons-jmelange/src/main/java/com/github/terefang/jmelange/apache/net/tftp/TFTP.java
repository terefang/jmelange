 ...
 * However, almost every user should only be concerend with the {@link DatagramSocketClient#open open() }, and
 * {@link DatagramSocketClient#close close() }, methods. Additionally,the a
 * {@link DatagramSocketClient#setDefaultTimeout setDefaultTimeout() } method may be of importance for performance tuning.
 * <p>
