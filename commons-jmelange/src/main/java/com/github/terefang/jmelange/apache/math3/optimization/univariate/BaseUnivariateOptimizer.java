...
package com.github.terefang.jmelange.apache.math3.optimization.univariate;

import com.github.terefang.jmelange.apache.math3.analysis.UnivariateFunction;
import com.github.terefang.jmelange.apache.math3.optimization.BaseOptimizer;
 ...
 * <ul>
 *  <li>{@link com.github.terefang.jmelange.apache.math3.optimization.univariate.UnivariateOptimizer}</li>
 * </ul>
 *
...
public interface BaseUnivariateOptimizer<FUNC extends UnivariateFunction>
     ...
     * @throws com.github.terefang.jmelange.apache.math3.exception.TooManyEvaluationsException
     * if the maximum evaluation count is exceeded.
     * @throws com.github.terefang.jmelange.apache.math3.exception.ConvergenceException if the
     * optimizer detects a convergence problem.
     * @throws IllegalArgumentException if {@code min > max} or the endpoints
     * do not satisfy the requirements specified by the optimizer.
     * @throws com.github.terefang.jmelange.apache.math3.exception.NullArgumentException if any
