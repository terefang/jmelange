...
import com.github.terefang.jmelange.apache.math3.util.IterationListener;
...
public class IterationManager {
     ...
     * @throws com.github.terefang.jmelange.apache.math3.exception.NullArgumentException if {@code callBack} is {@code null}
     * @since 3.1
     * @deprecated as of 3.6, replaced with {@link #IterationManager(int,
     * com.github.terefang.jmelange.apache.math3.util.IntegerSequence.Incrementor.MaxCountExceededCallback)}
     */
    @Deprecated
    public IterationManager(final int maxIterations,
