...
public class StreamNormalizingReader extends NormalizingReader {
    ...
    protected static class ASCIIDecoderFactory
        ...
        public CharDecoder createCharDecoder(InputStream is)
                throws IOException {
            return ReaderCharDecoder.from(is, StandardCharsets.US_ASCII);
        }
    }
    ...
    protected static class ISO_8859_1DecoderFactory
        ...
        public CharDecoder createCharDecoder(InputStream is)
                throws IOException {
            return ReaderCharDecoder.from(is, StandardCharsets.ISO_8859_1);
        }
    }
    ...
    protected static class UTF8DecoderFactory
        ...
        public CharDecoder createCharDecoder(InputStream is)
                throws IOException {
            return ReaderCharDecoder.from(is, StandardCharsets.UTF_8);
        }
    }
    ...
    protected static class UTF16DecoderFactory
        ...
        public CharDecoder createCharDecoder(InputStream is)
                throws IOException {
            return ReaderCharDecoder.from(is, StandardCharsets.UTF_16);
        }
    }
}