...
import com.github.terefang.jmelange.apache.text.similarity.LongestCommonSubsequence;

/**
 * An edit distance algorithm based on the length of the longest common subsequence between two strings.
 *
 * <p>
 * This code is directly based upon the implementation in {@link com.github.terefang.jmelange.apache.text.similarity.LongestCommonSubsequence}.
 * </p>
 *
 * <p>
...
public class LongestCommonSubsequenceDistance implements EditDistance<Integer>
{
     ...
     * {@code LCS} is given in {@link com.github.terefang.jmelange.apache.text.similarity.LongestCommonSubsequence#apply(CharSequence, CharSequence)}.
     *
