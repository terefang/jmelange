...
package com.github.terefang.jmelange.apache.net.chargen;
 ...
 * <p>
 * To use the CharGenUDPClient class, just open a local UDP port with {@link DatagramSocketClient#open open } and call {@link #send send
 ...
 * duration beforehand). Don't forget to call {@link DatagramSocketClient#close close() } to clean up properly.
 *
