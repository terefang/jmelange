 ...
 * should only be concerned with the {@link TFTPClient} class {@link TFTPClient#receiveFile
 * receiveFile()} and {@link TFTPClient#sendFile sendFile()} methods.
 *
 *
...
public abstract class TFTPPacket {
     ...
     * {@link TFTP} class methods to implement their own TFTP servers or clients.
     */
     ...
     * to implement his own TFTP client instead of using the {@link TFTPClient} class. Under normal circumstances, you should not
