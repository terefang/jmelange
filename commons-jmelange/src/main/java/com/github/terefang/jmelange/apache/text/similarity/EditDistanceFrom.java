...
/**
 * Stores a {@link com.github.terefang.jmelange.apache.text.similarity.EditDistance} implementation and a {@link CharSequence} "left" string.
...
public class EditDistanceFrom<R> {
     ...
     * Edit distance.
     */
    private final com.github.terefang.jmelange.apache.text.similarity.EditDistance<R> editDistance;
     ...
     */
    public EditDistanceFrom(final com.github.terefang.jmelange.apache.text.similarity.EditDistance<R> editDistance, final CharSequence left) {
