...
package com.github.terefang.jmelange.apache.collections4.properties;
...
public class SortedProperties extends Properties {
    ...
    public Set<Map.Entry<Object, Object>> entrySet() {
        final Stream<SimpleEntry<Object, Object>> stream = sortedKeys().map(k -> new SimpleEntry<>(k, getProperty(k)));
