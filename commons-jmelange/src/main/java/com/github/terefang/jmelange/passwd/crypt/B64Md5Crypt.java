...
public class B64Md5Crypt {
    public static String _PREFIX = "$MD5$";

    public static String crypt(String _plain)
    {
        return _PREFIX+ HashUtil.base64(HashUtil.md5(_plain.getBytes(StandardCharsets.UTF_8)));
    }
    ...
    {
        return _PREFIX+ HashUtil.base64(HashUtil.md5(_plain.getBytes(StandardCharsets.UTF_16LE)));
    }
