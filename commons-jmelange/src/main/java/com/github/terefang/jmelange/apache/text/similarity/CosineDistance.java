...
import com.github.terefang.jmelange.apache.text.similarity.CosineSimilarity;
import com.github.terefang.jmelange.apache.text.similarity.Counter;
import com.github.terefang.jmelange.apache.text.similarity.EditDistance;
import com.github.terefang.jmelange.apache.text.similarity.RegexTokenizer;
...
public class CosineDistance implements EditDistance<Double>
{
    ...
    public Double apply(final CharSequence left, final CharSequence right) {
        ...
        final Map<CharSequence, Integer> leftVector = com.github.terefang.jmelange.apache.text.similarity.Counter.of(leftTokens);
        final Map<CharSequence, Integer> rightVector = com.github.terefang.jmelange.apache.text.similarity.Counter.of(rightTokens);
