...
import com.github.terefang.jmelange.apache.io.filefilter.CanWriteFileFilter;
...
public class CanReadFileFilter extends AbstractFileFilter
    ...
    public static final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter CAN_READ = new CanReadFileFilter();

    /** Singleton instance of not <em>readable</em> filter */
    public static final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter CANNOT_READ = CAN_READ.negate();
