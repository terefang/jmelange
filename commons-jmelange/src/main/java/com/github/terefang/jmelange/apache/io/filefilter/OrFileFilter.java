 ...
 *
 * @since 1.0
 * @see FileFilterUtils#or(com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter...)
 */
public class OrFileFilter extends AbstractFileFilter
     ...
     */
    private OrFileFilter(final ArrayList<com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter> initialList) {
     ...
     * @since 2.9.0
     */
    public OrFileFilter(final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter... fileFilters) {
     ...
     */
    public OrFileFilter(final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter filter1, final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter filter2) {
        this(2);
     ...
     * @since 1.1
     */
    public OrFileFilter(final List<com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter> fileFilters) {
     ...
     */
    @Override
    public boolean removeFileFilter(final com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter fileFilter) {
