...
import com.github.terefang.jmelange.apache.codec.language.SoundexUtils;
...
public class RefinedSoundex implements StringEncoder {
   ...
   /**
     ...
     *
     * @see com.github.terefang.jmelange.apache.codec.language.SoundexUtils#difference(StringEncoder,String,String)
    ...
    public int difference(final String s1, final String s2) throws EncoderException {
        return com.github.terefang.jmelange.apache.codec.language.SoundexUtils.difference(this, s1, s2);
    }
    ...
    public String soundex(String str) {
        ...
        str = com.github.terefang.jmelange.apache.codec.language.SoundexUtils.clean(str);
        if (str.isEmpty()) {
            return str;
        }
