...
package com.github.terefang.jmelange.apache.net.echo;
...
import com.github.terefang.jmelange.apache.net.discard.DiscardUDPClient;
 ...
 * {@link DatagramSocketClient#open open } and call {@link #send send } to send datagrams to the server, then call {@link #receive
 * receive } to receive echoes. After you're done echoing data, call {@link DatagramSocketClient#close close() } to clean up properly.
 *
 * @see EchoTCPClient
