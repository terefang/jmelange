...
import com.github.terefang.jmelange.plexus.util.FastMap;
 ...
 * (e.g. {@link com.github.terefang.jmelange.plexus.util.FastMap}). For slower collections such as <code>java.util.TreeMap</code>, non-resizable {@link com.github.terefang.jmelange.plexus.util.FastMap}
...
public final class CachedMap implements Map {
     ...
     */
    private final com.github.terefang.jmelange.plexus.util.FastMap _backingFastMap;
     ...
     */
    private final com.github.terefang.jmelange.plexus.util.FastMap _keysMap;
    ...
    /**
     * Creates a cached map backed by a {@link com.github.terefang.jmelange.plexus.util.FastMap}. The default cache size and map capacity is set to
     * <code>256</code> entries.
     */
    public CachedMap() {
        this(256, new com.github.terefang.jmelange.plexus.util.FastMap());
    }

    /**
     * Creates a cached map backed by a {@link com.github.terefang.jmelange.plexus.util.FastMap} and having the specified cache size.
     *
    ...
    public CachedMap(int cacheSize) {
        this(cacheSize, new com.github.terefang.jmelange.plexus.util.FastMap(cacheSize));
    }
    ...
    public CachedMap(int cacheSize, Map backingMap) {
        ...
        if (backingMap instanceof com.github.terefang.jmelange.plexus.util.FastMap) {
            _backingFastMap = (com.github.terefang.jmelange.plexus.util.FastMap) backingMap;
