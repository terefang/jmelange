...
import com.github.terefang.jmelange.apache.io.file.Counters.PathCounters;
import com.github.terefang.jmelange.apache.io.file.CountingPathVisitor;
...
public class AccumulatorPathVisitor extends CountingPathVisitor
{
    ...
    public static AccumulatorPathVisitor withBigIntegerCounters() {
        return new AccumulatorPathVisitor(com.github.terefang.jmelange.apache.io.file.Counters.bigIntegerPathCounters());
    }
     ...
     * @since 2.9.0
     */
    public static AccumulatorPathVisitor withBigIntegerCounters(final com.github.terefang.jmelange.apache.io.file.PathFilter fileFilter,
        final com.github.terefang.jmelange.apache.io.file.PathFilter dirFilter) {
        return new AccumulatorPathVisitor(com.github.terefang.jmelange.apache.io.file.Counters.bigIntegerPathCounters(), fileFilter, dirFilter);
    }
    ...
    public static AccumulatorPathVisitor withLongCounters() {
        return new AccumulatorPathVisitor(com.github.terefang.jmelange.apache.io.file.Counters.longPathCounters());
    }
     ...
     * @since 2.9.0
     */
    public static AccumulatorPathVisitor withLongCounters(final com.github.terefang.jmelange.apache.io.file.PathFilter fileFilter, final com.github.terefang.jmelange.apache.io.file.PathFilter dirFilter) {
        return new AccumulatorPathVisitor(com.github.terefang.jmelange.apache.io.file.Counters.longPathCounters(), fileFilter, dirFilter);
    }
     ...
     * @since 2.9.0
     */
    public AccumulatorPathVisitor(final PathCounters pathCounter, final com.github.terefang.jmelange.apache.io.file.PathFilter fileFilter, final com.github.terefang.jmelange.apache.io.file.PathFilter dirFilter) {
     ...
     * @since 2.12.0
     */
    public AccumulatorPathVisitor(final PathCounters pathCounter, final com.github.terefang.jmelange.apache.io.file.PathFilter fileFilter, final PathFilter dirFilter,
    ...
    public List<Path> relativizeDirectories(final Path parent, final boolean sort,
        ...
        return com.github.terefang.jmelange.apache.io.file.PathUtils.relativize(getDirList(), parent, sort, comparator);
    }
