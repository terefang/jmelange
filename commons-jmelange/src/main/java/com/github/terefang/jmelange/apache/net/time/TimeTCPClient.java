...
package com.github.terefang.jmelange.apache.net.time;
 ...
 * {@link SocketClient#connect connect } and call either {@link #getTime getTime() } or {@link #getDate getDate() } to retrieve the time,
 * then call {@link SocketClient#disconnect disconnect } to close the connection properly.
 *
 *
 * @see TimeUDPClient
 */
...
public final class TimeTCPClient extends SocketClient {
     ...
     * <p>
     * The server will have closed the connection at this point, so you should call {@link SocketClient#disconnect disconnect } after
     * calling this method. To retrieve another time, you must initiate another connection with {@link SocketClient#connect connect }
