...
import com.github.terefang.jmelange.apache.math3.geometry.Point;
import com.github.terefang.jmelange.apache.math3.geometry.euclidean.oned.Euclidean1D;
import com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Euclidean2D;
import com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.PolygonsSet;
import com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.SubLine;
import com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Vector2D;
...
import com.github.terefang.jmelange.apache.math3.geometry.partitioning.BSPTreeVisitor;
import com.github.terefang.jmelange.apache.math3.geometry.partitioning.BoundaryAttribute;
import com.github.terefang.jmelange.apache.math3.geometry.partitioning.Hyperplane;
import com.github.terefang.jmelange.apache.math3.geometry.partitioning.Region;
...
import com.github.terefang.jmelange.apache.math3.geometry.partitioning.Transform;
    ...
    private static class RotationTransform implements Transform<Euclidean3D, Euclidean2D> {
        ...
        public SubHyperplane<Euclidean2D> apply(final SubHyperplane<Euclidean2D> sub,
            ...
            if (original != cachedOriginal) {
                ...
                cachedTransform =
                        com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line.getTransform(tP10.getX() - tP00.getX(),
                                                                                           tP10.getY() - tP00.getY(),
                                                                                           tP01.getX() - tP00.getX(),
                                                                                           tP01.getY() - tP00.getY(),
                                                                                           tP00.getX(),
    ...
    private static class TranslationTransform implements Transform<Euclidean3D, Euclidean2D> {
        ...
        public SubHyperplane<Euclidean2D> apply(final SubHyperplane<Euclidean2D> sub,
            ...
            if (original != cachedOriginal) {
                ...
                cachedOriginal  = (Plane) original;
                cachedTransform =
                        com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line.getTransform(1, 0, 0, 1,
                                                                                           shift.getX(),
                                                                                           shift.getY());
