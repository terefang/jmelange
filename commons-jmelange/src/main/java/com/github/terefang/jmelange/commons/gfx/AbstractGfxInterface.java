...
import com.github.terefang.jmelange.commons.gfx.bgi.BgInterface;
import com.github.terefang.jmelange.commons.gfx.bgi.BgInterfaceWrapper;
...
public abstract class AbstractGfxInterface implements GfxInterface, StackedGfxInterface
{
    ...
    public void setBackground(int _color) {
        _current.setBackground(GfxUtil.createColor(_color));
    }
    ...
    public void setColor(long _color) {
        _current.setColor(GfxUtil.createColor(_color));
    }
