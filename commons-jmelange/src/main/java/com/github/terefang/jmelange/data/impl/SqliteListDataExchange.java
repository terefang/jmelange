...
public class SqliteListDataExchange implements AbstractDataExchange, RowDataReader, RowDataWriter
{
    static String DATANAME = "sqlite-list";
    static List<String> DATANAMES = Collections.unmodifiableList(CommonUtil.toList("sqlite-list"));
    static List<String> DATAEXTS = Collections.unmodifiableList(CommonUtil.toList(".list"));
