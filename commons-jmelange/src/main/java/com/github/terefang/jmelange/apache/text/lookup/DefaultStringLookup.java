...
/**
 * An enumeration defining {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup} objects available through {@link StringLookupFactory}.
 * <p>
 ...
 * @see com.github.terefang.jmelange.apache.text.lookup.StringLookup
 * @since 1.7
 */
public enum DefaultStringLookup {
    ...
    private final com.github.terefang.jmelange.apache.text.lookup.StringLookup lookup;

    /**
     * Constructs a new instance of {@link DefaultStringLookup} and sets the key and the associated lookup instance.
     *
     * @param prefix the prefix
     * @param lookup the {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup} instance
     */
    DefaultStringLookup(final String prefix, final com.github.terefang.jmelange.apache.text.lookup.StringLookup lookup) {
        this.key = prefix;
        this.lookup = lookup;
    }
    ...
    /**
     * Gets the standard {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup} instance of this kind.
     *
     * @return the associated {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup} object
     */
