...
package com.github.terefang.jmelange.apache.net.discard;
 ...
 * with {@link DatagramSocketClient#open open } and call {@link #send send } to send datagrams to the server After you're done sending
 * discard data, call {@link DatagramSocketClient#close close() } to clean up properly.
 *
