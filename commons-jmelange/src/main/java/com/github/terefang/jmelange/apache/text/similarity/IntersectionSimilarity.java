...
import com.github.terefang.jmelange.apache.text.similarity.IntersectionResult;
import com.github.terefang.jmelange.apache.text.similarity.SimilarityScore;
 ...
 * @see HashMap
 */
public class IntersectionSimilarity<T> implements SimilarityScore<com.github.terefang.jmelange.apache.text.similarity.IntersectionResult>
{
     ...
     */
    @Override
    public com.github.terefang.jmelange.apache.text.similarity.IntersectionResult apply(final CharSequence left, final CharSequence right) {
        ...
        if (Math.min(sizeA, sizeB) == 0) {
            // No intersection
            return new com.github.terefang.jmelange.apache.text.similarity.IntersectionResult(sizeA, sizeB, 0);
        }
