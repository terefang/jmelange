 ...
 * {@link com.github.terefang.jmelange.apache.lang3.builder.Diffable} objects. Typically these differences are displayed using
 ...
 * @since 3.3
 */
public class DiffResult<T> implements Iterable<com.github.terefang.jmelange.apache.lang3.builder.Diff<?>> {
    ...
    private final List<com.github.terefang.jmelange.apache.lang3.builder.Diff<?>> diffList;
    private final T lhs;
    private final T rhs;
     ...
     */
    DiffResult(final T lhs, final T rhs, final List<com.github.terefang.jmelange.apache.lang3.builder.Diff<?>> diffList, final ToStringStyle style, final String toStringFormat) {
    ...
    /**
     * Returns an unmodifiable list of {@link com.github.terefang.jmelange.apache.lang3.builder.Diff}s. The list may be empty if
     * there were no differences between the objects.
     *
     * @return an unmodifiable list of {@link com.github.terefang.jmelange.apache.lang3.builder.Diff}s
     */
    public List<com.github.terefang.jmelange.apache.lang3.builder.Diff<?>> getDiffs() {
    ...
    /**
     * Returns an iterator over the {@link com.github.terefang.jmelange.apache.lang3.builder.Diff} objects contained in this list.
     *
     * @return the iterator
     */
    @Override
