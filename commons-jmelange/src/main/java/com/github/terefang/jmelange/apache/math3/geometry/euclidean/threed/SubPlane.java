...
public class SubPlane extends AbstractSubHyperplane<Euclidean3D, Euclidean2D> {
    ...
    public SplitSubHyperplane<Euclidean3D> split(Hyperplane<Euclidean3D> hyperplane) {
        ...
        final SubHyperplane<Euclidean2D> l2DMinus =
            new com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line(p, q, tolerance).wholeHyperplane();
        final SubHyperplane<Euclidean2D> l2DPlus =
            new com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line(q, p, tolerance).wholeHyperplane();
