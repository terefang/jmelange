...
package com.github.terefang.jmelange.apache.net.telnet;
 ...
 * <p>
 * The class can be used by first connecting to a server using the SocketClient {@link SocketClient#connect connect} method. Then an
