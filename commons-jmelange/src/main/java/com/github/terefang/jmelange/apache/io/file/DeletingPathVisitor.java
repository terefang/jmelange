...
import com.github.terefang.jmelange.apache.io.file.DeleteOption;
...
public class DeletingPathVisitor extends CountingPathVisitor
{
    ...
    public static DeletingPathVisitor withBigIntegerCounters() {
        return new DeletingPathVisitor(com.github.terefang.jmelange.apache.io.file.Counters.bigIntegerPathCounters());
    }
     ...
     * @since 2.8.0
     */
    public DeletingPathVisitor(final PathCounters pathCounter, final com.github.terefang.jmelange.apache.io.file.DeleteOption[] deleteOption, final String... skip) {
        this(pathCounter, com.github.terefang.jmelange.apache.io.file.PathUtils.noFollowLinkOptionArray(), deleteOption, skip);
    }
    ...
    public DeletingPathVisitor(final PathCounters pathCounter, final LinkOption[] linkOptions, final DeleteOption[] deleteOption, final String... skip) {
        ...
        this.linkOptions = linkOptions == null ? com.github.terefang.jmelange.apache.io.file.PathUtils.noFollowLinkOptionArray() : linkOptions.clone();
    }
    ...
    public DeletingPathVisitor(final PathCounters pathCounter, final String... skip) {
        this(pathCounter, com.github.terefang.jmelange.apache.io.file.PathUtils.EMPTY_DELETE_OPTION_ARRAY, skip);
    }
    ...
    private boolean accept(final Path path) {
        return Arrays.binarySearch(skip, com.github.terefang.jmelange.apache.io.file.PathUtils.getFileNameString(path)) < 0;
    }
    ...
    public FileVisitResult postVisitDirectory(final Path dir, final IOException exc) throws IOException {
        if (com.github.terefang.jmelange.apache.io.file.PathUtils.isEmptyDirectory(dir)) {
