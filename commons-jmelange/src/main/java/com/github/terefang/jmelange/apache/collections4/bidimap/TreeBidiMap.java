 ...
 */
package com.github.terefang.jmelange.apache.collections4.bidimap;

import static com.github.terefang.jmelange.apache.collections4.bidimap.TreeBidiMap.DataElement.KEY;
import static com.github.terefang.jmelange.apache.collections4.bidimap.TreeBidiMap.DataElement.VALUE;
...
import com.github.terefang.jmelange.apache.collections4.KeyValue;
import com.github.terefang.jmelange.apache.collections4.MapIterator;
import com.github.terefang.jmelange.apache.collections4.OrderedBidiMap;
import com.github.terefang.jmelange.apache.collections4.OrderedIterator;
import com.github.terefang.jmelange.apache.collections4.OrderedMapIterator;
...
public class TreeBidiMap<K extends Comparable<K>, V extends Comparable<V>>
     ...
     * A view of this map.
     */
    final class EntryView extends AbstractView<Entry<K, V>> {
     ...
     * A view of this map.
     */
    final class InverseEntryView extends AbstractView<Entry<V, K>> {
     ...
     */
    final class InverseViewMapEntryIterator extends AbstractViewIterator implements OrderedIterator<Entry<V, K>> {
     ...
     */
    final class ViewMapEntryIterator extends AbstractViewIterator implements OrderedIterator<Entry<K, V>> {
