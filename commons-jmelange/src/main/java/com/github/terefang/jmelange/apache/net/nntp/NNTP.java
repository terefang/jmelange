 ...
 * need to perform your own implementation, you should use {@link NNTPClient}. The NNTP class is made public to provide access to
 ...
 * {@link NNTPConnectionClosedException} , you must disconnect the connection with {@link #disconnect disconnect() } to properly
