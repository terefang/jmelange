 ...
 */
package com.github.terefang.jmelange.apache.lang3.exception;

import java.util.List;
import java.util.Set;

import com.github.terefang.jmelange.apache.lang3.exception.ContextedException;
import com.github.terefang.jmelange.apache.lang3.exception.DefaultExceptionContext;
import com.github.terefang.jmelange.apache.lang3.exception.ExceptionContext;
 ...
 * </p>
 * <pre>
 * com.github.terefang.jmelange.apache.lang3.exception.ContextedRuntimeException: java.lang.Exception: Error posting account transaction
 *  Exception Context:
 ...
 *
 *  ---------------------------------
 *  at com.github.terefang.jmelange.apache.lang3.exception.ContextedRuntimeExceptionTest.testAddValue(ContextedExceptionTest.java:88)
 *  ..... (rest of trace)
 * </pre>
 *
 ...
 * @since 3.0
 */
public class ContextedRuntimeException extends RuntimeException implements com.github.terefang.jmelange.apache.lang3.exception.ExceptionContext
{

    /** The serialization version. */
    private static final long serialVersionUID = 20110706L;
    /** The context where the data is stored. */
    private final com.github.terefang.jmelange.apache.lang3.exception.ExceptionContext exceptionContext;
    ...
    public ContextedRuntimeException() {
        exceptionContext = new com.github.terefang.jmelange.apache.lang3.exception.DefaultExceptionContext();
    }
    ...
    public ContextedRuntimeException(final String message, final Throwable cause, ExceptionContext context) {
        super(message, cause);
        if (context == null) {
            context = new com.github.terefang.jmelange.apache.lang3.exception.DefaultExceptionContext();
        }
