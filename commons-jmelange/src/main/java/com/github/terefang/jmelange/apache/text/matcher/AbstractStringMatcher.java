...
import com.github.terefang.jmelange.apache.text.matcher.StringMatcherFactory;
 ...
 * @since 1.3
 */
abstract class AbstractStringMatcher implements com.github.terefang.jmelange.apache.text.matcher.StringMatcher
{
    ...
    static final class AndStringMatcher extends AbstractStringMatcher {
         ...
         * Matchers in order.
         */
        private final com.github.terefang.jmelange.apache.text.matcher.StringMatcher[] stringMatchers;
         ...
         */
        AndStringMatcher(final com.github.terefang.jmelange.apache.text.matcher.StringMatcher... stringMatchers) {
        ...
        public int isMatch(final char[] buffer, final int start, final int bufferStart, final int bufferEnd) {
            int total = 0;
            int curStart = start;
            for (final com.github.terefang.jmelange.apache.text.matcher.StringMatcher stringMatcher : stringMatchers) {
