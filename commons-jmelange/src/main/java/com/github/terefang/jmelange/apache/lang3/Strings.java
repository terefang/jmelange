...
import static com.github.terefang.jmelange.apache.lang3.StringUtils.INDEX_NOT_FOUND;
...
import com.github.terefang.jmelange.apache.lang3.builder.AbstractSupplier;
import com.github.terefang.jmelange.apache.lang3.function.ToBooleanBiFunction;

/**
 * String operations where you choose case-senstive {@link #CS} vs. case-insensitive {@link #CI} through a singleton instance.
 *
 * @see com.github.terefang.jmelange.apache.lang3.CharSequenceUtils
 * @see StringUtils
 * @since 3.18.0
 */
public abstract class Strings {
    ...
    private static final class CiStrings extends Strings {
        ...
        public boolean contains(final CharSequence str, final CharSequence searchStr) {
            ...
            for (int i = 0; i <= max; i++) {
                if (com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.regionMatches(str, true, i, searchStr, 0, len)) {
                    return true;
                }
            }
            return false;
        ...
        public boolean equals(final CharSequence cs1, final CharSequence cs2) {
            ...
            return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.regionMatches(cs1, true, 0, cs2, 0, cs1.length());
        }
        ...
        public int indexOf(final CharSequence str, final CharSequence searchStr, int startPos) {
            ...
            for (int i = startPos; i < endLimit; i++) {
                if (com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.regionMatches(str, true, i, searchStr, 0, searchStr.length())) {
                    return i;
                }
            }
            return INDEX_NOT_FOUND;
        ...
        public int lastIndexOf(final CharSequence str, final CharSequence searchStr, int startPos) {
            ...
            for (int i = startPos; i >= 0; i--) {
                if (com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.regionMatches(str, true, i, searchStr, 0, searchStrLength)) {
                    return i;
                }
            }
            return INDEX_NOT_FOUND;
    ...
    private static final class CsStrings extends Strings {
        ...
        public boolean contains(final CharSequence seq, final CharSequence searchSeq) {
            return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(seq, searchSeq, 0) >= 0;
        }
        ...
        public int indexOf(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
            return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(seq, searchSeq, startPos);
        }

        @Override
        public int lastIndexOf(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
            return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.lastIndexOf(seq, searchSeq, startPos);
        }
    ...
    private static boolean containsAny(final ToBooleanBiFunction<CharSequence, CharSequence> test, final CharSequence cs,
        ...
        if (StringUtils.isEmpty(cs) || com.github.terefang.jmelange.apache.lang3.ArrayUtils.isEmpty(searchCharSequences)) {
            return false;
        }
    ...
    public String appendIfMissing(final String str, final CharSequence suffix, final CharSequence... suffixes) {
        ...
        if (com.github.terefang.jmelange.apache.lang3.ArrayUtils.isNotEmpty(suffixes)) {
    ...
    public boolean endsWith(final CharSequence str, final CharSequence suffix) {
        ...
        return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.regionMatches(str, ignoreCase, str.length() - sufLen, suffix, 0, sufLen);
    }
    ...
    public boolean endsWithAny(final CharSequence sequence, final CharSequence... searchStrings) {
        if (StringUtils.isEmpty(sequence) || com.github.terefang.jmelange.apache.lang3.ArrayUtils.isEmpty(searchStrings)) {
            return false;
        }
    ...
    public boolean equalsAny(final CharSequence string, final CharSequence... searchStrings) {
        if (com.github.terefang.jmelange.apache.lang3.ArrayUtils.isNotEmpty(searchStrings)) {
    ...
    public String prependIfMissing(final String str, final CharSequence prefix, final CharSequence... prefixes) {
        ...
        if (com.github.terefang.jmelange.apache.lang3.ArrayUtils.isNotEmpty(prefixes)) {
