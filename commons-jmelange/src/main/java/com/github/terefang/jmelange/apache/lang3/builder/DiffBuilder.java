...
import com.github.terefang.jmelange.apache.lang3.builder.Diff;
import com.github.terefang.jmelange.apache.lang3.builder.DiffResult;
import com.github.terefang.jmelange.apache.lang3.builder.Diffable;
import com.github.terefang.jmelange.apache.lang3.builder.ReflectionDiffBuilder;
import com.github.terefang.jmelange.apache.lang3.builder.ToStringStyle;

/**
 * Assists in implementing {@link com.github.terefang.jmelange.apache.lang3.builder.Diffable#diff(Object)} methods.
 *
 * <p>
 ...
 *
 * <p>
 * The {@link ToStringStyle} passed to the constructor is embedded in the returned {@link com.github.terefang.jmelange.apache.lang3.builder.DiffResult} and influences the style of the
 * {@code DiffResult.toString()} method. This style choice can be overridden by calling {@link com.github.terefang.jmelange.apache.lang3.builder.DiffResult#toString(ToStringStyle)}.
 * </p>
 * <p>
 ...
 * @see Diffable
 * @see com.github.terefang.jmelange.apache.lang3.builder.Diff
 * @see com.github.terefang.jmelange.apache.lang3.builder.DiffResult
 * @see ToStringStyle
 * @see ReflectionDiffBuilder
 * @since 3.3
 */
public class DiffBuilder<T> implements Builder<com.github.terefang.jmelange.apache.lang3.builder.DiffResult<T>>
{
    ...
    public static final class Builder<T> {
         ...
         * {@link com.github.terefang.jmelange.apache.lang3.builder.Diff} if the trivially equal test is enabled and returns true. The result of this test is never changed throughout the life of this
         * {@link DiffBuilder}.
         *
         ...
         *                          without creating a field {@link com.github.terefang.jmelange.apache.lang3.builder.Diff} if the trivially equal test is enabled and returns true. The result of this test is
    ...
    private static final class SDiff<T> extends com.github.terefang.jmelange.apache.lang3.builder.Diff<T>
    {
    ...
    private final List<com.github.terefang.jmelange.apache.lang3.builder.Diff<?>> diffs;
     ...
     * {@link com.github.terefang.jmelange.apache.lang3.builder.DiffResult} when {@link #build()} is executed.
     * </p>
     *
     * <p>
    ...
    /**
     * Appends diffs from another {@link com.github.terefang.jmelange.apache.lang3.builder.DiffResult}.
     *
     * <p>
     ...
     *
     * @param fieldName  the field name
     * @param diffResult the {@link com.github.terefang.jmelange.apache.lang3.builder.DiffResult} to append
     * @return {@code this} instance.
     * @throws NullPointerException if field name is {@code null} or diffResult is {@code null}
     * @since 3.5
     */
    public DiffBuilder<T> append(final String fieldName, final com.github.terefang.jmelange.apache.lang3.builder.DiffResult<?> diffResult) {
    ...
    /**
     * Builds a {@link com.github.terefang.jmelange.apache.lang3.builder.DiffResult} based on the differences appended to this builder.
     *
     * @return a {@link com.github.terefang.jmelange.apache.lang3.builder.DiffResult} containing the differences between the two objects.
     */
    @Override
    public com.github.terefang.jmelange.apache.lang3.builder.DiffResult<T> build() {
