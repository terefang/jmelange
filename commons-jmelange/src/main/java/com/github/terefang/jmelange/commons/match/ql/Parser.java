...
public final class Parser {
    ...
    static {
        ...
        TOKEN_TYPES.put(new Integer(TokenType.KEYWORD_MATCH), "KEYWORD_MATCH");
     ...
     * @throws OQLSyntaxException passed through from match().
     */
    public ParseTreeNode expr() throws InvalidCharException, OQLSyntaxException {
        return orExpr();
    }
     ...
     *         containing EQUAL, NOT_EQUAL, or KEYWORD_LIKE, or KEYWORD_MATCH, with two relationalExpr
     *         tree children.
     * @throws InvalidCharException passed through from match().
     * @throws OQLSyntaxException passed through from match().
     */
