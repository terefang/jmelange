    ...
    private byte[] doEncode(final byte[] bytes, final int expectedLength, final boolean willEncode) {
        ...
        for (final byte b : bytes) {
            if (willEncode && canEncode(b)) {
                ...
                final char hex1 = com.github.terefang.jmelange.apache.codec.net.Utils.hexDigit(bb >> 4);
                final char hex2 = com.github.terefang.jmelange.apache.codec.net.Utils.hexDigit(bb);
