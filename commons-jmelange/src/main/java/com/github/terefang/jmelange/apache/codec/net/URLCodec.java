...
package com.github.terefang.jmelange.apache.codec.net;

import java.io.ByteArrayOutputStream;
import java.io.UnsupportedEncodingException;
import java.util.BitSet;

import com.github.terefang.jmelange.apache.codec.BinaryDecoder;
import com.github.terefang.jmelange.apache.codec.BinaryEncoder;
import com.github.terefang.jmelange.apache.codec.CharEncoding;
import com.github.terefang.jmelange.apache.codec.DecoderException;
import com.github.terefang.jmelange.apache.codec.EncoderException;
import com.github.terefang.jmelange.apache.codec.StringDecoder;
import com.github.terefang.jmelange.apache.codec.StringEncoder;
import com.github.terefang.jmelange.apache.codec.binary.StringUtils;
import com.github.terefang.jmelange.apache.codec.net.Utils;
    ...
    public static final byte[] decodeUrl(final byte[] bytes) throws DecoderException {
        ...
        for (int i = 0; i < bytes.length; i++) {
            ...
            if (b == '+') {
                ...
                try {
                    final int u = com.github.terefang.jmelange.apache.codec.net.Utils.digit16(bytes[++i]);
                    final int l = com.github.terefang.jmelange.apache.codec.net.Utils.digit16(bytes[++i]);
    ...
    public static final byte[] encodeUrl(BitSet urlsafe, final byte[] bytes) {
        ...
        for (final byte c : bytes) {
            ...
            if (urlsafe.get(b)) {
                ...
                final char hex1 = com.github.terefang.jmelange.apache.codec.net.Utils.hexDigit(b >> 4);
                final char hex2 = com.github.terefang.jmelange.apache.codec.net.Utils.hexDigit(b);
                buffer.write(hex1);
                buffer.write(hex2);
            }
        }
