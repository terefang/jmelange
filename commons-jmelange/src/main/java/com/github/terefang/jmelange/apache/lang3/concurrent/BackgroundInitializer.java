...
import com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils;
...
public class BackgroundInitializer<T> extends AbstractConcurrentInitializer<T, Exception>
{
    ...
    public static class Builder<I extends BackgroundInitializer<T>, T> extends AbstractBuilder<I, T, Builder<I, T>, Exception> {
         ...
         *
         * @see com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer#setExternalExecutor(ExecutorService)
         *
     ...
     */
    private BackgroundInitializer(final FailableSupplier<T, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException> initializer, final FailableConsumer<T, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException> closer, final ExecutorService exec) {
     ...
     * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException}. Calling this method before {@link #start()}
     * was called causes an {@link IllegalStateException} exception to be
     * thrown.
     *
     * @return the object produced by this initializer
     * @throws com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException if a checked exception occurred during
     * background processing
     * @throws IllegalStateException if {@link #start()} has not been called
     */
    @Override
    public T get() throws com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException
    {
        try {
