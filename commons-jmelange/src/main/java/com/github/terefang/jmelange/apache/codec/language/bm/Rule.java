 ...
 * </p>
 * <blockquote>com/github/terefang/jmelange/apache/codec/language/bm/${NameType#getName}_${RuleType#getName}_${language}.txt</blockquote>
 * <p>
...
public class Rule {
    ...
    private static String createResourceName(final NameType nameType, final RuleType rt, final String lang) {
        return String.format("com/github/terefang/jmelange/apache/codec/language/bm/%s_%s_%s.txt",
    ...
    private static Scanner createScanner(final String lang) {
        final String resName = String.format("com/github/terefang/jmelange/apache/codec/language/bm/%s.txt", lang);
        return new Scanner(Resources.getInputStream(resName), ResourceConstants.ENCODING);
    }
