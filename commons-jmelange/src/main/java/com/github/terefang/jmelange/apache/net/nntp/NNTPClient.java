...
package com.github.terefang.jmelange.apache.net.nntp;
...
import com.github.terefang.jmelange.apache.net.io.DotTerminatedMessageWriter;
 ...
 * doing anything, and finally {@link NNTP#disconnect disconnect() } after you're completely finished interacting with the server.
 * Remember that the {@link NNTP#isAllowedToPost isAllowedToPost()} method is defined in {@link NNTP}.
 * <p>
 ...
 * a {@link NNTPReply#SERVICE_DISCONTINUED NNTPReply.SERVICE_DISCONTINUED } response to a command. When that occurs, the NNTP class
 * method encountering that reply will throw an {@link NNTPConnectionClosedException} . {@code NNTPConectionClosedException} is
 ...
 * {@link NNTPConnectionClosedException} , you must disconnect the connection with
 * {@link NNTP#disconnect disconnect() } to properly clean up the system resources used by NNTP. Before disconnecting, you may check
 * the last reply code and text with {@link NNTP#getReplyCode getReplyCode } and
...
public class NNTPClient extends NNTP {
     ...
     * </p>
     * <p>
     * Different NNTP servers will require different header formats, but you can use the provided {@link SimpleNNTPHeader} class to
