...
import com.github.terefang.jmelange.apache.lang3.exception.ExceptionUtils;
import com.github.terefang.jmelange.apache.lang3.time.CalendarUtils;
import com.github.terefang.jmelange.apache.lang3.time.DatePrinter;
import com.github.terefang.jmelange.apache.lang3.time.FastDateFormat;
import com.github.terefang.jmelange.apache.lang3.time.FastDateParser;

/**
 * FastDatePrinter is a fast and thread-safe version of
 * {@link SimpleDateFormat}.
 *
 * <p>To obtain a FastDatePrinter, use {@link com.github.terefang.jmelange.apache.lang3.time.FastDateFormat#getInstance(String, TimeZone, Locale)}
 * or another variation of the factory methods of {@link com.github.terefang.jmelange.apache.lang3.time.FastDateFormat}.</p>
 *
...
public class FastDatePrinter implements DatePrinter, Serializable {
     ...
     * Use {@link com.github.terefang.jmelange.apache.lang3.time.FastDateFormat#getInstance(String, TimeZone, Locale)}  or another variation of the
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(java.util.Calendar)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(java.util.Calendar, Appendable)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(java.util.Calendar, StringBuffer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(java.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(java.util.Date, Appendable)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(java.util.Date, StringBuffer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(long, Appendable)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#format(long, StringBuffer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#getLocale()
     */
    @Override
    ...
    // Accessors
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#getPattern()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.github.terefang.jmelange.apache.lang3.time.DatePrinter#getTimeZone()
     */
    @Override
    ...
    protected List<Rule> parsePattern() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            case 'L': // month in year (text and number)
                if (tokenLen >= 4) {
                    rule = new TextField(Calendar.MONTH, com.github.terefang.jmelange.apache.lang3.time.CalendarUtils.getInstance(locale).getStandaloneLongMonthNames());
                } else if (tokenLen == 3) {
