...
public class BmpFont implements GfxFont
{
    ...
    public static GfxFont from(int[][] _fontBitmap, int[] _fontWidths, int _fontWidth, int _fontHeight, int _widthBase, int _firstChar, int[] _cmap)
    {
        ...
        _af.setNumChar(_fontBitmap.length);
    ...
    public static GfxFont load(File _file)
    {
        ...
        if(_fileName.endsWith(".ch"))
        {
            return loadFromRomBin(_in, 8, 16);
        }
        else if(_fileName.endsWith(".bin"))
        {
            return loadFromRomBin(_in, 32,8, 8);
        }
        else if(_fileName.endsWith(".gdfa"))
        {
    ...
    private static GfxFont loadFromRomBin(InputStream _in, int _w, int _h)
    {
        ...
        BmpFont _af = new BmpFont();
        int[][] _bmp = new int[256][_h];
        for(int _i=0; _i<256; _i++)
        {
            for(int _j=0; _j<_h; _j++)
            {
                _bmp[_i][_j] = edis.readByte();
            }
        }
        _af.setFontBitmap(_bmp);
        _af.setFontWidths(null);
        _af.setFontWidth(_w);
        _af.setFontHeight(_h);
        _af.setFirstChar(0);
        _af.setWidthBase(8);
        edis.close();
        return _af;
    ...
    @SneakyThrows
    private static GfxFont loadFromRomBin(InputStream _in, int _fc, int _w, int _h)
    {
        EndianDataInputStream edis = new EndianDataInputStream(_in);
        edis.order(ByteOrder.BIG_ENDIAN);
        BmpFont _af = new BmpFont();
    ...
    public int drawChar(GfxInterface _surface, int _x, int _y, int _c, long _color, long _mcolor, boolean _useMColor)
    {
    ...
    public int drawChar(BufferedImage _surface, int _x, int _y, int _c, Color _color, Color _mcolor, boolean _useMColor)
    {
        int _i = _c - this.firstChar;
        if(_i<0) _i = '?' - this.firstChar;
        if(_i>=this.fontBitmap.length) _i = '?' - this.firstChar;
        ...
        for(int _h = 0; _h<this.fontHeight; _h++)
        {
            for(int _w = 0; _w<_width; _w++)
            {
                ...
                if((_line & (_mask>>>_w)) > 0)
                {
                    _surface.setRGB(_x+_w,_y+_h,_color.getRGB());
                }
                else if(_useMColor)
                {
                    _surface.setRGB(_x+_w,_y+_h,_mcolor.getRGB());
                }
            }
        }
    ...
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_8x8_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC8x10()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_8x10_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC8x12()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_8x12_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC8x13()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_8x13_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC8x14()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_8x14_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC8x16()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_8x16_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC7x14()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_7x14_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC6x10()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_6x10_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC6x12()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_6x12_LE.gdf.gz", null).getInputStream()), false);
    }

    @SneakyThrows
    public static GfxFont defaultC6x13()
    {
        return loadFromGDFB(new GZIPInputStream(ClasspathResourceLoader.of("fonts/cfnt/C_6x13_LE.gdf.gz", null).getInputStream()), false);
    }

    public static GfxFont defaultAmi8()
    {
        return loadFromGDFB(ClasspathResourceLoader.of("fonts/gdf/ami8.gdf", null).getInputStream(), false);
    }

    public static GfxFont defaultSmallDisplay()
    {
        return loadFromGDFB(ClasspathResourceLoader.of("fonts/gdf/display.gdf", null).getInputStream(), false);
    }

    public static GfxFont defaultTiny()
    {
        return loadFromGDFA(ClasspathResourceLoader.of("fonts/gd/tiny.gdfa", null).getInputStream());
    }

    public static GfxFont defaultMedium()
    {
        return loadFromGDFA(ClasspathResourceLoader.of("fonts/gd/medium.gdfa", null).getInputStream());
    }

    public static GfxFont defaultSmall()
    {
        return loadFromGDFA(ClasspathResourceLoader.of("fonts/gd/small.gdfa", null).getInputStream());
    }

    public static GfxFont defaultLarge()
    {
        return loadFromGDFA(ClasspathResourceLoader.of("fonts/gd/large.gdfa", null).getInputStream());
    }

    public static GfxFont defaultGiant()
    {
        return loadFromGDFA(ClasspathResourceLoader.of("fonts/gd/giant.gdfa", null).getInputStream());
    }
    ...
    public static GfxFont mc6847_7x12()
    {
    ...
    public static GfxFont svgalib_font1_8x8()
    {
    ...
    public static GfxFont svgalib_font2_8x8()
    {
    ...
    public static GfxFont picomite_8x12()
    {
        return from(_picomite_font.table, _picomite_font.wAdvance, _picomite_font.width, _picomite_font.height, _picomite_font.wbase, _picomite_font.start, null);
    }
    
    public static class _picomite_font
    {
        // this looks like in cp437 but isnt
        // might be good to move petscii equivalents to 0-31
        // to restore compat with either cp437 or latin15+euro
        public static int start = 32;
        public static int height = 12;
        public static int width = 8;
        public static int wbase = 8;
    ...
    public static GfxFont libdragon_8x8()
    {
        return from(_libdragon_font.table, _libdragon_font.wAdvance, _libdragon_font.width, _libdragon_font.height, _libdragon_font.wbase, _libdragon_font.start, null);
    }
    
    public static class _libdragon_font
    {
        // https://github.com/DragonMinded/libdragon/blob/trunk/include/font.h
