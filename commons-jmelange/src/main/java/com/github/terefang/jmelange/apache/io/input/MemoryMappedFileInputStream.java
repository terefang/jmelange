...
import com.github.terefang.jmelange.apache.io.input.ByteBufferCleaner;
...
public final class MemoryMappedFileInputStream extends AbstractInputStream {
    ...
    private void cleanBuffer() {
        if (com.github.terefang.jmelange.apache.io.input.ByteBufferCleaner.isSupported() && buffer.isDirect()) {
            com.github.terefang.jmelange.apache.io.input.ByteBufferCleaner.clean(buffer);
        }
    }
