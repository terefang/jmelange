...
public class LogNormalSampler implements SharedStateContinuousSampler {
     ...
     * is a {@link com.github.terefang.jmelange.apache.rng.sampling.SharedStateSampler SharedStateSampler}.
     * Otherwise a run-time exception is thrown.</p>
     *
     * @throws UnsupportedOperationException if the underlying sampler is not a
     * {@link com.github.terefang.jmelange.apache.rng.sampling.SharedStateSampler SharedStateSampler} or
