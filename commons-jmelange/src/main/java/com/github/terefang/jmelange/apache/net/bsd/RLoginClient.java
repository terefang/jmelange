...
/**
 * RLoginClient is very similar to {@link RCommandClient}, from which it is derived, and uses the rcmd() facility implemented in
 ...
 * {@link RCommandClient}.
 * <p>
 * As with virtually all the client classes in com.github.terefang.jmelange.apache.net, this class derives from SocketClient. But it relies on the connection methods defined
 ...
 * {@link RExecClient#getErrorStream getErrorStream() } will always return null. The standard input of the remote process can be
 * written to through the output stream returned by {@link RExecClient#getOutputStream getOutputSream() }
 *
 * @see SocketClient
 * @see RExecClient
 * @see RCommandClient
