 ...
 * threads. All these classes implement the {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer} interface
 ...
 *
 * <p>
 * A {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer} produces an object. By calling the
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer#get() get()} method the object managed by the
 * initializer can be obtained. There are different implementations of the interface available addressing various use
 * cases:
 * </p>
 *
 * <p>
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConstantInitializer} is a very straightforward implementation of the
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer} interface: An instance is passed an object when it
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer}.
 * </p>
 *
 * <p>
 * The {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer} class can be used to defer the creation of an object
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer} implements the <em>double-check idiom for an instance
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer} comes into play. We create a specialized subclass for
 * creating and initializing an instance of our messaging service.
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer} declares an abstract
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer#initialize() initialize()} method which we have to
 ...
 *
 * <p>
 * The {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicInitializer} class is very similar to
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer}. It serves the same purpose: to defer the creation of an
 * object until it is needed. The internal structure is also very similar. Again there is an abstract
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicInitializer#initialize() initialize()} method which has to be
 ...
 *
 * <p>
 * With {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicSafeInitializer} there is yet another variant implementing the
 * lazy initializing pattern. Its implementation is close to
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicInitializer}; it also uses atomic variables internally and therefore
 * does not need synchronization. The name &quot;Safe&quot; is derived from the fact that it implements an additional
 * check which guarantees that the {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicSafeInitializer#initialize()
 * initialize()} method is called only once. So it behaves exactly in the same way as
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer}.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicInitializer} is probably the most efficient implementation due to
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicInitializer} is a good choice.
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicSafeInitializer} and
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer} both guarantee that the initialization method is called
 * only once. Because {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicSafeInitializer} does not use synchronization it
 * is probably slightly more efficient than {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer}, but the
 * concrete numbers might depend on the level of concurrency.
 * </p>
 *
 * <p>
 * Another implementation of the {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer} interface is
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer}. It is again an abstract base class with an
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer#initialize() initialize()} method that has to be
 * defined by concrete subclasses. The idea of {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} is that
 ...
 * specialized implementation of {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} can be created for
 * this purpose:
 * </p>
 *
 * <pre>{@code
 ...
 *
 * <p>
 * Related to {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} is the
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.MultiBackgroundInitializer} class. As the name implies, this class can
 * handle multiple initializations in parallel. The basic usage scenario is that a
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.MultiBackgroundInitializer} instance is created. Then an arbitrary number
 * of {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} objects is added using the
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.MultiBackgroundInitializer#addInitializer(String, BackgroundInitializer)}
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.MultiBackgroundInitializer#start()} method is called. This starts
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.MultiBackgroundInitializer.MultiBackgroundInitializerResults}. This object
 ...
 *
 * <p>
 * With {@link com.github.terefang.jmelange.apache.lang3.concurrent.MultiBackgroundInitializer} we can extend our example to perform
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer} implementations exist. The following example
 * fragment shows the usage of {@link com.github.terefang.jmelange.apache.lang3.concurrent.MultiBackgroundInitializer} for this purpose:
 * </p>
 *
 * <pre>
 * {@code
 ...
 *
 * <p>
 * If background initializers - including {@link com.github.terefang.jmelange.apache.lang3.concurrent.MultiBackgroundInitializer} - are
 ...
 * concurrency. There is the {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils} class with a bunch of static
 ...
 *
 * <p>
 * The {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils#extractCause(java.util.concurrent.ExecutionException)}
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException} is created and initialized with the root cause
 * ({@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException} is a new exception class in the
 * {@code o.a.c.l.concurrent} package). So if you get such a
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException}, you can be sure that the original cause for the
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils#extractCauseUnchecked(java.util.concurrent.ExecutionException)}
 * method which behaves like {@code extractCause()}, but returns the unchecked exception
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentRuntimeException} instead.
 * </p>
 *
 * <p>
 * In addition to the {@code extractCause()} methods there are corresponding
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils#handleCause(java.util.concurrent.ExecutionException)} and
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils#handleCauseUnchecked(java.util.concurrent.ExecutionException)}
 * methods. These methods extract the cause of the passed in {@link java.util.concurrent.ExecutionException} and throw
 * the resulting {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException} or
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentRuntimeException}. This makes it easy to transform an
 * {@link java.util.concurrent.ExecutionException} into a
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException} ignoring unchecked exceptions:
 * </p>
 *
 * <pre>{@code
 ...
 * {@code initialize()} method is passed a {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer} object and
 * returns the object created by this initializer. It is null-safe. The {@code initializeUnchecked()} method works
 * analogously, but a {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException} throws by the initializer is
 * rethrown as a {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentRuntimeException}. This is especially useful if
 * the specific {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer} does not throw checked exceptions.
 ...
 *
 * <p>
 * Using the {@link com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentUtils#initializeUnchecked(ConcurrentInitializer)}
 * method, this becomes:
 * </p>
 *
 * <pre>
 ...
 *
 * <p>
 * With {@link com.github.terefang.jmelange.apache.lang3.concurrent.BasicThreadFactory} Commons Lang has an implementation of
 ...
 * uncaught exceptions. Instances of {@link com.github.terefang.jmelange.apache.lang3.concurrent.BasicThreadFactory} are created and
 * configured using the nested {@link com.github.terefang.jmelange.apache.lang3.concurrent.BasicThreadFactory.Builder} class. The
 ...
 *
 * <p>
 * The nested {@link com.github.terefang.jmelange.apache.lang3.concurrent.BasicThreadFactory.Builder} class defines some methods for
 * configuring the new {@link com.github.terefang.jmelange.apache.lang3.concurrent.BasicThreadFactory} instance. Objects of this class
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.BasicThreadFactory.Builder#wrappedFactory(java.util.concurrent.ThreadFactory)
 ...
 *
 * <p>
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.TimedSemaphore} allows restricted access to a resource in a given time
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.TimedSemaphore#acquire()} method. The semaphore keeps track about the
 ...
 *
 * <p>
 * What are use cases for {@link com.github.terefang.jmelange.apache.lang3.concurrent.TimedSemaphore}? One example is to artificially
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.TimedSemaphore} object this can be achieved. The semaphore can be
 ...
 * has to create an instance of {@link com.github.terefang.jmelange.apache.lang3.concurrent.TimedSemaphore} and to initialize its
 ...
 *
 * <p>
 * With the {@link com.github.terefang.jmelange.apache.lang3.concurrent.TimedSemaphore#setLimit(int)} method the number of permits
 ...
 * </p>
 */
package com.github.terefang.jmelange.apache.lang3.concurrent;

import com.github.terefang.jmelange.apache.lang3.concurrent.BackgroundInitializer;
import com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentInitializer;