...
package com.github.terefang.jmelange.apache.net.ftp.parser;

import java.util.regex.Pattern;

import com.github.terefang.jmelange.apache.net.ftp.FTPClient;
import com.github.terefang.jmelange.apache.net.ftp.FTPClientConfig;
import com.github.terefang.jmelange.apache.net.ftp.FTPFileEntryParser;
import com.github.terefang.jmelange.apache.net.ftp.Configurable;
 ...
 * com.github.terefang.jmelange.apache.net.ftp.FTPClient.listFiles() if no other implementation has been specified.
 *
            ...
            try {
                ...
                try {
                    ...
                    throw new ParserInitializationException(
                            parserClass.getName() + " does not implement the interface " + "com.github.terefang.jmelange.apache.net.ftp.FTPFileEntryParser.", e);
