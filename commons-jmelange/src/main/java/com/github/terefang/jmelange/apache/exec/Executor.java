...
public interface Executor {
     ...
     * {@link Executor#execute(CommandLine)} will throw an {@link ExecuteException}.
     *
     ...
     * </ul>
     *
     * If an undefined exit value is returned by the process then {@link Executor#execute(CommandLine)} will throw an
     * {@link ExecuteException}.
     *
