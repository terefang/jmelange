...
import com.github.terefang.jmelange.plexus.util.MatchPatterns;
import com.github.terefang.jmelange.plexus.util.Scanner;
import com.github.terefang.jmelange.plexus.util.SelectorUtils;
...
public abstract class AbstractScanner implements Scanner
{
    ...
    private com.github.terefang.jmelange.plexus.util.MatchPatterns includesPatterns;
    ...
    private com.github.terefang.jmelange.plexus.util.MatchPatterns excludesPatterns;
    ...
    protected static boolean matchPatternStart(String pattern, String str) {
        return com.github.terefang.jmelange.plexus.util.SelectorUtils.matchPatternStart(pattern, str);
    }
    ...
    protected static boolean matchPatternStart(String pattern, String str, boolean isCaseSensitive) {
        return com.github.terefang.jmelange.plexus.util.SelectorUtils.matchPatternStart(pattern, str, isCaseSensitive);
    }
    ...
    protected static boolean matchPath(String pattern, String str) {
        return com.github.terefang.jmelange.plexus.util.SelectorUtils.matchPath(pattern, str);
    }
    ...
    protected static boolean matchPath(String pattern, String str, boolean isCaseSensitive) {
        return com.github.terefang.jmelange.plexus.util.SelectorUtils.matchPath(pattern, str, isCaseSensitive);
    }
    ...
    public static boolean match(String pattern, String str) {
        return com.github.terefang.jmelange.plexus.util.SelectorUtils.match(pattern, str);
    }
    ...
    protected static boolean match(String pattern, String str, boolean isCaseSensitive) {
        return com.github.terefang.jmelange.plexus.util.SelectorUtils.match(pattern, str, isCaseSensitive);
    }
    ...
    private String normalizePattern(String pattern) {
        ...
        if (pattern.startsWith(SelectorUtils.REGEX_HANDLER_PREFIX)) {
            if (File.separatorChar == '\\') {
                pattern = com.github.terefang.jmelange.plexus.util.StringUtils.replace(pattern, "/", "\\\\");
            } else {
    ...
    protected void setupMatchPatterns() {
        includesPatterns = com.github.terefang.jmelange.plexus.util.MatchPatterns.from(includes);
