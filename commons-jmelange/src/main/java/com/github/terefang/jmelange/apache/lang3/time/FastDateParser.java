...
import com.github.terefang.jmelange.apache.lang3.time.DateParser;
import com.github.terefang.jmelange.apache.lang3.time.FastDateFormat;
import com.github.terefang.jmelange.apache.lang3.time.FastDatePrinter;
import com.github.terefang.jmelange.apache.lang3.time.FastTimeZone;
import com.github.terefang.jmelange.apache.lang3.time.TimeZones;

/**
 * FastDateParser is a fast and thread-safe version of {@link SimpleDateFormat}.
 *
 * <p>
 * To obtain a proxy to a FastDateParser, use {@link com.github.terefang.jmelange.apache.lang3.time.FastDateFormat#getInstance(String, TimeZone, Locale)} or another variation of the factory methods of
 * {@link com.github.terefang.jmelange.apache.lang3.time.FastDateFormat}.
 * </p>
 *
 * <p>
...
public class FastDateParser implements DateParser, Serializable {
    ...
    private static final class ISO8601TimeZoneStrategy extends PatternStrategy {
        ...
        @Override
        void setCalendar(final FastDateParser parser, final Calendar calendar, final String value) {
            calendar.setTimeZone(com.github.terefang.jmelange.apache.lang3.time.FastTimeZone.getGmtTimeZone(value));
        }
    }
    ...
    static class TimeZoneStrategy extends PatternStrategy {
        ...
        private static final String GMT_OPTION = com.github.terefang.jmelange.apache.lang3.time.TimeZones.GMT_ID + "[+-]\\d{1,2}:\\d{2}";
        /**
         * Index of zone id
         */
        ...
        TimeZoneStrategy(final Locale locale) {
            ...
            for (final String[] zoneNames : zones) {
                ...
                if (tzId.equalsIgnoreCase(com.github.terefang.jmelange.apache.lang3.time.TimeZones.GMT_ID)) {
                    continue;
                }
     ...
     *
     * Use {@link com.github.terefang.jmelange.apache.lang3.time.FastDateFormat#getInstance(String, TimeZone, Locale)} or another variation of the factory methods of {@link FastDateFormat} to get a cached
     ...
     * (non-Javadoc)
     *
     * @see com.github.terefang.jmelange.apache.lang3.time.DateParser#getLocale()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.github.terefang.jmelange.apache.lang3.time.DateParser#getPattern()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.github.terefang.jmelange.apache.lang3.time.DateParser#getTimeZone()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.github.terefang.jmelange.apache.lang3.time.DateParser#parse(String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.github.terefang.jmelange.apache.lang3.time.DateParser#parseObject(String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.github.terefang.jmelange.apache.lang3.time.DateParser#parseObject(String, java.text.ParsePosition)
     */
    @Override
