...
import com.github.terefang.jmelange.apache.io.IOIndexedException;
import com.github.terefang.jmelange.apache.io.function.IOStreams;
...
public interface IOConsumer<T> {
    ...
    static <T> void forAll(final IOConsumer<T> action, final Iterable<T> iterable) throws IOExceptionList {
        com.github.terefang.jmelange.apache.io.function.IOStreams.forAll(com.github.terefang.jmelange.apache.io.function.IOStreams.of(iterable), action);
    }
    ...
    static <T> void forAll(final IOConsumer<T> action, final Stream<T> stream) throws IOExceptionList {
        com.github.terefang.jmelange.apache.io.function.IOStreams.forAll(stream, action, IOIndexedException::new);
    }
    ...
    static <T> void forAll(final IOConsumer<T> action, final T... array) throws IOExceptionList {
        com.github.terefang.jmelange.apache.io.function.IOStreams.forAll(com.github.terefang.jmelange.apache.io.function.IOStreams.of(array), action);
    }
    ...
    static <T> void forEach(final Iterable<T> iterable, final IOConsumer<T> action) throws IOException {
        com.github.terefang.jmelange.apache.io.function.IOStreams.forEach(com.github.terefang.jmelange.apache.io.function.IOStreams.of(iterable), action);
    }
    ...
    static <T> void forEach(final Stream<T> stream, final IOConsumer<T> action) throws IOException {
        com.github.terefang.jmelange.apache.io.function.IOStreams.forEach(stream, action);
    }
    ...
    static <T> void forEach(final T[] array, final IOConsumer<T> action) throws IOException {
        com.github.terefang.jmelange.apache.io.function.IOStreams.forEach(com.github.terefang.jmelange.apache.io.function.IOStreams.of(array), action);
    }
