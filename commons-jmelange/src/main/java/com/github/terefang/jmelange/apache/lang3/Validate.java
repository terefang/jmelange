...
public class Validate {
    ...
    private static String getMessage(final String message, final Object... values) {
        return com.github.terefang.jmelange.apache.lang3.ArrayUtils.isEmpty(values) ? message : String.format(message, values);
    }
    ...
    public static void isAssignableFrom(final Class<?> superType, final Class<?> type) {
        ...
        if (type == null || superType == null || !superType.isAssignableFrom(type)) {
            throw new IllegalArgumentException(
                String.format(DEFAULT_IS_ASSIGNABLE_EX_MESSAGE, com.github.terefang.jmelange.apache.lang3.ClassUtils.getName(type, "null type"), com.github.terefang.jmelange.apache.lang3.ClassUtils.getName(superType, "null type")));
        }
    }
    ...
    public static <T extends Iterable<?>> T noNullElements(final T iterable, final String message, final Object... values) {
        ...
        for (final Iterator<?> it = iterable.iterator(); it.hasNext(); i++) {
            if (it.next() == null) {
                final Object[] values2 = com.github.terefang.jmelange.apache.lang3.ArrayUtils.addAll(values, Integer.valueOf(i));
