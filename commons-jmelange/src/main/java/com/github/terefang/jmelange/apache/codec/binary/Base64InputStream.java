...
public class Base64InputStream extends BaseNCodecInputStream
{
    ...
    public Base64InputStream(final InputStream inputStream, final boolean doEncode) {
        super(inputStream, new com.github.terefang.jmelange.apache.codec.binary.Base64(false), doEncode);
    }
    ...
    public Base64InputStream(final InputStream inputStream, final boolean doEncode, final int lineLength, final byte[] lineSeparator) {
        super(inputStream, new com.github.terefang.jmelange.apache.codec.binary.Base64(lineLength, lineSeparator), doEncode);
    }
