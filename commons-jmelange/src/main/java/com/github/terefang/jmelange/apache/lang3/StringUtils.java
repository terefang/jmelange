 ...
 */
package com.github.terefang.jmelange.apache.lang3;
...
import com.github.terefang.jmelange.apache.lang3.ArrayUtils;
import com.github.terefang.jmelange.apache.lang3.CharSequenceUtils;
import com.github.terefang.jmelange.apache.lang3.CharUtils;
import com.github.terefang.jmelange.apache.lang3.Charsets;
import com.github.terefang.jmelange.apache.lang3.LocaleUtils;
import com.github.terefang.jmelange.apache.lang3.ObjectUtils;
import com.github.terefang.jmelange.apache.lang3.RegExUtils;
import com.github.terefang.jmelange.apache.lang3.function.Suppliers;
import com.github.terefang.jmelange.apache.lang3.stream.LangCollectors;
import com.github.terefang.jmelange.apache.lang3.stream.Streams;
...
public class StringUtils {
     ...
     *
     * <p>For a word based algorithm, see {@link com.github.terefang.jmelange.apache.text.WordUtils#capitalize(String)}.
     ...
     * @see com.github.terefang.jmelange.apache.text.WordUtils#capitalize(String)
    ...
    public static String chomp(final String str) {
        ...
        if (str.length() == 1) {
            ...
            if (ch == com.github.terefang.jmelange.apache.lang3.CharUtils.CR || ch == com.github.terefang.jmelange.apache.lang3.CharUtils.LF) {
                return EMPTY;
            }
            return str;
        }
        ...
        if (last == com.github.terefang.jmelange.apache.lang3.CharUtils.LF) {
            if (str.charAt(lastIdx - 1) == com.github.terefang.jmelange.apache.lang3.CharUtils.CR) {
                lastIdx--;
            }
        } else if (last != com.github.terefang.jmelange.apache.lang3.CharUtils.CR) {
            lastIdx++;
        }
    ...
    public static String chop(final String str) {
        ...
        final char last = str.charAt(lastIdx);
        if (last == com.github.terefang.jmelange.apache.lang3.CharUtils.LF && ret.charAt(lastIdx - 1) == com.github.terefang.jmelange.apache.lang3.CharUtils.CR) {
    ...
    public static boolean contains(final CharSequence seq, final int searchChar) {
        ...
        return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(seq, searchChar, 0) >= 0;
    }
    ...
    public static boolean containsAny(final CharSequence cs, final char... searchChars) {
        if (isEmpty(cs) || com.github.terefang.jmelange.apache.lang3.ArrayUtils.isEmpty(searchChars)) {
            return false;
        }
    ...
    public static boolean containsAny(final CharSequence cs, final CharSequence searchChars) {
        ...
        return containsAny(cs, com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.toCharArray(searchChars));
    }
    ...
    public static int countMatches(final CharSequence str, final CharSequence sub) {
        ...
        int count = 0;
        int idx = 0;
        while ((idx = com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(str, sub, idx)) != INDEX_NOT_FOUND) {
            count++;
            idx += sub.length();
        }
        return count;
    ...
    public static byte[] getBytes(final String string, final Charset charset) {
        return string == null ? com.github.terefang.jmelange.apache.lang3.ArrayUtils.EMPTY_BYTE_ARRAY : string.getBytes(com.github.terefang.jmelange.apache.lang3.Charsets.toCharset(charset));
    }
    ...
    public static byte[] getBytes(final String string, final String charset) throws UnsupportedEncodingException {
        return string == null ? com.github.terefang.jmelange.apache.lang3.ArrayUtils.EMPTY_BYTE_ARRAY : string.getBytes(com.github.terefang.jmelange.apache.lang3.Charsets.toCharsetName(charset));
    }
    ...
    public static String getCommonPrefix(final String... strs) {
        if (com.github.terefang.jmelange.apache.lang3.ArrayUtils.isEmpty(strs)) {
            return EMPTY;
        }
     ...
     * <a href="https://commons.apache.org/proper/commons-text/javadocs/api-release/com/github/terefang/jmelange/apache/text/similarity/FuzzyScore.html">
     ...
     * @since 3.3
     * @deprecated As of 3.6, use Apache Commons Text
     * <a href="https://commons.apache.org/proper/commons-text/javadocs/api-release/com/github/terefang/jmelange/apache/text/similarity/JaroWinklerDistance.html">
     ...
     * @deprecated As of 3.6, use Apache Commons Text
     * <a href="https://commons.apache.org/proper/commons-text/javadocs/api-release/com/github/terefang/jmelange/apache/text/similarity/LevenshteinDistance.html">
     ...
     * @since 3.6 Updated {@link com.github.terefang.jmelange.apache.lang3.CharSequenceUtils} call to behave more like {@link String}
     */
    public static int indexOf(final CharSequence seq, final int searchChar) {
        if (isEmpty(seq)) {
            return INDEX_NOT_FOUND;
        }
        return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(seq, searchChar, 0);
    }
    ...
    public static int indexOf(final CharSequence seq, final int searchChar, final int startPos) {
        ...
        return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(seq, searchChar, startPos);
    }
    ...
    public static int indexOfAny(final CharSequence str, final CharSequence... searchStrs) {
        ...
        for (final CharSequence search : searchStrs) {
            ...
            tmp = com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(str, search, 0);
    ...
    public static int indexOfAnyBut(final CharSequence seq, final CharSequence searchChars) {
        ...
        for (int i = 0; i < strLen; i++) {
            ...
            final boolean chFound = com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(searchChars, ch, 0) >= 0;
            if (i + 1 < strLen && Character.isHighSurrogate(ch)) {
                final char ch2 = seq.charAt(i + 1);
                if (chFound && com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.indexOf(searchChars, ch2, 0) < 0) {
                    return i;
                }
            } else if (!chFound) {
                return i;
    ...
    public static int indexOfDifference(final CharSequence... css) {
        if (com.github.terefang.jmelange.apache.lang3.ArrayUtils.getLength(css) <= 1) {
            return INDEX_NOT_FOUND;
        }
    ...
    public static boolean isAllBlank(final CharSequence... css) {
        if (com.github.terefang.jmelange.apache.lang3.ArrayUtils.isEmpty(css)) {
            return true;
        }
        for (final CharSequence cs : css) {
            if (isNotBlank(cs)) {
    ...
    public static boolean isAsciiPrintable(final CharSequence cs) {
        ...
        final int sz = cs.length();
        for (int i = 0; i < sz; i++) {
            if (!com.github.terefang.jmelange.apache.lang3.CharUtils.isAsciiPrintable(cs.charAt(i))) {
                return false;
            }
        }
        return true;
    ...
    public static int lastIndexOf(final CharSequence seq, final int searchChar) {
        ...
        return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.lastIndexOf(seq, searchChar, seq.length());
    }
    ...
    public static int lastIndexOf(final CharSequence seq, final int searchChar, final int startPos) {
        ...
        return com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.lastIndexOf(seq, searchChar, startPos);
    }
    ...
    public static int lastIndexOfAny(final CharSequence str, final CharSequence... searchStrs) {
        ...
        for (final CharSequence search : searchStrs) {
            ...
            tmp = com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.lastIndexOf(str, search, str.length());
            if (tmp > ret) {
                ret = tmp;
            }
        }
    ...
    public static String lowerCase(final String str, final Locale locale) {
        ...
        return str.toLowerCase(com.github.terefang.jmelange.apache.lang3.LocaleUtils.toLocale(locale));
    }
    ...
    private static int ordinalIndexOf(final CharSequence str, final CharSequence searchStr, final int ordinal, final boolean lastIndex) {
        ...
        do {
            if (lastIndex) {
                index = com.github.terefang.jmelange.apache.lang3.CharSequenceUtils.lastIndexOf(str, searchStr, index - 1); // step backwards through string
            } else {
    ...
    public static String removeAll(final String text, final String regex) {
        return com.github.terefang.jmelange.apache.lang3.RegExUtils.removeAll(text, regex);
    }
    ...
    public static String removePattern(final String source, final String regex) {
        return com.github.terefang.jmelange.apache.lang3.RegExUtils.removePattern(source, regex);
    }
    ...
    public static String replaceAll(final String text, final String regex, final String replacement) {
        return com.github.terefang.jmelange.apache.lang3.RegExUtils.replaceAll(text, regex, replacement);
    }
    ...
    private static String replaceEach(
        ...
        if (isEmpty(text) || com.github.terefang.jmelange.apache.lang3.ArrayUtils.isEmpty(searchList) || com.github.terefang.jmelange.apache.lang3.ArrayUtils.isEmpty(replacementList) || com.github.terefang.jmelange.apache.lang3.ArrayUtils.isNotEmpty(searchList) && timeToLive == -1) {
            return text;
        }
    ...
    public static String replaceEachRepeatedly(final String text, final String[] searchList, final String[] replacementList) {
        return replaceEach(text, searchList, replacementList, true, com.github.terefang.jmelange.apache.lang3.ArrayUtils.getLength(searchList));
    }
    ...
    public static String replaceFirst(final String text, final String regex, final String replacement) {
        return com.github.terefang.jmelange.apache.lang3.RegExUtils.replaceFirst(text, regex, replacement);
    }
    ...
    public static String reverseDelimited(final String str, final char separatorChar) {
        ...
        com.github.terefang.jmelange.apache.lang3.ArrayUtils.reverse(strs);
    ...
    private static String[] splitByCharacterType(final String str, final boolean camelCase) {
        ...
        if (str.isEmpty()) {
            return com.github.terefang.jmelange.apache.lang3.ArrayUtils.EMPTY_STRING_ARRAY;
        }
        ...
        return list.toArray(com.github.terefang.jmelange.apache.lang3.ArrayUtils.EMPTY_STRING_ARRAY);
    }
    ...
    private static String[] splitByWholeSeparatorWorker(
        ...
        return substrings.toArray(com.github.terefang.jmelange.apache.lang3.ArrayUtils.EMPTY_STRING_ARRAY);
    }
    ...
    public static String[] stripAll(final String[] strs, final String stripChars) {
        final int strsLen = com.github.terefang.jmelange.apache.lang3.ArrayUtils.getLength(strs);
        if (strsLen == 0) {
            return strs;
        }
     ...
     * </ul>
     *
     * <p>For a word based algorithm, see {@link com.github.terefang.jmelange.apache.text.WordUtils#swapCase(String)}.
     * A {@code null} input String returns {@code null}.</p>
     *
     * <pre>
     ...
     * That functionality is available in com.github.terefang.jmelange.apache.lang3.text.WordUtils.</p>
     *
    ...
    public static String toEncodedString(final byte[] bytes, final Charset charset) {
        return new String(bytes, com.github.terefang.jmelange.apache.lang3.Charsets.toCharset(charset));
    }
    ...
    public static String toString(final byte[] bytes, final String charsetName) {
        return new String(bytes, com.github.terefang.jmelange.apache.lang3.Charsets.toCharset(charsetName));
    }
     ...
     *
     * <p>For a word based algorithm, see {@link com.github.terefang.jmelange.apache.text.WordUtils#uncapitalize(String)}.
     * A {@code null} input String returns {@code null}.</p>
     *
     * <pre>
     ...
     * @see com.github.terefang.jmelange.apache.text.WordUtils#uncapitalize(String)
    ...
    public static String unwrap(final String str, final char wrapChar) {
        if (isEmpty(str) || wrapChar == com.github.terefang.jmelange.apache.lang3.CharUtils.NUL || str.length() == 1) {
            return str;
        }
    ...
    public static String wrap(final String str, final char wrapWith) {
        ...
        if (isEmpty(str) || wrapWith == com.github.terefang.jmelange.apache.lang3.CharUtils.NUL) {
            return str;
        }
