 ...
 * operation.</p>
 *
 * <p>Some Bloom filters (e.g. {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.CountingBloomFilter}) use counters rather than bits. In this case each counter
 ...
 *     bits into the {@code long} values is described in the {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BitMaps} Javadoc.</li>
 *
 ...
 *
 *     <li><em>cell</em> - Some Bloom filters (e.g. {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.CountingBloomFilter}) use counters rather than bits.  In the {@code bloomfilter} package
 ...
 *     names like {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BitMapExtractor} or
 *     {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.IndexExtractor} and have a {@code processXs} methods that take a
 *     type specialization of {@link java.util.function.Predicate}.
 *     {@code Predicate} type argument.
 *     (e.g. {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BitMapExtractor#processBitMaps(java.util.function.LongPredicate)},
 *     {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.IndexExtractor#processIndices(java.util.function.IntPredicate)},
 *     and {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.CellExtractor#processCells(CellExtractor.CellPredicate)}).
 ...
 * specific state representation we require that all Bloom filters implement the {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BitMapExtractor}
 * and {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.IndexExtractor} interfaces,
 * Counting-based Bloom filters implement {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.CellExtractor} as well.  There are static
 * methods in the various Extractor interfaces to convert from one type to another.</p>
 *
 * <p>Programs that utilize the Bloom filters may use the {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BitMapExtractor}
 * or {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.IndexExtractor} to retrieve
 * or process a representation of the internal structure.
 * Additional methods are available in the {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BitMaps} class to assist in
 * manipulation of bit map representations.</p>
 *
 * <p>The Bloom filter is an interface that requires implementation of 9 methods:</p>
 * <ul>
 * <li>{@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BloomFilter#cardinality()} returns the number of bits enabled in the Bloom filter.</li>
 *
 * <li>{@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BloomFilter#characteristics()} which returns an integer of characteristics flags.</li>
 *
 * <li>{@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BloomFilter#clear()} which resets the Bloom filter to its initial empty state.</li>
 *
 * <li>{@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BloomFilter#contains(IndexExtractor)} which returns true if the bits specified
 * by the indices generated by IndexExtractor are enabled in the Bloom filter.</li>
 *
 * <li>{@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BloomFilter#copy()} which returns a fresh copy of the bitmap.</li>
 *
 * <li>{@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BloomFilter#getShape()} which returns the shape the Bloom filter was created with.</li>
 *
 * <li>{@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BloomFilter#merge(BitMapExtractor)} which merges the BitMaps from the BitMapExtractor
 * into the internal representation of the Bloom filter.</li>
 *
 * <li>{@link com.github.terefang.jmelange.apache.collections4.bloomfilter.BloomFilter#merge(IndexExtractor)} which merges the indices from the IndexExtractor
 * into the internal representation of the Bloom filter.</li>
 * </ul>
 *
 ...
 *
 * <p>The {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.CountingBloomFilter} extends the Bloom filter by counting the number
 ...
 *
 * <p>The {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.LayeredBloomFilter} extends the Bloom filter by creating layers of Bloom
 ...
 * <h3>Shape</h3>
 *
 * <p>The {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.Shape} describes the Bloom filter using the number of bits and the number
 * of hash functions.  It can be specified
 * by the number of expected items and desired false positive rate.</p>
 *
 * <h3>Hasher</h3>
 *
 * <p>A {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.Hasher} converts bytes into a series of integers based on a Shape.
 * Each hasher represents one item being added
 * to the Bloom filter.</p>
 *
 * <p>The {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.EnhancedDoubleHasher} uses a combinatorial generation technique to
 ...
 *
 * <p>Other implementations of the {@link com.github.terefang.jmelange.apache.collections4.bloomfilter.Hasher} are easy to implement.</p>
 *
 * <h2>References</h2>
 *
 * <ol>
 ...
 * @since 4.5.0
 */
package com.github.terefang.jmelange.apache.collections4.bloomfilter;
