...
import com.github.terefang.jmelange.apache.io.build.AbstractOriginSupplier;
...
public abstract class AbstractStreamBuilder<T, B extends AbstractStreamBuilder<T, B>> extends AbstractOriginSupplier<T, B>
{
     ...
     * @see com.github.terefang.jmelange.apache.io.build.AbstractOrigin#getCharSequence(Charset)
     * @since 2.13.0
     */
     ...
     * @throws IOException                   if an I/O error occurs.
     * @see com.github.terefang.jmelange.apache.io.build.AbstractOrigin#getInputStream(OpenOption...)
     * @see #getOpenOptions()
     * @since 2.13.0
     */
     ...
     * @throws IOException                   if an I/O error occurs.
     * @see com.github.terefang.jmelange.apache.io.build.AbstractOrigin#getOutputStream(OpenOption...)
     * @see #getOpenOptions()
     * @since 2.13.0
     */
     ...
     * @see com.github.terefang.jmelange.apache.io.build.AbstractOrigin#getPath()
     * @since 2.13.0
     */
     ...
     * @throws IOException                   if an I/O error occurs.
     * @see com.github.terefang.jmelange.apache.io.build.AbstractOrigin#getReader(Charset)
     * @see #getCharset()
     * @since 2.16.0
     */
