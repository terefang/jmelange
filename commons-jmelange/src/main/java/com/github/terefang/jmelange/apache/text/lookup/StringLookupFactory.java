...
import com.github.terefang.jmelange.apache.text.StringSubstitutor;
import com.github.terefang.jmelange.apache.text.lookup.*;
import com.github.terefang.jmelange.apache.text.lookup.BiStringLookup;
import com.github.terefang.jmelange.apache.text.lookup.DateStringLookup;
import com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup;
import com.github.terefang.jmelange.apache.text.lookup.DnsStringLookup;
import com.github.terefang.jmelange.apache.text.lookup.FileStringLookup;
import com.github.terefang.jmelange.apache.text.lookup.ScriptStringLookup;
import com.github.terefang.jmelange.apache.text.lookup.StringLookup;
import com.github.terefang.jmelange.apache.text.lookup.UrlStringLookup;
import com.github.terefang.jmelange.apache.text.lookup.XmlStringLookup;
 ...
 * <li>{@link #interpolatorStringLookup(com.github.terefang.jmelange.apache.text.lookup.StringLookup)}.</li>
 * <li>{@link #interpolatorStringLookup(Map, com.github.terefang.jmelange.apache.text.lookup.StringLookup, boolean)}.</li>
 * </ul>
 * <p>
 ...
 * {@link com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup} enum. For example, setting this system property to {@code "BASE64_ENCODER,ENVIRONMENT"} will only include the
 * {@link com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup#BASE64_ENCODER BASE64_ENCODER} and {@link com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup#ENVIRONMENT ENVIRONMENT} lookups. Setting the property to the empty
 * string will cause no defaults to be configured. Note that not all lookups defined here and in {@link com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup} are included by default.
 * Specifically, lookups that can execute code (e.g., {@link com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup#SCRIPT SCRIPT}) and those that can result in contact with remote servers (e.g.,
 * {@link com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup#URL URL} and {@link com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup#DNS DNS}) are not included by default. The current set of default lookups can be accessed
 ...
 * <td>{@link com.github.terefang.jmelange.apache.text.lookup.StringLookup}</td>
 ...
 * </tr>
 * <tr>
 * <td>{@link com.github.terefang.jmelange.apache.text.lookup.BiStringLookup}</td>
...
public final class StringLookupFactory {
    ...
    /**
     * Internal class used to construct the default {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup} map used by {@link StringLookupFactory#addDefaultStringLookups(Map)}.
     */
    static final class DefaultStringLookupsHolder {
         ...
         */
        private static void addLookup(final com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup lookup, final Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> map) {
            map.put(toKey(lookup.getKey()), lookup.getStringLookup());
            if (com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.BASE64_DECODER.equals(lookup)) {
         ...
         */
        private static Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> createDefaultStringLookups() {
            final Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> lookupMap = new HashMap<>();

            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.BASE64_DECODER, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.BASE64_ENCODER, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.CONST, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.DATE, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.ENVIRONMENT, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.FILE, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.JAVA, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.LOCAL_HOST, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.LOCAL_HOST, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.PROPERTIES, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.RESOURCE_BUNDLE, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.SYSTEM_PROPERTIES, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.URL_DECODER, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.URL_ENCODER, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.XML, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.XML_DECODER, lookupMap);
            addLookup(com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup.XML_ENCODER, lookupMap);
         ...
         * {@link com.github.terefang.jmelange.apache.text.lookup.DefaultStringLookup} enum. If the given string is null or empty, an empty map is returned.
         *
         * @param str string to parse; may be null or empty
         * @return lookup map parsed from the given string
         */
        private static Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> parseStringLookups(final String str) {
            final Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> lookupMap = new HashMap<>();
            try {
        ...
        private final Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> defaultStringLookups;
        ...
        DefaultStringLookupsHolder(final Properties props) {
            final Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> lookups = props.containsKey(StringLookupFactory.DEFAULT_STRING_LOOKUPS_PROPERTY)
         ...
         */
        Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> getDefaultStringLookups() {
     ...
     * @since 1.10.0
     */
    public static final String DEFAULT_STRING_LOOKUPS_PROPERTY = "com.github.terefang.jmelange.apache.text.lookup.StringLookupFactory.defaultStringLookups";
     ...
     * <p>
     * Using a {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup} from the {@link StringLookupFactory}:
     * </p>
     *
     * <pre>
     ...
     * @since 1.5
     */
    public void addDefaultStringLookups(final Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> stringLookupMap) {
     ...
     * @since 1.5
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup base64DecoderStringLookup() {
     ...
     * @since 1.6
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup base64EncoderStringLookup() {
     ...
     */
    @Deprecated
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup base64StringLookup() {
        return StringLookupFactory.INSTANCE_BASE64_DECODER;
    }
     ...
     * @since 1.5
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup constantStringLookup() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup dateStringLookup() {
        return com.github.terefang.jmelange.apache.text.lookup.DateStringLookup.INSTANCE;
    }
     ...
     * @since 1.8
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup dnsStringLookup() {
        return com.github.terefang.jmelange.apache.text.lookup.DnsStringLookup.INSTANCE;
    }
     ...
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup environmentVariableStringLookup() {
     ...
     * <p>
     * To use a fenced {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup}, use {@link StringLookupFactory#builder()}:
     * </p>
     *
     * <pre>
     ...
     * <p>
     * To use an unfenced {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup}, use {@link StringLookupFactory#INSTANCE}:
     * </p>
     *
     * <pre>
     ...
     * @since 1.5
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup fileStringLookup() {
        return fences != null ? fileStringLookup(fences) : com.github.terefang.jmelange.apache.text.lookup.FileStringLookup.INSTANCE;
    }

    /**
     * Returns a fenced file StringLookup instance.
     * <p>
     * To use a {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup} fenced by the current directory, use:
     * </p>
     *
     * <pre>
     ...
     * @since 1.12.0
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup fileStringLookup(final Path... fences) {
        return new com.github.terefang.jmelange.apache.text.lookup.FileStringLookup(fences);
    }
     ...
     * @since 1.9
     */
    public <R> com.github.terefang.jmelange.apache.text.lookup.StringLookup functionStringLookup(final Function<String, R> function) {
     ...
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup interpolatorStringLookup() {
     ...
     * @since 1.4
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup interpolatorStringLookup(final Map<String, com.github.terefang.jmelange.apache.text.lookup.StringLookup> stringLookupMap, final com.github.terefang.jmelange.apache.text.lookup.StringLookup defaultStringLookup,
     ...
     * @return a new InterpolatorStringLookup.
     */
    public <V> com.github.terefang.jmelange.apache.text.lookup.StringLookup interpolatorStringLookup(final Map<String, V> map) {
     ...
     * @return a new InterpolatorStringLookup.
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup interpolatorStringLookup(final com.github.terefang.jmelange.apache.text.lookup.StringLookup defaultStringLookup) {
     ...
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup javaPlatformStringLookup() {
     ...
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup localHostStringLookup() {
     ...
     * @return The InetAddressStringLookup singleton instance.
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup loopbackAddressStringLookup() {
     ...
     * @return a new MapStringLookup.
     */
    public <V> com.github.terefang.jmelange.apache.text.lookup.StringLookup mapStringLookup(final Map<String, V> map) {
     ...
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup nullStringLookup() {
     ...
     * @since 1.5
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup propertiesStringLookup() {
     ...
     * @since 1.12.0
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup propertiesStringLookup(final Path... fences) {
     ...
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup resourceBundleStringLookup() {
     ...
     * @since 1.5
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup resourceBundleStringLookup(final String bundleName) {
     ...
     * @since 1.5
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup scriptStringLookup() {
        return com.github.terefang.jmelange.apache.text.lookup.ScriptStringLookup.INSTANCE;
    }
     ...
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup systemPropertyStringLookup() {
     ...
     * @since 1.6
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup urlDecoderStringLookup() {
     ...
     * @since 1.6
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup urlEncoderStringLookup() {
     ...
     * @since 1.5
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup urlStringLookup() {
        return com.github.terefang.jmelange.apache.text.lookup.UrlStringLookup.INSTANCE;
    }
     ...
     * @since 1.11.0
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup xmlDecoderStringLookup() {
     ...
     * @since 1.11.0
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup xmlEncoderStringLookup() {
     ...
     * @since 1.5
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup xmlStringLookup() {
        return fences != null ? xmlStringLookup(com.github.terefang.jmelange.apache.text.lookup.XmlStringLookup.DEFAULT_FEATURES, fences) : com.github.terefang.jmelange.apache.text.lookup.XmlStringLookup.INSTANCE;
    }
     ...
     * @since 1.11.0
     */
    public com.github.terefang.jmelange.apache.text.lookup.StringLookup xmlStringLookup(final Map<String, Boolean> xPathFactoryFeatures) {
     ...
     * </p>
     * <p>
     * Using a {@link com.github.terefang.jmelange.apache.text.lookup.StringLookup} from the {@link StringLookupFactory} fenced by the current directory ({@code Paths.get("")}):
     * </p>
     *
     * <pre>
    ...
    public StringLookup xmlStringLookup(final Map<String, Boolean> xPathFactoryFeatures, final Path... fences) {
        return new com.github.terefang.jmelange.apache.text.lookup.XmlStringLookup(xPathFactoryFeatures, fences);
    }
}
