...
import com.github.terefang.jmelange.apache.codec.binary.BaseNCodecInputStream;
...
public class Base32InputStream extends BaseNCodecInputStream
{
    ...
    public Base32InputStream(final InputStream inputStream, final boolean doEncode) {
        super(inputStream, new com.github.terefang.jmelange.apache.codec.binary.Base32(false), doEncode);
    }
    ...
    public Base32InputStream(final InputStream inputStream, final boolean doEncode, final int lineLength, final byte[] lineSeparator) {
        super(inputStream, new com.github.terefang.jmelange.apache.codec.binary.Base32(lineLength, lineSeparator), doEncode);
    }
