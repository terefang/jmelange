...
import com.github.terefang.jmelange.apache.text.lookup.IllegalArgumentExceptions;
 ...
 * @since 1.3
 */
final class ResourceBundleStringLookup extends com.github.terefang.jmelange.apache.text.lookup.AbstractStringLookup
{
    ...
    public String lookup(final String key) {
        ...
        if (anyBundle && keyLen != 2) {
            throw com.github.terefang.jmelange.apache.text.lookup.IllegalArgumentExceptions
                .format("Bad resource bundle key format [%s]; expected format is BundleName:KeyName.", key);
        }
        if (bundleName != null && keyLen != 1) {
            throw com.github.terefang.jmelange.apache.text.lookup.IllegalArgumentExceptions.format("Bad resource bundle key format [%s]; expected format is KeyName.",
                key);
        }
        ...
        try {
            ...
            throw com.github.terefang.jmelange.apache.text.lookup.IllegalArgumentExceptions.format(e, "Error looking up resource bundle [%s] and key [%s].",
