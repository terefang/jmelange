...
import com.github.terefang.jmelange.apache.lang3.concurrent.AbstractConcurrentInitializer;
import com.github.terefang.jmelange.apache.lang3.concurrent.AtomicInitializer;
...
import com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer;
import com.github.terefang.jmelange.apache.lang3.function.FailableConsumer;
 ...
 * to {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicInitializer}, but ensures that the {@link #initialize()}
 * method is called only once.
 *
 * <p>
 * As {@link com.github.terefang.jmelange.apache.lang3.concurrent.AtomicInitializer} this class is based on atomic variables, so it
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.concurrent.LazyInitializer}. It is a &quot;save&quot; implementation of the lazy
 ...
 */
public class AtomicSafeInitializer<T> extends AbstractConcurrentInitializer<T, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException>
{
     ...
     * @since 3.14.0
     */
    public static class Builder<I extends AtomicSafeInitializer<T>, T> extends AbstractBuilder<I, T, Builder<I, T>, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException> {
     ...
     */
    private AtomicSafeInitializer(final FailableSupplier<T, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException> initializer, final FailableConsumer<T, com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException> closer) {
     ...
     * @throws com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException if the initialization of the object causes an
     * exception
     */
    @Override
    public final T get() throws com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException
    {
        T result;
     ...
     */
    @Override
    protected com.github.terefang.jmelange.apache.lang3.concurrent.ConcurrentException getTypedException(final Exception e) {
