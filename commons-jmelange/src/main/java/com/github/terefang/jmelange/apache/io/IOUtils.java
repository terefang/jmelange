...
package com.github.terefang.jmelange.apache.io;
...
import com.github.terefang.jmelange.apache.io.Charsets;
import com.github.terefang.jmelange.apache.io.CloseableURLConnection;
import com.github.terefang.jmelange.apache.io.IO;
import com.github.terefang.jmelange.apache.io.IOExceptionList;
import com.github.terefang.jmelange.apache.io.LineIterator;
import com.github.terefang.jmelange.apache.io.StandardLineSeparator;
import com.github.terefang.jmelange.apache.io.function.IOConsumer;
import com.github.terefang.jmelange.apache.io.function.IOSupplier;
import com.github.terefang.jmelange.apache.io.function.IOTriFunction;
import com.github.terefang.jmelange.apache.io.input.QueueInputStream;
import com.github.terefang.jmelange.apache.io.output.AppendableWriter;
import com.github.terefang.jmelange.apache.io.output.ByteArrayOutputStream;
import com.github.terefang.jmelange.apache.io.output.NullOutputStream;
import com.github.terefang.jmelange.apache.io.output.NullWriter;
import com.github.terefang.jmelange.apache.io.output.StringBuilderWriter;
import com.github.terefang.jmelange.apache.io.output.ThresholdingOutputStream;
import com.github.terefang.jmelange.apache.io.output.UnsynchronizedByteArrayOutputStream;
...
public class IOUtils {
     ...
     * </ul>
     * @see com.github.terefang.jmelange.apache.io.IO#clear()
     */
    static void clear() {
     ...
     * @throws com.github.terefang.jmelange.apache.io.IOExceptionList if an I/O error occurs.
     * @since 2.8.0
     */
    ...
    public static boolean contentEquals(final InputStream input1, final InputStream input2) throws IOException {
        ...
        // com.github.terefang.jmelange.apache.io.jmh.IOUtilsContentEqualsInputStreamsBenchmark
        if (input1 == input2) {
            return true;
        }
    ...
    public static void copy(final InputStream input, final Writer writer, final Charset inputCharset)
            throws IOException {
        copy(new InputStreamReader(input, com.github.terefang.jmelange.apache.io.Charsets.toCharset(inputCharset)), writer);
    }
    ...
    public static void copy(final InputStream input, final Writer writer, final String inputCharsetName)
            throws IOException {
        copy(input, writer, com.github.terefang.jmelange.apache.io.Charsets.toCharset(inputCharsetName));
    }
    ...
    public static void copy(final Reader reader, final OutputStream output, final Charset outputCharset)
            throws IOException {
        final OutputStreamWriter writer = new OutputStreamWriter(output, com.github.terefang.jmelange.apache.io.Charsets.toCharset(outputCharset));
        copy(reader, writer);
    ...
    public static void copy(final Reader reader, final OutputStream output, final String outputCharsetName)
            throws IOException {
        copy(reader, output, com.github.terefang.jmelange.apache.io.Charsets.toCharset(outputCharsetName));
    }
    ...
    public static LineIterator lineIterator(final InputStream input, final Charset charset) {
        return new LineIterator(new InputStreamReader(input, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charset)));
    }
    ...
    public static LineIterator lineIterator(final InputStream input, final String charsetName) {
        return lineIterator(input, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static List<String> readLines(final InputStream input, final Charset charset) throws UncheckedIOException {
        return readLines(new InputStreamReader(input, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charset)));
    }
    ...
    public static List<String> readLines(final InputStream input, final String charsetName) throws UncheckedIOException {
        return readLines(input, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static byte[] toByteArray(final Reader reader, final String charsetName) throws IOException {
        return toByteArray(reader, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static byte[] toByteArray(final URL url) throws IOException {
        try (com.github.terefang.jmelange.apache.io.CloseableURLConnection urlConnection = com.github.terefang.jmelange.apache.io.CloseableURLConnection.open(url)) {
    ...
    public static char[] toCharArray(final InputStream inputStream, final String charsetName) throws IOException {
        return toCharArray(inputStream, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static InputStream toInputStream(final CharSequence input, final String charsetName) {
        return toInputStream(input, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static InputStream toInputStream(final String input, final Charset charset) {
        return new ByteArrayInputStream(input.getBytes(com.github.terefang.jmelange.apache.io.Charsets.toCharset(charset)));
    }
    ...
    public static InputStream toInputStream(final String input, final String charsetName) {
        return new ByteArrayInputStream(input.getBytes(com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName)));
    }
    ...
    public static String toString(final byte[] input, final String charsetName) {
        return new String(input, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static String toString(final InputStream input, final String charsetName)
            throws IOException {
        return toString(input, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static String toString(final URI uri, final Charset encoding) throws IOException {
        return toString(uri.toURL(), com.github.terefang.jmelange.apache.io.Charsets.toCharset(encoding));
    }
    ...
    public static String toString(final URI uri, final String charsetName) throws IOException {
        return toString(uri, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static String toString(final URL url, final String charsetName) throws IOException {
        return toString(url, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static void write(final byte[] data, final Writer writer, final Charset charset) throws IOException {
        if (data != null) {
            writer.write(new String(data, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charset)));
        }
    }
    ...
    public static void write(final byte[] data, final Writer writer, final String charsetName) throws IOException {
        write(data, writer, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static void write(final char[] data, final OutputStream output, final String charsetName)
            throws IOException {
        write(data, output, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
    }
    ...
    public static void write(final String data, final OutputStream output, final Charset charset) throws IOException {
        if (data != null) {
            ...
            Channels.newChannel(output).write(com.github.terefang.jmelange.apache.io.Charsets.toCharset(charset).encode(data));
        }
    }
    ...
    public static void write(final StringBuffer data, final OutputStream output, final String charsetName) //NOSONAR
        throws IOException {
        if (data != null) {
            write(data.toString(), output, com.github.terefang.jmelange.apache.io.Charsets.toCharset(charsetName));
        }
    }
