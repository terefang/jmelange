...
import com.github.terefang.jmelange.apache.io.RandomAccessFileMode;
import com.github.terefang.jmelange.apache.io.RandomAccessFiles;
import com.github.terefang.jmelange.apache.io.ThreadUtils;
import com.github.terefang.jmelange.apache.io.file.*;
...
import com.github.terefang.jmelange.apache.io.file.attribute.FileTimes;
import com.github.terefang.jmelange.apache.io.filefilter.IOFileFilter;
import com.github.terefang.jmelange.apache.io.function.IOFunction;
...
public final class PathUtils {
    ...
    public static PathCounters cleanDirectory(final Path directory, final DeleteOption... deleteOptions) throws IOException {
        return visitFileTree(new CleaningPathVisitor(com.github.terefang.jmelange.apache.io.file.Counters.longPathCounters(), deleteOptions), directory).getPathCounters();
    }
    ...
    public static PathCounters copyDirectory(final Path sourceDirectory, final Path targetDirectory, final CopyOption... copyOptions) throws IOException {
        ...
        return visitFileTree(new CopyDirectoryVisitor(com.github.terefang.jmelange.apache.io.file.Counters.longPathCounters(), absoluteSource, targetDirectory, copyOptions), absoluteSource)
                .getPathCounters();
    }
    ...
    public static PathCounters deleteDirectory(final Path directory, final DeleteOption... deleteOptions) throws IOException {
        ...
        return withPosixFileAttributes(getParent(directory), linkOptions, overrideReadOnly(deleteOptions),
                pfa -> visitFileTree(new DeletingPathVisitor(com.github.terefang.jmelange.apache.io.file.Counters.longPathCounters(), linkOptions, deleteOptions), directory).getPathCounters());
    }
    ...
    public static PathCounters deleteDirectory(final Path directory, final LinkOption[] linkOptions, final DeleteOption... deleteOptions) throws IOException {
        return visitFileTree(new DeletingPathVisitor(com.github.terefang.jmelange.apache.io.file.Counters.longPathCounters(), linkOptions, deleteOptions), directory).getPathCounters();
    }
