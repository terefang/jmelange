...
import com.github.terefang.jmelange.apache.lang3.reflect.MethodUtils;

/**
 *  Utility reflection methods focused on constructors, modeled after
 * {@link com.github.terefang.jmelange.apache.lang3.reflect.MethodUtils}.
 *
...
public class ConstructorUtils {
    ...
    public static <T> Constructor<T> getAccessibleConstructor(final Constructor<T> ctor) {
        ...
        return com.github.terefang.jmelange.apache.lang3.reflect.MemberUtils.isAccessible(ctor)
    ...
    public static <T> Constructor<T> getMatchingAccessibleConstructor(final Class<T> cls,
        ...
        try {
            return com.github.terefang.jmelange.apache.lang3.reflect.MemberUtils.setAccessibleWorkaround(cls.getConstructor(parameterTypes));
        ...
        for (Constructor<?> ctor : ctors) {
            // compare parameters
            if (com.github.terefang.jmelange.apache.lang3.reflect.MemberUtils.isMatchingConstructor(ctor, parameterTypes)) {
                // get accessible version of constructor
                ctor = getAccessibleConstructor(ctor);
                if (ctor != null) {
                    com.github.terefang.jmelange.apache.lang3.reflect.MemberUtils.setAccessibleWorkaround(ctor);
                    if (result == null || com.github.terefang.jmelange.apache.lang3.reflect.MemberUtils.compareConstructorFit(ctor, result, parameterTypes) < 0) {
