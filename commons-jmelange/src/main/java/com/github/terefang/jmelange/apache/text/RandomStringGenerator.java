...
import com.github.terefang.jmelange.apache.text.CharacterPredicate;
import com.github.terefang.jmelange.apache.text.CharacterPredicates;
import com.github.terefang.jmelange.apache.text.TextRandomProvider;
...
public final class RandomStringGenerator {
     ...
     *
     * <p>The type of code points returned can be filtered using {@link #filteredBy(com.github.terefang.jmelange.apache.text.CharacterPredicate...)},
     ...
     * @since 1.1
     */
    public static class Builder implements com.github.terefang.jmelange.apache.text.Builder<RandomStringGenerator> {
         ...
         */
        private Set<com.github.terefang.jmelange.apache.text.CharacterPredicate> inclusivePredicates;
         ...
         */
        public Builder filteredBy(final com.github.terefang.jmelange.apache.text.CharacterPredicate... predicates) {
     ...
     * Filters for code points.
     */
    private final Set<com.github.terefang.jmelange.apache.text.CharacterPredicate> inclusivePredicates;
    ...
    private RandomStringGenerator(final int minimumCodePoint, final int maximumCodePoint,
                                  final Set<com.github.terefang.jmelange.apache.text.CharacterPredicate> inclusivePredicates, final TextRandomProvider random,
