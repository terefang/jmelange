...
import com.github.terefang.jmelange.apache.net.ftp.parser.ConfigurableFTPFileEntryParserImpl;
import com.github.terefang.jmelange.apache.net.ftp.parser.FTPTimestampParserImpl;
...
/**
 * <p>
 * This class implements an alternate means of configuring the {@link FTPClient FTPClient} object and also subordinate objects which
 * it uses. Any class implementing the {@link Configurable Configurable } interface can be configured by this object.
 * </p>
 * <p>
