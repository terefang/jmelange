 ...
 */
package com.github.terefang.jmelange.apache.lang3.time;

import com.github.terefang.jmelange.apache.lang3.time.FastDateFormat;
import com.github.terefang.jmelange.apache.lang3.time.FastTimeZone;
 ...
 * {@link com.github.terefang.jmelange.apache.lang3.time.FastDateFormat} class.</p>
 *
...
public class DateFormatUtils {
     ...
     * @since 3.5
     */
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_8601_EXTENDED_DATETIME_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("yyyy-MM-dd'T'HH:mm:ss");

    /**
     * @deprecated - as of 4.0, ISO_DATETIME_FORMAT will be replaced by ISO_8601_EXTENDED_DATETIME_FORMAT.
     */
    @Deprecated
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_DATETIME_FORMAT = ISO_8601_EXTENDED_DATETIME_FORMAT;
     ...
     * @since 3.5
     */
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("yyyy-MM-dd'T'HH:mm:ssZZ");

    /**
     * @deprecated - as of 4.0, ISO_DATETIME_TIME_ZONE_FORMAT will be replaced by ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.
     */
    @Deprecated
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_DATETIME_TIME_ZONE_FORMAT = ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT;
     ...
     * @since 3.5
     */
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_8601_EXTENDED_DATE_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("yyyy-MM-dd");

    /**
     * @deprecated - as of 4.0, ISO_DATE_FORMAT will be replaced by ISO_8601_EXTENDED_DATE_FORMAT.
     */
    @Deprecated
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_DATE_FORMAT = ISO_8601_EXTENDED_DATE_FORMAT;
     ...
     */
    @Deprecated
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_DATE_TIME_ZONE_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("yyyy-MM-ddZZ");
     ...
     */
    @Deprecated
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_TIME_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("'T'HH:mm:ss");
     ...
     */
    @Deprecated
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_TIME_TIME_ZONE_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("'T'HH:mm:ssZZ");
     ...
     * @since 3.5
     */
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_8601_EXTENDED_TIME_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("HH:mm:ss");

    /**
     * @deprecated - as of 4.0, ISO_TIME_NO_T_FORMAT will be replaced by ISO_8601_EXTENDED_TIME_FORMAT.
     */
    @Deprecated
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_TIME_NO_T_FORMAT = ISO_8601_EXTENDED_TIME_FORMAT;
     ...
     * @since 3.5
     */
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_8601_EXTENDED_TIME_TIME_ZONE_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("HH:mm:ssZZ");

    /**
     * @deprecated - as of 4.0, ISO_TIME_NO_T_TIME_ZONE_FORMAT will be replaced by ISO_8601_EXTENDED_TIME_TIME_ZONE_FORMAT.
     */
    @Deprecated
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat ISO_TIME_NO_T_TIME_ZONE_FORMAT = ISO_8601_EXTENDED_TIME_TIME_ZONE_FORMAT;
     ...
     * </p>
     */
    public static final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat SMTP_DATETIME_FORMAT
            = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance("EEE, dd MMM yyyy HH:mm:ss Z", Locale.US);
     ...
     * @see com.github.terefang.jmelange.apache.lang3.time.FastDateFormat#format(Calendar)
     * @since 2.4
     */
    ...
    public static String format(final Calendar calendar, final String pattern, final TimeZone timeZone, final Locale locale) {
        final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat df = com.github.terefang.jmelange.apache.lang3.time.FastDateFormat.getInstance(pattern, timeZone, locale);
    ...
    public static String format(final Date date, final String pattern, final TimeZone timeZone, final Locale locale) {
        final com.github.terefang.jmelange.apache.lang3.time.FastDateFormat df = FastDateFormat.getInstance(pattern, timeZone, locale);
