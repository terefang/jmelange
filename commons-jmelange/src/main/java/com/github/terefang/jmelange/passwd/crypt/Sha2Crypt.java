...
import com.github.terefang.jmelange.commons.base.B64T;
...
public class Sha2Crypt {
    ...
    public static String sha256Crypt(final byte[] keyBytes, String salt) {
        if (salt == null) {
            salt = SHA256_PREFIX + B64T.getRandomSalt(8);
        }
    ...
    public static String sha256Crypt(final byte[] keyBytes, String salt, final Random random) {
        if (salt == null) {
            salt = SHA256_PREFIX + B64T.getRandomSalt(8, random);
        }
        return sha2Crypt(keyBytes, salt, SHA256_PREFIX, SHA256_BLOCKSIZE, "SHA-256");
    }
    ...
    private static String sha2Crypt(final byte[] keyBytes, final String salt, final String saltPrefix,
        ...
        MessageDigest ctx = HashUtil.getDigest(algorithm);
         ...
         * context.
         */
        MessageDigest altCtx = HashUtil.getDigest(algorithm);
         ...
         */
        altCtx = HashUtil.getDigest(algorithm);
        ...
        for (int i = 0; i <= rounds - 1; i++) {
             ...
             * New context.
             */
            ctx = HashUtil.getDigest(algorithm);
        ...
        if (blocksize == 32) {
            B64T.b64from24bit(altResult[0], altResult[10], altResult[20], 4, buffer);
            B64T.b64from24bit(altResult[21], altResult[1], altResult[11], 4, buffer);
            B64T.b64from24bit(altResult[12], altResult[22], altResult[2], 4, buffer);
            B64T.b64from24bit(altResult[3], altResult[13], altResult[23], 4, buffer);
            B64T.b64from24bit(altResult[24], altResult[4], altResult[14], 4, buffer);
            B64T.b64from24bit(altResult[15], altResult[25], altResult[5], 4, buffer);
            B64T.b64from24bit(altResult[6], altResult[16], altResult[26], 4, buffer);
            B64T.b64from24bit(altResult[27], altResult[7], altResult[17], 4, buffer);
            B64T.b64from24bit(altResult[18], altResult[28], altResult[8], 4, buffer);
            B64T.b64from24bit(altResult[9], altResult[19], altResult[29], 4, buffer);
            B64T.b64from24bit((byte) 0, altResult[31], altResult[30], 3, buffer);
        } else {
            B64T.b64from24bit(altResult[0], altResult[21], altResult[42], 4, buffer);
            B64T.b64from24bit(altResult[22], altResult[43], altResult[1], 4, buffer);
            B64T.b64from24bit(altResult[44], altResult[2], altResult[23], 4, buffer);
            B64T.b64from24bit(altResult[3], altResult[24], altResult[45], 4, buffer);
            B64T.b64from24bit(altResult[25], altResult[46], altResult[4], 4, buffer);
            B64T.b64from24bit(altResult[47], altResult[5], altResult[26], 4, buffer);
            B64T.b64from24bit(altResult[6], altResult[27], altResult[48], 4, buffer);
            B64T.b64from24bit(altResult[28], altResult[49], altResult[7], 4, buffer);
            B64T.b64from24bit(altResult[50], altResult[8], altResult[29], 4, buffer);
            B64T.b64from24bit(altResult[9], altResult[30], altResult[51], 4, buffer);
            B64T.b64from24bit(altResult[31], altResult[52], altResult[10], 4, buffer);
            B64T.b64from24bit(altResult[53], altResult[11], altResult[32], 4, buffer);
            B64T.b64from24bit(altResult[12], altResult[33], altResult[54], 4, buffer);
            B64T.b64from24bit(altResult[34], altResult[55], altResult[13], 4, buffer);
            B64T.b64from24bit(altResult[56], altResult[14], altResult[35], 4, buffer);
            B64T.b64from24bit(altResult[15], altResult[36], altResult[57], 4, buffer);
            B64T.b64from24bit(altResult[37], altResult[58], altResult[16], 4, buffer);
            B64T.b64from24bit(altResult[59], altResult[17], altResult[38], 4, buffer);
            B64T.b64from24bit(altResult[18], altResult[39], altResult[60], 4, buffer);
            B64T.b64from24bit(altResult[40], altResult[61], altResult[19], 4, buffer);
            B64T.b64from24bit(altResult[62], altResult[20], altResult[41], 4, buffer);
            B64T.b64from24bit((byte) 0, (byte) 0, altResult[63], 2, buffer);
        }
    ...
    public static String sha512Crypt(final byte[] keyBytes, String salt) {
        if (salt == null) {
            salt = SHA512_PREFIX + B64T.getRandomSalt(8);
        }
    ...
    public static String sha512Crypt(final byte[] keyBytes, String salt, final Random random) {
        if (salt == null) {
            salt = SHA512_PREFIX + B64T.getRandomSalt(8, random);
        }
        return sha2Crypt(keyBytes, salt, SHA512_PREFIX, SHA512_BLOCKSIZE, "SHA-512");
    }
}