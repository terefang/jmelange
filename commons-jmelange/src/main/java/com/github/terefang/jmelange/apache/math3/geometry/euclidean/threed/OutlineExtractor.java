...
import com.github.terefang.jmelange.apache.math3.geometry.partitioning.AbstractSubHyperplane;
            ...
            if (FastMath.abs(scal) > 1.0e-3) {
                ...
                for (Vector2D[] loop : vertices) {
                    ...
                    while (current < loop.length) {
                        ...
                        final com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line line =
                            new com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line(pPoint, cPoint, tolerance);
                        ...
                        if (closed || (previous != 1)) {
                            ...
                            final com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line l =
                                new com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line(pPoint, angle, tolerance);
                        ...
                        if (closed || (current != (loop.length - 1))) {
                            ...
                            final double angle = line.getAngle() + 0.5 * FastMath.PI;
                            final com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line l =
                                new com.github.terefang.jmelange.apache.math3.geometry.euclidean.twod.Line(cPoint, angle, tolerance);
